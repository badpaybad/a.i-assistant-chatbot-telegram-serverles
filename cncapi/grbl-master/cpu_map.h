...
#define cpu_map_h
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // #define SPINDLE_TCCRB_INIT_MASK      (1<<CS22)               // 1/64 prescaler -> 0.98kHz (J-tech laser) [CODE CŨ]
    #define SPINDLE_TCCRB_INIT_MASK      ((1<<CS22) | (1<<CS21) | (1<<CS20)) // 1/1024 prescaler -> ~61Hz (CHUẨN TẦN SỐ CHO SERVO RC SG90/MG90S)
