...
**khi thao tác xóa** xóa file thì xóa ở DB và xóa thật trên firestore, xóa folder thì cần xóa thật cả trên firestore luôn xóa cả subfolder và các file. xóa folder là xóa recusive triệt để. tránh tốn tiền firestore