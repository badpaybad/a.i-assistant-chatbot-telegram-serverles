...
**cập nhật 2026-07-21 14:16:16**
bổ xung log các dữ liệu trong quá trình train TreeOfThought/docs/nhan-dien-khuon-mat/ArcFaceFinetune/main.py ra file csv để cho phép dựa vào đó đánh giá được cần điều chỉnh gì để có kết quả train tốt dần sau mỗi lần train 