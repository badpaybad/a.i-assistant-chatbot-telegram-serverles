...
Bước 4,5 là để scale dự án nhanh với nhiều team độc lập, cho nhiều nghiệp vụ cùng lúc. Kể các nghiệp vụ có liên quan tới nhau cũng không bị chờ đợi hoặc xung đột
    ...
    Lúc này dev, hoặc A.I chỉ cần quan tâm tới docs/tên nghiệp vụ/whattodo.md và các subfolder của nghiệp vụ. Việc code đã có A.I triển khai khi người dùng duyệt howtodo.md 
...
## Vd cách tạo các file md theo tree of thought
                ...
                whattodo.md intent, what to do do người viết

                howtodo.md là how to do do A.I viết 

### nghệp vụ IAM

                docs/iam/whattodo.md  ( mô tả về nguyên tắc, user có nhiều roles , acl là jj , db design, http rest ,...) 

                docs/iam/user/whattodo.md (mô tả chi tiết về UI thao tác ... nghiệp vụ khi click nút edit ... về chức năng quản lý user )

                để làm nghiệp vụ mới : tot-dev.md làm nghiệp vụ: quản lý task nội bộ .... khi tạo cấu trúc xong chỉ cần người dùng bổ xung srs vào docs/quan-ly-task-noi-bo/whattodo.md đợi howtodo.md để duyệt và kiểm soát (nếu chưa ưng ý cập nhật whattodo.md ...) rồi khi đã ưng ý. yêu cầu tot-dev.md tiến hành code

                như vậy khi làm việc , chỉ cần gọi skill : tot-dev.md cần fix bug iam với lỗi user ....log error ở đây ... là tự nó đọc iam/whattodo.md iam/howtodo.md + iam/user/whattodo.md ...

                bug thì chat vào box: titan-dev.md sửa lỗi xxx ở nghiệp vụ iam user lỗi như sau : ....

                titan-dev.md sẽ tự động update change vào whattodo.md về việc cập nhật bug này kia .... và cập nhật cho howtodo.md -> khi e đọc howtodo.md thấy nó mô tả đúng về lỗi và chỉ ra cáchlàm rồi -> titan-dev.md tiến hành fix

                Dev chỉ cẩn review howtodo.md để quyết định bảo A.I tiến hành thực hiện code
