...
**chú ý khi thực hiện code xong** cần kiểm tra lỗi BE code project .net vào TreeOfThought/backend/Core.Web.Api hãy dùng lệnh **dotnet run** xem lỗi ở console log và sửa. khi cần kiểm tra lỗi FE vào TreeOfThought/frontend/web cần chạy lênh **ng build** xem lỗi ở console log và sửa. sau khi chạy xong cần close các process để tránh xung đột port, vd port 5000, 4200 (fuser -k 4200/tcp 5000/tcp). ưu tiên việc viết tài liệu bằng tiếng Việt Nam, kể cả những code sinh ra ở FE, BE là text cần là tiếng Việt trước