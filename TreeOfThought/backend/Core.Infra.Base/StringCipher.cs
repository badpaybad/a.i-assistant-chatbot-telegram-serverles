...
public static class StringCipher
{
    ...
    public static string RsaSign(string data, string privateKeyInBase64)
    {
        RSA rsa = RSA.Create();
        rsa.ImportRSAPrivateKey(Convert.FromBase64String(privateKeyInBase64), out int readByte);
    ...
    public static string RandomPassword(short lenghtOfLowerCase = 3, short lenghtOfUpperCase = 1, short lenghtOfNumber = 2, short lenghtOfSpecial = 0)
    {
    ...
    public static bool AesEncript(this string plainText, string password, out string encrypted)
    {
        encrypted = plainText;
        try
        {
    ...
    public static bool AesDecript(this string encrypted, string password, out string decrypted)
    {
        decrypted = encrypted;
        try
        {
        ...
        {
            Console.WriteLine("ERR: AesDecript");
