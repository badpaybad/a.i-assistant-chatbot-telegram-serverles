...
_AuthorizeInfoComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthorizeInfoComponent, selectors: [["app-authorize-info"]], decls: 43, vars: 45, consts: [[1, "authorize-info-container"], [1, "page-header"], [1, "subtitle"], [3, "nzTitle"], [1, "tab-content"], [1, "info-card", 3, "nzTitle"], ["nzBordered", "", 3, "nzColumn"], [3, "nzColor", 4, "ngFor", "ngForOf"], ["class", "empty-text", 4, "ngIf"], [1, "claims-list"], ["class", "info-card", 3, "nzTitle", 4, "ngIf"], ["nzColor", "volcano"], [3, "title", "data", "columns", "pageSize", "frontPagination"], ["totCell", "value"], [3, "nzColor"], [1, "empty-text"], [1, "admin-notice"], ["nz-icon", "", "nzType", "safety-certificate", "nzTheme", "twotone", 3, "nzTwotoneColor"]], template: function AuthorizeInfoComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("title", \u0275\u0275pipeBind1(41, 43, "Danh s\xE1ch Quy\u1EC1n h\u1EA1n \u0111\u1ECBnh ngh\u0129a trong FE"))("data", ctx.appClaimsList)("columns", ctx.claimsColumns)("pageSize", 10)("frontPagination", true);
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
//# sourceMappingURL=chunk-UBHLMFDZ.js.map
