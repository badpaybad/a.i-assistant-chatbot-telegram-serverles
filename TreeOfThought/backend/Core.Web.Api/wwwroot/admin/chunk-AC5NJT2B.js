...
var _FilesFoldersService = class _FilesFoldersService {
  ...
  moveFile(fileId, newFolderId, callback) {
    return this.http.post("/api/files/move", { fileId, newFolderId }, callback);
  }
  renameFile(fileId, newName, callback) {
    return this.http.patch(`/api/files/${fileId}/rename`, { newName }, callback);
  }
  setFilePermission(fileId, permission, shareCode, expiredAt, callback) {
...
var _CreateFolderPopoverComponent = class _CreateFolderPopoverComponent {
  ...
  async submit() {
    ...
    try {
      ...
      this.name = "";
      await this.filesFoldersService.createFolder(folderName, this.parentId, (data) => {
...
function FileExplorerComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, FileExplorerComponent_ng_template_4_span_1_Template, 1, 0, "span", 28);
...
function FileExplorerComponent_div_6_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_div_6_ng_template_2_Template_div_click_0_listener() {
      ...
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.openFileDetail(data_r7));
    });
    \u0275\u0275element(1, "span", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r7.name, " ");
  }
}
...
function FileExplorerComponent_div_6_ng_template_4_tot_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_div_6_ng_template_4_tot_button_1_Template_tot_button_click_0_listener() {
      ...
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onSelectFile(data_r11));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementEnd();
...
function FileExplorerComponent_div_6_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_div_6_ng_template_4_Template_tot_button_click_2_listener() {
      const data_r11 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.goToFolder(data_r11.folderId));
    });
    \u0275\u0275element(4, "span", 39);
    \u0275\u0275elementEnd()();
  }
...
function FileExplorerComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("pageIndexChange", function FileExplorerComponent_div_6_Template_tot_table_pageIndexChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.searchPageIndex = $event);
    })("pageSizeChange", function FileExplorerComponent_div_6_Template_tot_table_pageSizeChange_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      ctx_r3.searchPageSize = $event;
      return \u0275\u0275resetView(ctx_r3.searchPageIndex = 1);
    });
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r3.paginatedSearchResults)("columns", ctx_r3.searchColumns)("total", ctx_r3.searchResults.length)("pageIndex", ctx_r3.searchPageIndex)("pageSize", ctx_r3.searchPageSize)("nzSize", "small")("title", "K\u1EBFt qu\u1EA3 t\xECm ki\u1EBFm (" + ctx_r3.searchResults.length + ")")("frontPagination", false)("scroll", \u0275\u0275pureFunction0(9, _c32));
  }
}
...
function FileExplorerComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_div_14_Template_div_click_0_listener() {
      ...
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.navigateToFolder(folder_r14.id));
    });
    \u0275\u0275elementStart(1, "div", 45);
    \u0275\u0275element(2, "span", 49);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_div_14_Template_li_click_13_listener() {
      const folder_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.renameItem(folder_r14, "folder"));
    });
  ...
  if (rf & 2) {
    ...
    const folderMenu_r15 = \u0275\u0275reference(9);
    const ctx_r3 = \u0275\u0275nextContext();
    const renameTemplate_r16 = \u0275\u0275reference(28);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzTooltipTitle", folder_r14.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(folder_r14.name);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzDropdownMenu", folderMenu_r15)("nzPopoverContent", renameTemplate_r16)("nzPopoverTrigger", null)("nzPopoverVisible", ctx_r3.renamePopoverVisibleId === folder_r14.id)("nzPopoverPlacement", "bottomRight");
  }
}
function FileExplorerComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_17_Template_div_click_0_listener() {
      ...
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openFileDetail(data_r18));
    });
    \u0275\u0275element(1, "span", 35);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r18.name, " ");
  }
}
function FileExplorerComponent_ng_template_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("nzColor", ctx_r3.getPermissionColor(data_r19.permission));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.getPermissionLabel(data_r19.permission), " ");
  }
}
function FileExplorerComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275textInterpolate1(" ", ctx_r3.formatSize(data_r20.size), " ");
  }
}
function FileExplorerComponent_ng_template_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", data_r21.mimeType, " ");
  }
}
function FileExplorerComponent_ng_template_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, data_r22.createdAt, "dd/MM/yyyy HH:mm"), " ");
  }
}
function FileExplorerComponent_ng_template_22_tot_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_22_tot_button_1_Template_tot_button_click_0_listener() {
      \u0275\u0275restoreView(_r24);
      const data_r25 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onSelectFile(data_r25));
    });
    \u0275\u0275text(1, " Ch\xE8n ");
    \u0275\u0275elementEnd();
  }
...
function FileExplorerComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_22_Template_tot_button_click_5_listener() {
      const data_r25 = \u0275\u0275restoreView(_r23).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openShareModal(data_r25));
    });
    \u0275\u0275element(6, "span", 63);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_22_Template_li_click_12_listener() {
      const data_r25 = \u0275\u0275restoreView(_r23).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openMoveModal(data_r25, "file"));
    });
    \u0275\u0275text(13, "Di chuy\u1EC3n");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_22_Template_li_click_14_listener() {
      const data_r25 = \u0275\u0275restoreView(_r23).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.renameItem(data_r25, "file"));
    });
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_22_Template_li_click_17_listener() {
      const data_r25 = \u0275\u0275restoreView(_r23).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.deleteFile(data_r25.id));
    });
    \u0275\u0275text(18, "X\xF3a");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const fileMenu_r26 = \u0275\u0275reference(10);
    const ctx_r3 = \u0275\u0275nextContext();
    const renameTemplate_r16 = \u0275\u0275reference(28);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.selectionMode);
    \u0275\u0275advance(2);
    \u0275\u0275property("href", data_r25.url);
    \u0275\u0275advance(4);
    \u0275\u0275property("nzDropdownMenu", fileMenu_r26)("nzPopoverContent", renameTemplate_r16)("nzPopoverTrigger", null)("nzPopoverVisible", ctx_r3.renamePopoverVisibleId === data_r25.id)("nzPopoverPlacement", "bottomRight");
  }
}
function FileExplorerComponent_ng_template_23_nz_breadcrumb_item_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_23_nz_breadcrumb_item_7_Template_a_click_1_listener() {
      const item_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.navigateToFolder(item_r29.id));
    });
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
...
function FileExplorerComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, FileExplorerComponent_ng_template_23_nz_breadcrumb_item_7_Template, 3, 1, "nz-breadcrumb-item", 68);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function FileExplorerComponent_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FileExplorerComponent_ng_template_25_Template_tot_button_click_6_listener() {
      \u0275\u0275restoreView(_r30);
      const fileInput_r31 = \u0275\u0275reference(11);
      return \u0275\u0275resetView(fileInput_r31.click());
    });
    \u0275\u0275element(7, "span", 74);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "transloco");
...
var _FileExplorerComponent = class _FileExplorerComponent {
  ...
  waitForTask(trackingId, successMessage, onComplete) {
    ...
    this.http.registerCallback(trackingId, (data) => {
      if (data.status === "Completed") {
  ...
  initColumns() {
    this.searchColumns = [
      { title: "T\xEAn file", key: "name" },
      { title: "\u0110\u01B0\u1EDDng d\u1EABn", key: "path" },
      { title: "Thao t\xE1c", key: "action", width: "100px", right: true }
    ];
    this.folderColumns = [
      { title: "T\xEAn th\u01B0 m\u1EE5c", key: "name" },
      { title: "H\xE0nh \u0111\u1ED9ng", key: "action", width: "150px", right: true }
    ];
    this.fileColumns = [
      { title: "T\xEAn file", key: "name" },
      { title: "Tr\u1EA1ng th\xE1i", key: "status", width: "120px" },
      { title: "K\xEDch th\u01B0\u1EDBc", key: "size", width: "120px" },
      { title: "Lo\u1EA1i", key: "type", width: "120px" },
      { title: "Ng\xE0y t\u1EA1o", key: "createdAt", width: "150px" },
      { title: "H\xE0nh \u0111\u1ED9ng", key: "action", width: "150px", right: true }
    ];
  }
  ngOnDestroy() {
    ...
    this.modal.confirm({
      ...
      nzOnOk: async () => {
        try {
          ...
          await this.filesFoldersService.deleteFile(fileId, (data) => {
            if (data.status === "Completed") {
              this.message.success(data.message || "File \u0111\xE3 \u0111\u01B0\u1EE3c x\xF3a th\xE0nh c\xF4ng");
              this.loadContent();
            } else if (data.status === "Error") {
              this.message.error(data.message || "Thao t\xE1c x\xF3a file th\u1EA5t b\u1EA1i");
              this.loadContent();
            }
          });
        } catch (error) {
    ...
    this.modal.confirm({
      ...
      nzOnOk: async () => {
        try {
          ...
          await this.filesFoldersService.deleteFolder(folderId, (data) => {
            if (data.status === "Completed") {
              this.message.success(data.message || "Th\u01B0 m\u1EE5c \u0111\xE3 \u0111\u01B0\u1EE3c x\xF3a th\xE0nh c\xF4ng");
              this.loadContent();
              this.folderCreated.emit();
            } else if (data.status === "Error") {
              this.message.error(data.message || "Thao t\xE1c x\xF3a th\u01B0 m\u1EE5c th\u1EA5t b\u1EA1i");
              this.loadContent();
            }
          });
        } catch (error) {
...
_FileExplorerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FileExplorerComponent, selectors: [["app-file-explorer"]], viewQuery: function FileExplorerComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, FileExplorerComponent_ng_template_4_Template, 3, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, FileExplorerComponent_div_6_Template, 5, 10, "div", 12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(13, FileExplorerComponent_div_13_Template, 5, 0, "div", 17)(14, FileExplorerComponent_div_14_Template, 18, 7, "div", 18);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 19)(16, "tot-table", 20);
    \u0275\u0275listener("pageIndexChange", function FileExplorerComponent_Template_tot_table_pageIndexChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageIndex = $event;
      return \u0275\u0275resetView(ctx.loadContent());
    })("pageSizeChange", function FileExplorerComponent_Template_tot_table_pageSizeChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return \u0275\u0275resetView(ctx.loadContent());
  ...
  if (rf & 2) {
    const suffixTemplate_r33 = \u0275\u0275reference(5);
    const folderHeader_r34 = \u0275\u0275reference(11);
    const fileTitleTpl_r35 = \u0275\u0275reference(24);
    const fileExtraTpl_r36 = \u0275\u0275reference(26);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzSuffix", suffixTemplate_r33);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("nzHeader", folderHeader_r34)("nzActive", true);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx.hasParent);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx.folders);
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.files)("columns", ctx.fileColumns)("loading", ctx.loading)("total", ctx.total)("pageIndex", ctx.pageIndex)("pageSize", ctx.pageSize)("frontPagination", false)("nzSize", "small")("title", fileTitleTpl_r35)("extra", fileExtraTpl_r36)("scroll", \u0275\u0275pureFunction0(19, _c23));
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
(() => {
  ...
  <div class="search-section">
    ...
    <div *ngIf="searchResults.length > 0 || searching" class="mt-3">
      <tot-table [data]="paginatedSearchResults" [columns]="searchColumns" [total]="searchResults.length" [pageIndex]="searchPageIndex" [pageSize]="searchPageSize" [nzSize]="'small'"
        [title]="'K\u1EBFt qu\u1EA3 t\xECm ki\u1EBFm (' + searchResults.length + ')'" [frontPagination]="false" [scroll]="{ x: '800px' }"
        (pageIndexChange)="searchPageIndex = $event" (pageSizeChange)="searchPageSize = $event; searchPageIndex = 1">
  ...
  <div class="explorer-content">
    ...
    <div class="mt-3">
      ...
      <tot-table [data]="files" [columns]="fileColumns" [loading]="loading" [total]="total" [pageIndex]="pageIndex"
        ...
        [scroll]="{ x: '1000px' }" (pageIndexChange)="pageIndex = $event; loadContent()" (pageSizeChange)="pageSize = $event; pageIndex = 1; loadContent()">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FileExplorerComponent, { className: "FileExplorerComponent", filePath: "projects/tot/business-files/src/lib/components/file-explorer/file-explorer.ts", lineNumber: 55 });
})();
...
//# sourceMappingURL=chunk-AC5NJT2B.js.map
