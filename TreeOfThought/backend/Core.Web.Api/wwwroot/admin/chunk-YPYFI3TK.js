...
var WebAnimationsPlayer = class {
  constructor(element, keyframes, options, _specialStyles) {
    ...
    __publicField(this, "_originalOnDoneFns", []);
    __publicField(this, "_originalOnStartFns", []);
    __publicField(this, "domPlayer", null);
  ...
  _preparePlayerBeforeStart() {
    ...
    if (this._delay) {
      ...
      (_a = this.domPlayer) == null ? void 0 : _a.pause();
    }
  }
  ...
  _resetDomPlayerState() {
    var _a;
    (_a = this.domPlayer) == null ? void 0 : _a.cancel();
  }
  restart() {
    this.reset();
    this.play();
...
var Animation = class {
  constructor(_driver, input) {
    __publicField(this, "_driver");
    __publicField(this, "_animationAst");
    this._driver = _driver;
    const errors = [];
    const warnings = [];
...
//# sourceMappingURL=chunk-YPYFI3TK.js.map
