...
function DashboardComponent_div_60_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "slice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "tot-button", 79);
    \u0275\u0275listener("click", function DashboardComponent_div_60_ng_template_33_Template_tot_button_click_4_listener() {
...
function DashboardComponent_div_60_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 59)(1, "tot-button", 81);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275listener("click", function DashboardComponent_div_60_ng_template_34_Template_tot_button_click_1_listener() {
    ...
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "tot-button", 83);
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275listener("click", function DashboardComponent_div_60_ng_template_34_Template_tot_button_click_6_listener() {
      const data_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(10, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "tot-button", 85);
    \u0275\u0275listener("click", function DashboardComponent_div_60_ng_template_34_Template_tot_button_click_11_listener() {
      const data_r20 = \u0275\u0275restoreView(_r19).$implicit;
...
function DashboardComponent_div_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(31, DashboardComponent_div_60_ng_template_31_Template, 3, 4, "ng-template", 74)(32, DashboardComponent_div_60_ng_template_32_Template, 1, 1, "ng-template", 75)(33, DashboardComponent_div_60_ng_template_33_Template, 6, 6, "ng-template", 76)(34, DashboardComponent_div_60_ng_template_34_Template, 15, 17, "ng-template", 47);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const prefixSearch_r21 = \u0275\u0275reference(10);
    const ctx_r12 = \u0275\u0275nextContext();
    const expandTpl_r22 = \u0275\u0275reference(64);
    \u0275\u0275advance();
...
function DashboardComponent_div_61_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tot-button", 91);
...
function DashboardComponent_div_61_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-list-item")(1, "span", 92);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "nz-tag", 93);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd()();
  }
...
function DashboardComponent_div_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 39);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 87);
    \u0275\u0275template(4, DashboardComponent_div_61_ng_template_4_Template, 3, 4, "ng-template", 74)(5, DashboardComponent_div_61_ng_template_5_Template, 3, 5, "ng-template", 47);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "nz-card", 88);
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275elementStart(8, "div", 63)(9, "div", 18)(10, "nz-list", 89);
    ...
    \u0275\u0275template(14, DashboardComponent_div_61_div_14_Template, 5, 3, "div", 90);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function DashboardComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 39);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 97);
    \u0275\u0275template(4, DashboardComponent_div_62_ng_template_4_Template, 3, 4, "ng-template", 41)(5, DashboardComponent_div_62_ng_template_5_Template, 7, 12, "ng-template", 98);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r12 = \u0275\u0275nextContext();
...
function DashboardComponent_ng_template_63_ng_template_16_nz_tag_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-tag", 48);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DashboardComponent_ng_template_63_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-list-item")(1, "div", 106)(2, "span", 107);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, DashboardComponent_ng_template_63_ng_template_16_nz_tag_9_Template, 2, 2, "nz-tag", 110);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DashboardComponent_ng_template_63_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "tot-button", 103);
    \u0275\u0275listener("click", function DashboardComponent_ng_template_63_Template_tot_button_click_5_listener() {
    ...
    \u0275\u0275pipe(8, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "pre", 104);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 96)(12, "h4");
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "nz-list", 105);
    \u0275\u0275template(16, DashboardComponent_ng_template_63_ng_template_16_Template, 10, 7, "ng-template", null, 7, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 65, vars: 59, consts: [["prefixEnqueued", ""], ["prefixProcessed", ""], ["prefixError", ""], ["prefixWorkers", ""], ["expandTpl", ""], ["prefixSearch", ""], ["errorItem", ""], ["historyItem", ""], [1, "dashboard-container"], [1, "site-page-header", 3, "nzTitle"], [2, "display", "flex", "align-items", "center", "gap", "16px"], [2, "display", "flex", "align-items", "center", "gap", "8px"], [2, "color", "#999"], [2, "width", "120px", 3, "ngModelChange", "ngModel"], [3, "nzLabel", "nzValue", 4, "ngFor", "ngForOf"], ["nzType", "primary", 3, "click", "loading"], ["nz-icon", "", "nzType", "reload"], ["nz-row", "", 1, "stats-row", 2, "margin-bottom", "24px", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], ["nzHoverable", ""], [3, "nzValue", "nzTitle", "nzPrefix"], [3, "nzValue", "nzTitle", "nzPrefix", "nzValueStyle"], [1, "tab-actions", 2, "margin-bottom", "16px", "display", "flex", "justify-content", "center"], ["nzButtonStyle", "solid", "nzSize", "large", 3, "ngModelChange", "ngModel"], ["nz-radio-button", "", "nzValue", "queues"], ["nz-icon", "", "nzType", "database"], ["nz-radio-button", "", "nzValue", "tracking"], ["nz-icon", "", "nzType", "history"], ["nz-radio-button", "", "nzValue", "workers"], ["nz-icon", "", "nzType", "api"], ["nz-radio-button", "", "nzValue", "activity"], ["nz-icon", "", "nzType", "clock-circle"], [3, "ngSwitch"], [4, "ngSwitchCase"], [3, "nzLabel", "nzValue"], ["nz-icon", "", "nzType", "cloud-upload", 2, "color", "#1890ff"], ["nz-icon", "", "nzType", "check-circle", 2, "color", "#52c41a"], ["nz-icon", "", "nzType", "close-circle", 2, "color", "#ff4d4f"], ["nz-icon", "", "nzType", "cluster", 2, "color", "#722ed1"], [3, "nzTitle"], [3, "data", "columns", "loading", "pageSize", "frontPagination", "showPagination", "scroll"], ["totCell", "type"], ["totCell", "processing"], ["totCell", "success"], ["totCell", "error"], ["totCell", "workers"], ["totCell", "handlers"], ["totCell", "action"], [3, "nzColor"], ["nzColor", "processing"], ["nzColor", "success"], ["nzColor", "error"], [1, "worker-tags"], ["nzColor", "processing", 4, "ngFor", "ngForOf"], [1, "handler-grid"], ["class", "handler-tag-item", 4, "ngFor", "ngForOf"], [1, "handler-tag-item"], [1, "h-name"], [1, "m-name"], [2, "display", "flex", "gap", "4px", "flex-direction", "column"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzGhost"], ["nzType", "default", "nzSize", "small", 3, "click"], [1, "filters-container", 2, "margin-bottom", "24px"], ["nz-row", "", 3, "nzGutter"], [3, "nzPrefix"], ["type", "text", "nz-input", "", 3, "ngModelChange", "ngModel", "placeholder"], ["nzAllowClear", "", 2, "width", "100%", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], ["nzValue", "success", 3, "nzLabel"], ["nzValue", "error", 3, "nzLabel"], ["nzValue", "processing", 3, "nzLabel"], [2, "display", "flex", "gap", "8px"], [2, "flex", "1", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], [3, "click", "nzBlock"], [3, "queryParamsChange", "data", "columns", "loading", "total", "pageIndex", "pageSize", "frontPagination", "expandTemplate"], ["totCell", "status"], ["totCell", "worker"], ["totCell", "content"], ["nz-icon", "", "nzType", "search"], [1, "content-preview"], ["nzType", "text", "nzSize", "small", 3, "click"], ["nz-icon", "", "nzType", "copy"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzTooltipTitle"], ["nz-icon", "", "nzType", "rollback"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzDanger", "nzTooltipTitle"], ["nz-icon", "", "nzType", "delete"], ["nzSize", "small", "nzType", "link", 3, "click"], ["nz-icon", "", 3, "nzType"], [3, "data", "columns", "pageSize", "frontPagination", "showPagination", "scroll"], [2, "margin-top", "24px", 3, "nzTitle"], ["nzBordered", "", 3, "nzDataSource", "nzRenderItem"], ["class", "empty-state", 4, "ngIf"], [3, "click", "nzType", "nzDanger"], [2, "color", "#ff4d4f", "font-weight", "bold"], ["nzColor", "red"], [1, "empty-state"], ["nz-icon", "", "nzType", "check-circle", 2, "font-size", "48px", "color", "#52c41a"], [2, "margin-top", "16px"], ["nzSize", "middle", 3, "data", "columns", "pageSize", "frontPagination", "showPagination"], ["totCell", "lastActive"], [3, "nz-tooltip"], [2, "color", "#999", "font-size", "12px", "margin-left", "8px"], [1, "json-viewer-container", 2, "width", "100%"], [1, "json-header"], ["nzSize", "small", 3, "click"], [1, "json-content"], [3, "nzDataSource", "nzRenderItem"], [2, "display", "flex", "width", "100%", "gap", "16px"], [2, "width", "150px", "color", "#999"], [2, "width", "100px", "font-weight", "bold"], [2, "flex", "1"], [3, "nzColor", 4, "ngIf"]], template: function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(59, DashboardComponent_div_59_Template, 11, 11, "div", 33)(60, DashboardComponent_div_60_Template, 35, 46, "div", 33)(61, DashboardComponent_div_61_Template, 15, 19, "div", 33)(62, DashboardComponent_div_62_Template, 6, 8, "div", 33);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(63, DashboardComponent_ng_template_63_Template, 18, 12, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzValue", ctx.stats.stats["total:enqueued"] || 0)("nzTitle", \u0275\u0275pipeBind1(19, 41, "T\u1ED5ng tin nh\u1EAFn v\xE0o"))("nzPrefix", prefixEnqueued_r34);
    \u0275\u0275advance(4);
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzValue", ctx.stats.stats["total:processed"] || 0)("nzTitle", \u0275\u0275pipeBind1(25, 43, "\u0110\xE3 x\u1EED l\xFD th\xE0nh c\xF4ng"))("nzPrefix", prefixProcessed_r35)("nzValueStyle", \u0275\u0275pureFunction0(57, _c04));
    \u0275\u0275advance(4);
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzValue", ctx.workerList.length)("nzTitle", \u0275\u0275pipeBind1(37, 47, "Workers \u0111ang ch\u1EA1y"))("nzPrefix", prefixWorkers_r37);
    \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "projects/tot/business-dashboard/src/lib/dashboard/dashboard.component.ts", lineNumber: 63 });
})();
...
//# sourceMappingURL=chunk-BM5KRFS5.js.map
