...
function consumerMarkDirty(node) {
  ...
  (_a7 = node.consumerMarkedDirty) == null ? void 0 : _a7.call(node, node);
}
...
function runPostProducerCreatedFn(node) {
  postProducerCreatedFn == null ? void 0 : postProducerCreatedFn(node);
}
...
function signalValueChanged(node) {
  ...
  producerNotifyConsumers(node);
  postSignalSetFn == null ? void 0 : postSignalSetFn(node);
}
...
var AnonymousSubject = class extends Subject {
  ...
  next(value) {
    var _a7, _b2;
    (_b2 = (_a7 = this.destination) === null || _a7 === void 0 ? void 0 : _a7.next) === null || _b2 === void 0 ? void 0 : _b2.call(_a7, value);
  }
  error(err) {
    var _a7, _b2;
    (_b2 = (_a7 = this.destination) === null || _a7 === void 0 ? void 0 : _a7.error) === null || _b2 === void 0 ? void 0 : _b2.call(_a7, err);
  }
  complete() {
    var _a7, _b2;
    (_b2 = (_a7 = this.destination) === null || _a7 === void 0 ? void 0 : _a7.complete) === null || _b2 === void 0 ? void 0 : _b2.call(_a7);
  }
  _subscribe(subscriber) {
    var _a7, _b2;
    return (_b2 = (_a7 = this.source) === null || _a7 === void 0 ? void 0 : _a7.subscribe(subscriber)) !== null && _b2 !== void 0 ? _b2 : EMPTY_SUBSCRIPTION;
  }
};
...
function isNotFound(e) {
  return e === NOT_FOUND || (e == null ? void 0 : e.name) === "\u0275NotFound";
}
...
var formatter = {
  header: (sig, config2) => {
    if (!isSignal(sig) || (config2 == null ? void 0 : config2.ngSkipFormatting)) return null;
    let value;
    try {
      value = sig();
    } catch (e) {
  ...
  hasBody: (sig, config2) => {
    ...
    return !(config2 == null ? void 0 : config2.ngSkipFormatting);
  },
  body: (sig, config2) => {
...
function installDevToolsSignalFormatter() {
  var _a7;
  (_a7 = globalThis.devtoolsFormatters) != null ? _a7 : globalThis.devtoolsFormatters = [];
...
function getInheritedInjectableDef(type) {
  var _a7;
  const def = (_a7 = type == null ? void 0 : type[NG_PROV_DEF]) != null ? _a7 : null;
  if (def) {
...
function prependTokenToDependencyPath(error, token) {
  var _a7;
  (_a7 = error[NG_TOKEN_PATH]) != null ? _a7 : error[NG_TOKEN_PATH] = [];
  const currentPath = error[NG_TOKEN_PATH];
  let pathStr;
  if (typeof token === "object" && "multi" in token && (token == null ? void 0 : token.multi) === true) {
...
function requiresRefreshOrTraversal(lView) {
  var _a7;
  return !!(lView[FLAGS] & (1024 | 8192) || ((_a7 = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a7.dirty));
}
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a7;
  (_a7 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a7.notify(8);
  if (lView[FLAGS] & 64) {
    lView[FLAGS] |= 1024;
  }
...
function markAncestorsForTraversal(lView) {
  var _a7;
  (_a7 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a7.notify(0);
...
function getOrCreateLViewCleanup(view) {
  var _a7;
  return (_a7 = view[CLEANUP]) != null ? _a7 : view[CLEANUP] = [];
}
function getOrCreateTViewCleanup(tView) {
  var _a7;
  return (_a7 = tView.cleanup) != null ? _a7 : tView.cleanup = [];
}
...
var _Injector = class _Injector {
  static create(options, parent) {
    ...
    if (Array.isArray(options)) {
      ...
      const name = (_a7 = options.name) != null ? _a7 : "";
      return createInjector({
        name
...
__publicField(_Injector, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _Injector,
  providedIn: "any",
...
var _PendingTasksInternal = class _PendingTasksInternal {
  constructor() {
    ...
    __publicField(this, "pendingTask", new BehaviorSubject(false));
    __publicField(this, "debugTaskTracker", inject2(DEBUG_TASK_TRACKER, {
      optional: true
    }));
  }
  get hasPendingTasks() {
  ...
  add() {
    ...
    (_a7 = this.debugTaskTracker) == null ? void 0 : _a7.add(taskId);
    return taskId;
  }
  has(taskId) {
  ...
  remove(taskId) {
    ...
    (_a7 = this.debugTaskTracker) == null ? void 0 : _a7.remove(taskId);
...
__publicField(_PendingTasksInternal, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var EventEmitter_ = class extends Subject {
  constructor(isAsync = false) {
    ...
    if (isInInjectionContext()) {
      this.destroyRef = (_a7 = inject2(DestroyRef, {
        optional: true
      })) != null ? _a7 : void 0;
      this.pendingTasks = (_b2 = inject2(PendingTasksInternal, {
        optional: true
      })) != null ? _b2 : void 0;
    }
  }
  ...
  subscribe(observerOrNext, error, complete) {
    ...
    if (observerOrNext && typeof observerOrNext === "object") {
      ...
      nextFn = (_a7 = observer.next) == null ? void 0 : _a7.bind(observer);
  ...
  wrapInTimeout(fn) {
    return (value) => {
      var _a7;
      const taskId = (_a7 = this.pendingTasks) == null ? void 0 : _a7.add();
      setTimeout(() => {
        var _a8;
        try {
          fn(value);
          ...
          if (taskId !== void 0) {
            (_a8 = this.pendingTasks) == null ? void 0 : _a8.remove(taskId);
          }
        }
      });
    };
...
var AsyncStackTaggingZoneSpec = class {
  constructor(namePrefix, consoleAsyncStackTaggingImpl = console) {
    ...
    this.createTask = (_a7 = consoleAsyncStackTaggingImpl == null ? void 0 : consoleAsyncStackTaggingImpl.createTask) != null ? _a7 : (() => null);
  }
...
function hasApplyArgsData(applyArgs, key) {
  ...
  return ((_b2 = (_a7 = applyArgs[0]) == null ? void 0 : _a7.data) == null ? void 0 : _b2[key]) === true;
}
    ...
    return (e) => {
      zone.runOutsideAngular(() => {
        if (injector.destroyed && !userErrorHandler) {
          ...
          userErrorHandler != null ? userErrorHandler : userErrorHandler = injector.get(ErrorHandler);
...
function signal(initialValue, options) {
  const [get, set, update] = createSignal(initialValue, options == null ? void 0 : options.equal);
  const signalFn = get;
  ...
  if (typeof ngDevMode !== "undefined" && ngDevMode) {
    const debugName = options == null ? void 0 : options.debugName;
...
var _PendingTasks = class _PendingTasks {
  constructor() {
    __publicField(this, "internalPendingTasks", inject2(PendingTasksInternal));
    __publicField(this, "scheduler", inject2(ChangeDetectionScheduler));
    __publicField(this, "errorHandler", inject2(INTERNAL_APPLICATION_ERROR_HANDLER));
  }
  add() {
...
__publicField(_PendingTasks, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _PendingTasks,
  providedIn: "root",
...
__publicField(_EffectScheduler, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var ZoneAwareEffectScheduler = class {
  constructor() {
    __publicField(this, "dirtyEffectCount", 0);
...
function effect(effectFn, options) {
  ...
  const injector = (_a7 = options == null ? void 0 : options.injector) != null ? _a7 : inject2(Injector);
...
var EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, BASE_EFFECT_NODE), {
  ...
  cleanup() {
    var _a7;
    if (!((_a7 = this.cleanupFns) == null ? void 0 : _a7.length)) {
      return;
    }
    const prevConsumer = setActiveConsumer(null);
    try {
...
var VIEW_EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, EFFECT_NODE), {
  ...
  destroy() {
    ...
    this.cleanup();
    (_a7 = this.view[EFFECTS]) == null ? void 0 : _a7.delete(this);
  }
}))();
function createViewEffect(view, notifier, fn) {
  ...
  (_a7 = view[EFFECTS]) != null ? _a7 : view[EFFECTS] = /* @__PURE__ */ new Set();
...
function createEffectFn(node, fn) {
  return () => {
    fn((cleanupFn) => {
      var _a7;
      return ((_a7 = node.cleanupFns) != null ? _a7 : node.cleanupFns = []).push(cleanupFn);
    });
  };
}
...
function registerPreOrderHooks(directiveIndex, directiveDef, tView) {
  ...
  if (ngOnChanges) {
    ...
    ((_a7 = tView.preOrderHooks) != null ? _a7 : tView.preOrderHooks = []).push(directiveIndex, wrappedOnChanges);
...
function registerPostOrderHooks(tView, tNode) {
  ...
  for (let i = tNode.directiveStart, end = tNode.directiveEnd; i < end; i++) {
    ...
    if (ngAfterContentInit) {
      ((_a7 = tView.contentHooks) != null ? _a7 : tView.contentHooks = []).push(-i, ngAfterContentInit);
    }
...
function getNodeInjectable(lView, tView, index, tNode, flags) {
  ...
  if (value instanceof NodeInjectorFactory) {
    const factory = value;
    ngDevMode && injectionPath.push((_a7 = factory.name) != null ? _a7 : "unknown");
...
var QueryList = class {
  constructor(_emitDistinctChangesOnly = false) {
    ...
    __publicField(this, _a2, /* @__PURE__ */ (() => symbolIterator)());
    this._emitDistinctChangesOnly = _emitDistinctChangesOnly;
  }
  get changes() {
    var _a7;
    return (_a7 = this._changes) != null ? _a7 : this._changes = new Subject();
  }
  get(index) {
  ...
  setDirty() {
    var _a7;
    this.dirty = true;
    (_a7 = this._onDirty) == null ? void 0 : _a7.call(this);
  }
  destroy() {
...
var CSP_NONCE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "CSP nonce" : "", {
  factory: () => {
    var _a7, _b2;
    return ((_b2 = (_a7 = inject2(DOCUMENT).body) == null ? void 0 : _a7.querySelector("[ngCspNonce]")) == null ? void 0 : _b2.getAttribute("ngCspNonce")) || null;
  }
});
...
__publicField(_TransferState, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  ...
  return new IntersectionObserver((entries) => {
    ...
    for (const current of entries) {
      if (current.isIntersecting && viewportTriggers.has(current.target)) {
        (_b2 = (_a7 = viewportTriggers.get(current.target)) == null ? void 0 : _a7.get(key)) == null ? void 0 : _b2.listener();
      }
    }
  }, options);
}
function onViewport(trigger, callback, observerFactoryFn, options) {
  var _a7;
  const key = getIntersectionObserverKey(options);
  let entry = (_a7 = viewportTriggers.get(trigger)) == null ? void 0 : _a7.get(key);
  ...
  return () => {
    var _a8;
    if (!((_a8 = viewportTriggers.get(trigger)) == null ? void 0 : _a8.has(key))) {
      return;
    }
...
function getIntersectionObserverKey(options) {
  ...
  return `${options.rootMargin}/${typeof options.threshold === "number" ? options.threshold : (_a7 = options.threshold) == null ? void 0 : _a7.join("\n")}`;
}
...
function getTemplateLocationDetails(lView) {
  ...
  const componentClassName = (_a7 = hostComponentDef == null ? void 0 : hostComponentDef.type) == null ? void 0 : _a7.name;
...
function trustedHTMLFromString(html) {
  var _a7;
  return ((_a7 = getPolicy$1()) == null ? void 0 : _a7.createHTML(html)) || html;
}
function trustedScriptURLFromString(url) {
  var _a7;
  return ((_a7 = getPolicy$1()) == null ? void 0 : _a7.createScriptURL(url)) || url;
}
var policy;
function getPolicy() {
  if (policy === void 0) {
...
function trustedHTMLFromStringBypass(html) {
  var _a7;
  return ((_a7 = getPolicy()) == null ? void 0 : _a7.createHTML(html)) || html;
}
function trustedScriptFromStringBypass(script) {
  var _a7;
  return ((_a7 = getPolicy()) == null ? void 0 : _a7.createScript(script)) || script;
}
function trustedScriptURLFromStringBypass(url) {
  var _a7;
  return ((_a7 = getPolicy()) == null ? void 0 : _a7.createScriptURL(url)) || url;
}
...
var DOMParserHelper = class {
  ...
  getInertBodyElement(html) {
    ...
    try {
      ...
      (_a7 = body.firstChild) == null ? void 0 : _a7.remove();
      return body;
    } catch {
      return null;
    }
...
function getUrlSanitizer(tag, prop) {
  var _a7;
  const isResource = ((_a7 = RESOURCE_MAP[tag]) == null ? void 0 : _a7[prop]) === true;
...
function \u0275\u0275validateAttribute(value, tagName, attributeName) {
  ...
  const validationConfig = (_a7 = SECURITY_SENSITIVE_ELEMENTS[lowerCaseTagName]) == null ? void 0 : _a7[lowerCaseAttrName];
  if (!validationConfig) {
    return value;
  }
...
var _a3;
var areAnimationSupported = typeof document !== "undefined" && typeof ((_a3 = document == null ? void 0 : document.documentElement) == null ? void 0 : _a3.getAnimations) === "function";
...
function cancelLeavingNodes(tNode, newElement) {
  ...
  for (let i = nodes.length - 1; i >= 0; i--) {
    ...
    if (leavingEl === newElement) {
      ...
      (_a7 = leavingEl.parentNode) == null ? void 0 : _a7.removeChild(leavingEl);
    }
  }
}
...
function getLViewEnterAnimations(lView) {
  var _a7, _b2, _c;
  const animationData = (_b2 = lView[_a7 = ANIMATIONS]) != null ? _b2 : lView[_a7] = {};
  return (_c = animationData.enter) != null ? _c : animationData.enter = /* @__PURE__ */ new Map();
}
function getLViewLeaveAnimations(lView) {
  var _a7, _b2, _c;
  const animationData = (_b2 = lView[_a7 = ANIMATIONS]) != null ? _b2 : lView[_a7] = {};
  return (_c = animationData.leave) != null ? _c : animationData.leave = /* @__PURE__ */ new Map();
}
...
function addAnimationToLView(animations, tNode, fn) {
  var _a7;
  const nodeAnimations = (_a7 = animations.get(tNode.index)) != null ? _a7 : {
    animateFns: []
  };
...
function determineLongestAnimationFromElementAnimations(el, animationsMap, animations) {
  ...
  for (const animation of animations) {
    const timing = (_a7 = animation.effect) == null ? void 0 : _a7.getTiming();
...
function performanceMarkFeature(feature) {
  ...
  (_a7 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a7.call(performance, "mark_feature_usage", {
    detail: {
      feature
    }
  });
...
var _AfterRenderManager = class _AfterRenderManager {
  ...
  execute() {
    var _a7;
    (_a7 = this.impl) == null ? void 0 : _a7.execute();
  }
};
__publicField(_AfterRenderManager, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _AfterRenderImpl = class _AfterRenderImpl {
  constructor() {
    __publicField(this, "ngZone", inject2(NgZone));
    __publicField(this, "scheduler", inject2(ChangeDetectionScheduler));
    __publicField(this, "errorHandler", inject2(ErrorHandler, {
      optional: true
    }));
    ...
    for (const phase of AFTER_RENDER_PHASES) {
      for (const sequence of this.sequences) {
        ...
        try {
          ...
          (_a7 = this.errorHandler) == null ? void 0 : _a7.handleError(err);
        }
      }
    }
  ...
  register(sequence) {
    ...
    if (view !== void 0) {
      ((_b2 = view[_a7 = AFTER_RENDER_SEQUENCES_TO_ADD]) != null ? _b2 : view[_a7] = []).push(sequence);
...
__publicField(_AfterRenderImpl, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var AfterRenderSequence = class {
  ...
  afterRun() {
    ...
    (_a7 = this.snapshot) == null ? void 0 : _a7.dispose();
    this.snapshot = null;
  }
  destroy() {
    var _a7, _b2;
    this.impl.unregister(this);
    (_a7 = this.unregisterOnDestroy) == null ? void 0 : _a7.call(this);
...
function afterEveryRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  (_a7 = manager.impl) != null ? _a7 : manager.impl = injector.get(AfterRenderImpl);
...
function addToAnimationQueue(injector, animationFns, animationData) {
  ...
  if (Array.isArray(animationFns)) {
    for (const animateFn of animationFns) {
      ...
      (_a7 = animationData == null ? void 0 : animationData.detachedLeaveAnimationFns) == null ? void 0 : _a7.push(animateFn);
    }
  } else {
...
function maybeQueueEnterAnimation(parentLView, parent, tNode, injector) {
  var _a7;
  const enterAnimations = (_a7 = parentLView == null ? void 0 : parentLView[ANIMATIONS]) == null ? void 0 : _a7.enter;
...
function applyToElementOrContainer(action, renderer, injector, parent, lNodeToHandle, tNode, beforeNode, parentLView) {
  ...
  if (lNodeToHandle != null) {
    ...
    if (action === 0 && parent !== null) {
      ...
      if ((_b2 = (_a7 = parentLView == null ? void 0 : parentLView[ANIMATIONS]) == null ? void 0 : _a7.leave) == null ? void 0 : _b2.has(tNode.index)) {
...
function detachViewFromDOM(tView, lView) {
  var _a7;
  (_a7 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a7.notify(9);
...
function runAfterLeaveAnimations(lView, callback) {
  var _a7;
  const runningAnimations = (_a7 = lView[ANIMATIONS]) == null ? void 0 : _a7.running;
...
function setNgReflectProperties(lView, tView, tNode, publicName, value) {
  ...
  const inputConfig = (_a7 = tNode.inputs) == null ? void 0 : _a7[publicName];
...
function storePropertyBindingMetadata(tData, tNode, propertyName, bindingIndex, ...interpolationParts) {
  ...
  if (tData[bindingIndex] === null) {
    if (!((_a7 = tNode.inputs) == null ? void 0 : _a7[propertyName]) && !((_b2 = tNode.hostDirectiveInputs) == null ? void 0 : _b2[propertyName])) {
...
function setAllInputsForProperty(tNode, tView, lView, publicName, value) {
  var _a7, _b2;
  const inputs = (_a7 = tNode.inputs) == null ? void 0 : _a7[publicName];
...
function renderView(tView, lView, context2) {
  ...
  try {
    ...
    (_a7 = lView[QUERIES]) == null ? void 0 : _a7.finishViewCreation(tView);
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context2, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context2, viewFlags, null, templateTNode, null, null, (_a7 = options == null ? void 0 : options.injector) != null ? _a7 : null, (_b2 = options == null ? void 0 : options.embeddedViewInjector) != null ? _b2 : null, (_c = options == null ? void 0 : options.dehydratedView) != null ? _c : null);
...
function getOrBorrowReactiveLViewConsumer(lView) {
  var _a7;
  return (_a7 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a7 : borrowReactiveLViewConsumer(lView);
}
function borrowReactiveLViewConsumer(lView) {
  var _a7;
  const consumer = (_a7 = freeConsumers.pop()) != null ? _a7 : Object.create(REACTIVE_LVIEW_CONSUMER_NODE);
...
function getOrCreateTemporaryConsumer(lView) {
  var _a7;
  const consumer = (_a7 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a7 : Object.create(TEMPORARY_CONSUMER_NODE);
  consumer.lView = lView;
  return consumer;
}
...
function detectChangesInternal(lView, mode = 0) {
  ...
  if (!checkNoChangesMode) {
    (_a7 = rendererFactory.begin) == null ? void 0 : _a7.call(rendererFactory);
  }
  try {
...
function markViewDirty(lView, source) {
  ...
  (_a7 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a7.notify(source);
  while (lView) {
...
var ViewRef = class {
  ...
  checkNoChanges() {
    ...
    if (ngDevMode) {
      try {
        (_a7 = this.exhaustive) != null ? _a7 : this.exhaustive = this._lView[INJECTOR].get(UseExhaustiveCheckNoChanges, USE_EXHAUSTIVE_CHECK_NO_CHANGES_DEFAULT);
      } catch {
...
var TemplateRef = class {
  ...
  get ssrId() {
    var _a7;
    return ((_a7 = this._declarationTContainer.tView) == null ? void 0 : _a7.ssrId) || null;
  }
...
function describeRNode(rNode, innerContent = "\u2026") {
  ...
  switch (node.nodeType) {
    ...
    case Node.COMMENT_NODE:
      return `<!-- ${shorten((_a7 = node.textContent) != null ? _a7 : "")} -->`;
    default:
...
function removeDehydratedViews(lContainer) {
  var _a7;
  const views = (_a7 = lContainer[DEHYDRATED_VIEWS]) != null ? _a7 : [];
...
var _a4;
var ComponentFactoryResolver$1 = (_a4 = class {
}, __publicField(_a4, "NULL", new _NullComponentFactoryResolver()), _a4);
...
__publicField(_Sanitizer, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _Sanitizer,
  providedIn: "root",
  factory: () => null
}));
...
var DepsTracker = class {
  constructor() {
    __publicField(this, "ownerNgModule", /* @__PURE__ */ new WeakMap());
    __publicField(this, "ngModulesWithSomeUnresolvedDecls", /* @__PURE__ */ new Set());
    __publicField(this, "ngModulesScopeCache", /* @__PURE__ */ new WeakMap());
    __publicField(this, "standaloneComponentsScopeCache", /* @__PURE__ */ new WeakMap());
  }
...
function markAsComponentHost(tView, hostTNode, componentOffset) {
  ...
  ((_a7 = tView.components) != null ? _a7 : tView.components = []).push(hostTNode.index);
}
function initializeDirectives(tView, lView, tNode, directives, exportsMap, hostDirectiveDefs, hostDirectiveRanges) {
  ...
  if (componentDef == null ? void 0 : componentDef.viewProvidersResolver) {
  ...
  for (let i = 0; i < directivesLength; i++) {
    ...
    if (!preOrderHooksFound && (lifeCycleHooks.ngOnChanges || lifeCycleHooks.ngOnInit || lifeCycleHooks.ngDoCheck)) {
      ((_a7 = tView.preOrderHooks) != null ? _a7 : tView.preOrderHooks = []).push(tNode.index);
...
function setupSelectorMatchedInputsOrOutputs(mode, tNode, def, directiveIndex) {
  ...
  for (const publicName in aliasMap) {
    if (aliasMap.hasOwnProperty(publicName)) {
      let bindings;
      if (mode === 0) {
        bindings = (_a7 = tNode.inputs) != null ? _a7 : tNode.inputs = {};
      } else {
        bindings = (_b2 = tNode.outputs) != null ? _b2 : tNode.outputs = {};
      }
      (_c = bindings[publicName]) != null ? _c : bindings[publicName] = [];
...
function setupHostDirectiveInputsOrOutputs(mode, tNode, config2, directiveIndex) {
  ...
  for (const initialName in aliasMap) {
    if (aliasMap.hasOwnProperty(initialName)) {
      ...
      let bindings;
      if (mode === 0) {
        bindings = (_a7 = tNode.hostDirectiveInputs) != null ? _a7 : tNode.hostDirectiveInputs = {};
      } else {
...
function setupInitialInputs(tNode, directiveIndex, isHostDirective) {
  ...
  if (attrs === null || !isHostDirective && inputs === null || isHostDirective && hostDirectiveInputs === null || isInlineTemplate(tNode)) {
    (_a7 = tNode.initialInputs) != null ? _a7 : tNode.initialInputs = [];
...
var ControlDirectiveHostImpl = class {
  constructor(lView, tView, tNode) {
    __publicField(this, "lView");
    __publicField(this, "tView");
    __publicField(this, "tNode");
    __publicField(this, "hasPassThrough");
    this.lView = lView;
    this.tView = tView;
    this.tNode = tNode;
  ...
  setInputOnDirectives(inputName, value) {
    var _a7, _b2;
    const directiveIndices = (_a7 = this.tNode.inputs) == null ? void 0 : _a7[inputName];
    const hostDirectiveInputs = (_b2 = this.tNode.hostDirectiveInputs) == null ? void 0 : _b2[inputName];
...
function initializeControlFirstCreatePass(tView, tNode, lView) {
  ...
  if (controlDef.passThroughInput) {
    if (((_c = (_b2 = (_a7 = tNode.inputs) == null ? void 0 : _a7[controlDef.passThroughInput]) == null ? void 0 : _b2.length) != null ? _c : 0) > 1) {
      tNode.flags |= 4096;
      return;
    }
  }
...
function getComponentName(def) {
  var _a7;
  return ((_a7 = def.debugInfo) == null ? void 0 : _a7.className) || def.type.name || null;
}
...
var ComponentFactory2 = class extends ComponentFactory$1 {
  constructor(componentDef, ngModule) {
    ...
    this.ngContentSelectors = (_a7 = componentDef.ngContentSelectors) != null ? _a7 : [];
    this.isBoundToModule = !!ngModule;
  }
  get inputs() {
    var _a7;
    (_a7 = this.cachedInputs) != null ? _a7 : this.cachedInputs = toInputRefArray(this.componentDef.inputs);
    return this.cachedInputs;
  }
  get outputs() {
    var _a7;
    (_a7 = this.cachedOutputs) != null ? _a7 : this.cachedOutputs = toOutputRefArray(this.componentDef.outputs);
...
var ComponentRef2 = class extends ComponentRef$1 {
  ...
  setInput(name, value) {
    ...
    (_a7 = this.previousInputValues) != null ? _a7 : this.previousInputValues = /* @__PURE__ */ new Map();
...
var R3ViewContainerRef = class _R3ViewContainerRef extends ViewContainerRef {
  ...
  createComponent(componentFactoryOrType, indexOrOptions, injector, projectableNodes, environmentInjector, directives, bindings) {
    ...
    const componentDef = getComponentDef((_a7 = componentFactory.componentType) != null ? _a7 : {});
...
function createLQuery(tView, lView, flags) {
  ...
  const lQueries = ((_b2 = lView[_a7 = QUERIES]) != null ? _b2 : lView[_a7] = new LQueries_()).queries;
...
async function resolveComponentResources(resourceResolver) {
  ...
  const resolutionPromises = Array.from(currentQueue).map(async ([type, component]) => {
    var _a7, _b2;
    if (component.styleUrl && ((_a7 = component.styleUrls) == null ? void 0 : _a7.length)) {
    ...
    const styles = typeof component.styles === "string" ? [component.styles] : (_b2 = component.styles) != null ? _b2 : [];
    ...
    if (styleUrls == null ? void 0 : styleUrls.length) {
...
function componentNeedsResolution(component) {
  var _a7;
  return !!(component.templateUrl && !component.hasOwnProperty("template") || ((_a7 = component.styleUrls) == null ? void 0 : _a7.length) || component.styleUrl);
}
...
__publicField(_StandaloneService, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function \u0275\u0275defineComponent(componentDefinition) {
  return noSideEffects(() => {
    ...
    const def = __spreadProps(__spreadValues({}, baseDef), {
      ...
      signals: (_a7 = componentDefinition.signals) != null ? _a7 : false,
  ...
  for (const minifiedKey in obj) {
    if (obj.hasOwnProperty(minifiedKey)) {
      ...
      if (Array.isArray(value)) {
        inputFlags = value[0];
        publicName = value[1];
        declaredName = (_a7 = value[2]) != null ? _a7 : publicName;
...
function \u0275\u0275definePipe(pipeDef) {
  ...
  return {
    ...
    standalone: (_a7 = pipeDef.standalone) != null ? _a7 : true,
...
function getNgDirectiveDef(directiveDefinition) {
  ...
  return {
    ...
    standalone: (_a7 = directiveDefinition.standalone) != null ? _a7 : true,
...
function initFeatures(definition) {
  var _a7;
  (_a7 = definition.features) == null ? void 0 : _a7.forEach((fn) => fn(definition));
}
...
function \u0275\u0275ControlFeature(passThroughInput) {
  return (definition) => {
    definition.controlDef = {
      ...
      update: (inst, host) => {
        var _a7;
        (_a7 = inst == null ? void 0 : inst.\u0275ngControlUpdate) == null ? void 0 : _a7.call(inst, host);
      },
      passThroughInput
    };
  };
...
function getMinimumDurationForState(tDetails, currentState) {
  ...
  if (currentState === DeferBlockState.Placeholder) {
    return (_b2 = (_a7 = tDetails.placeholderBlockConfig) == null ? void 0 : _a7[MINIMUM_SLOT]) != null ? _b2 : null;
...
function getLoadingBlockAfter(tDetails) {
  var _a7, _b2;
  return (_b2 = (_a7 = tDetails.loadingBlockConfig) == null ? void 0 : _a7[LOADING_AFTER_SLOT]) != null ? _b2 : null;
}
...
function trackTriggerForDebugging(tView, tNode, textRepresentation) {
  var _a7, _b2, _c;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  (_a7 = tDetails.debug) != null ? _a7 : tDetails.debug = {};
  (_c = (_b2 = tDetails.debug).triggers) != null ? _c : _b2.triggers = /* @__PURE__ */ new Set();
...
function getTriggerLView(deferredHostLView, deferredTNode, walkUpTimes) {
  ...
  const triggerLView = (_a7 = deferredContainer[CONTAINER_HEADER_OFFSET]) != null ? _a7 : null;
...
__publicField(_IdleScheduler, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_TimerScheduler, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_CachedInjectorService, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function renderDeferBlockState(newState, tNode, lContainer, skipTimerScheduling = false) {
  ...
  if (isValidStateChange(currentState, newState) && isValidStateChange((_a7 = lDetails[NEXT_DEFER_BLOCK_STATE]) != null ? _a7 : -1, newState)) {
...
function findMatchingDehydratedViewForDeferBlock(lContainer, lDetails) {
  var _a7, _b2;
  const dehydratedViewIx = (_b2 = (_a7 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a7.findIndex((view) => view.data[DEFER_BLOCK_STATE$1] === lDetails[DEFER_BLOCK_STATE])) != null ? _b2 : -1;
...
function applyDeferBlockState(newState, lDetails, lContainer, tNode, hostLView) {
  ...
  if (stateTmplIndex !== null) {
    ...
    if (dehydratedViewIx > -1) {
      (_a7 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a7.splice(dehydratedViewIx, 1);
    }
...
__publicField(_Console, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _Console,
...
function handleEffectCreatedEvent(context2, effect2) {
  ...
  (_a7 = cleanupContainer.onDestroyFns) != null ? _a7 : cleanupContainer.onDestroyFns = [];
...
function getDeferBlocks(node) {
  var _a7;
  const results = [];
  const lView = (_a7 = getLContext(node)) == null ? void 0 : _a7.lView;
  if (lView) {
  ...
  for (const details of blocks) {
    ...
    const data = {
      ...
      loadingBlock: {
        ...
        minimumTime: (_b2 = (_a7 = tDetails.loadingBlockConfig) == null ? void 0 : _a7[MINIMUM_SLOT]) != null ? _b2 : null,
        afterTime: (_d = (_c = tDetails.loadingBlockConfig) == null ? void 0 : _c[LOADING_AFTER_SLOT]) != null ? _d : null
      },
      placeholderBlock: {
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return (_c = (_b2 = (_a7 = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a7.get) == null ? void 0 : _b2.call(_a7, token)) != null ? _c : [];
  }
  const lView = getNodeInjectorLView(injector);
  ...
  return dependencies.filter((dependency) => {
    var _a8;
    const dependencyNode = (_a8 = dependency.injectedIn) == null ? void 0 : _a8.tNode;
...
function getNodeInjectorProviders(injector) {
  ...
  return (_a7 = resolverToProviders.get(diResolver)) != null ? _a7 : [];
}
    ...
    if (!visitedContainers.has(container)) {
      for (const prov of providerToPath.keys()) {
        ...
        deepForEach(containerDef.imports, (moduleImport) => {
          ...
          if (isNextStepInPath) {
            (_a7 = providerToPath.get(prov)) == null ? void 0 : _a7.unshift(container);
          }
        });
      }
    }
...
function getEnvironmentInjectorProviders(injector) {
  var _a7, _b2;
  const providerRecordsWithoutImportPaths = (_a7 = getFrameworkDIDebugData().resolverToProviders.get(injector)) != null ? _a7 : [];
...
function getInjectorMetadata(injector) {
  ...
  if (injector instanceof R3Injector) {
    return {
      type: "environment",
      source: (_a7 = injector.source) != null ? _a7 : null
    };
  }
...
function getInjectorParent(injector) {
  ...
  if (hasParentInjector(parentLocation)) {
    ...
    const injectorParent = (_a7 = chainedInjector.injector) == null ? void 0 : _a7.parent;
...
function getTemplateConsumer(injector) {
  ...
  if (isLView(templateLView)) {
    return (_a7 = templateLView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a7 : null;
  }
  return null;
}
...
function getNodesAndEdgesFromSignalMap(signalMap) {
  ...
  for (const [consumer, producers] of signalMap.entries()) {
    ...
    if (isComputedNode(consumer)) {
      ...
      debugSignalGraphNodes.push({
        label: (_e = consumer.debugName) != null ? _e : (_d = (_c = (_b2 = (_a7 = consumer.lView) == null ? void 0 : _a7[HOST]) == null ? void 0 : _b2.tagName) == null ? void 0 : _c.toLowerCase) == null ? void 0 : _d.call(_c),
        kind: consumer.kind,
        epoch: consumer.version,
        debuggableFn: (_g = (_f = consumer.lView) == null ? void 0 : _f[CONTEXT]) == null ? void 0 : _g.constructor,
        id
      });
    } else {
      debugSignalGraphNodes.push({
...
function extractEffectsFromInjector(injector) {
  ...
  const effects = (_a7 = resolverToEffects.get(diResolver)) != null ? _a7 : [];
...
function publishUtil(name, fn) {
  ...
  if (typeof COMPILED === "undefined" || !COMPILED) {
    ...
    (_a7 = w[GLOBAL_PUBLISH_EXPANDO_KEY]) != null ? _a7 : w[GLOBAL_PUBLISH_EXPANDO_KEY] = {};
...
var _Testability = class _Testability {
  constructor(_ngZone, registry, testabilityGetter) {
    ...
    if (isInInjectionContext()) {
      this._destroyRef = (_a7 = inject2(DestroyRef, {
        optional: true
      })) != null ? _a7 : void 0;
    }
  ...
  _watchAngularEvents() {
    ...
    (_a7 = this._destroyRef) == null ? void 0 : _a7.onDestroy(() => {
...
__publicField(_Testability, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _Testability,
...
var _TestabilityRegistry = class _TestabilityRegistry {
  ...
  findTestabilityInTree(elem, findInAncestors = true) {
    var _a7;
    return (_a7 = _testabilityGetter == null ? void 0 : _testabilityGetter.findTestabilityInTree(this, elem, findInAncestors)) != null ? _a7 : null;
  }
};
...
__publicField(_TestabilityRegistry, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  constructor() {
    ...
    __publicField(this, "appInits", (_a5 = inject2(APP_INITIALIZER, {
      optional: true
    })) != null ? _a5 : []);
    __publicField(this, "injector", inject2(Injector));
...
__publicField(_ApplicationInitStatus, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _ApplicationRef = class _ApplicationRef {
  constructor() {
    ...
    __publicField(this, "internalErrorHandler", inject2(INTERNAL_APPLICATION_ERROR_HANDLER));
    __publicField(this, "afterRenderManager", inject2(AfterRenderManager));
    __publicField(this, "zonelessEnabled", inject2(ZONELESS_ENABLED));
    __publicField(this, "rootEffectScheduler", inject2(EffectScheduler));
    ...
    __publicField(this, "internalPendingTask", inject2(PendingTasksInternal));
    __publicField(this, "_injector", inject2(EnvironmentInjector));
    ...
    __publicField(this, "tickImpl", () => {
      ...
      try {
        ...
        (_a7 = this.tracingSnapshot) == null ? void 0 : _a7.dispose();
  ...
  synchronizeOnce() {
    ...
    if (!ranDetectChanges) {
      (_b2 = (_a7 = this._rendererFactory) == null ? void 0 : _a7.begin) == null ? void 0 : _b2.call(_a7);
...
__publicField(_ApplicationRef, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function triggerResourceLoading(tDetails, lView, tNode) {
  ...
  const tView = lView[TVIEW];
  if (tDetails.loadingState !== DeferDependenciesLoadingState.NOT_STARTED) {
    return (_a7 = tDetails.loadingPromise) != null ? _a7 : Promise.resolve();
  }
  const lDetails = getLDeferBlockDetails(lView, tNode);
    ...
    if (failed) {
      ...
      if (tDetails.errorTmplIndex === null) {
        ...
        if (ngDevMode) {
          ...
          const errorReason = failedReason == null ? void 0 : failedReason.message;
          if (depsFn) {
            errorMsg += `
...
async function triggerHydrationForBlockQueue(injector, hydrationQueue, replayQueuedEventsFn) {
  ...
  await ((_a7 = blocksBeingHydrated.get(lastBlockName)) == null ? void 0 : _a7.promise);
...
function cleanupRemainingHydrationQueue(hydrationQueue, dehydratedBlockRegistry) {
  ...
  for (const dehydratedBlockId in hydrationQueue) {
    (_a7 = blocksBeingHydrated.get(dehydratedBlockId)) == null ? void 0 : _a7.reject();
  }
...
function getHydrateTriggers(tView, tNode) {
  var _a7;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  return (_a7 = tDetails.hydrateTriggers) != null ? _a7 : tDetails.hydrateTriggers = /* @__PURE__ */ new Map();
}
function \u0275\u0275defer(index, primaryTmplIndex, dependencyResolverFn, loadingTmplIndex, placeholderTmplIndex, errorTmplIndex, loadingConfigIndex, placeholderConfigIndex, enableTimerScheduling, flags) {
  ...
  if (((_a7 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a7.length) > 0) {
...
function runLeaveAnimations(lView, tNode, value, ngZone) {
  ...
  ((_b2 = (_a7 = getLViewLeaveAnimations(lView).get(tNode.index)).resolvers) != null ? _b2 : _a7.resolvers = []).push(resolve);
  const activeClasses = getClassListFromValue(value);
  if (activeClasses && activeClasses.length > 0) {
...
function animateLeaveClassRunner(el, tNode, lView, classList, renderer, ngZone) {
  ...
  const cleanupFns = [];
  const componentResolvers = (_a7 = getLViewLeaveAnimations(lView).get(tNode.index)) == null ? void 0 : _a7.resolvers;
...
function runLeaveAnimationFunction(lView, tNode, value, ngZone, maxAnimationTimeout) {
  ...
  const animationsDisabled = areAnimationsDisabled(lView);
  ((_b2 = (_a7 = getLViewLeaveAnimations(lView).get(tNode.index)).resolvers) != null ? _b2 : _a7.resolvers = []).push(resolve);
  const resolvers = (_c = getLViewLeaveAnimations(lView).get(tNode.index)) == null ? void 0 : _c.resolvers;
  if (animationsDisabled) {
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  create(index, value) {
    ...
    ngDevMode && ((_a7 = this.operationsCounter) == null ? void 0 : _a7.recordCreate());
    return embeddedLView;
  }
  destroy(lView) {
    var _a7;
    destroyLView(lView[TVIEW], lView);
    ngDevMode && ((_a7 = this.operationsCounter) == null ? void 0 : _a7.recordDestroy());
  }
  updateValue(index, value) {
  ...
  reset() {
    ...
    ngDevMode && ((_a7 = this.operationsCounter) == null ? void 0 : _a7.reset());
  }
  updateIndexes() {
...
function \u0275\u0275repeater(collection) {
  ...
  try {
    ...
    if (ngDevMode && metadata.trackByFn === \u0275\u0275repeaterTrackByIdentity && ((_a7 = liveCollection.operationsCounter) == null ? void 0 : _a7.wasReCreated(liveCollection.length)) && isViewExpensiveToRecreate(getExistingLViewFromLContainer(lContainer, 0))) {
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
  ...
  if (processOutputs) {
    const outputConfig = (_a7 = tNode.outputs) == null ? void 0 : _a7[eventName];
...
function \u0275\u0275pipe(index, pipeName) {
  ...
  if (tView.firstCreatePass) {
    ...
    if (pipeDef.onDestroy) {
      ((_a7 = tView.destroyHooks) != null ? _a7 : tView.destroyHooks = []).push(adjustedIndex, pipeDef.onDestroy);
    }
  } else {
...
function clearRendererCache(factory, def) {
  var _a7;
  (_a7 = factory.componentReplaced) == null ? void 0 : _a7.call(factory, def.id);
}
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b2 = (_a7 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a7.send) == null ? void 0 : _b2.call(_a7, "angular:invalidate", {
        id,
        message: toLog,
        error: true
      });
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a7 = metadata.hostDirectives) == null ? void 0 : _a7.map((directive) => typeof directive === "function" ? {
      directive
    } : directive)) || null
  };
}
...
__publicField(_Compiler, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _Compiler,
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  constructor() {
    __publicField(this, "applicationErrorHandler", inject2(INTERNAL_APPLICATION_ERROR_HANDLER));
    __publicField(this, "appRef", inject2(ApplicationRef));
    __publicField(this, "taskService", inject2(PendingTasksInternal));
    __publicField(this, "ngZone", inject2(NgZone));
    __publicField(this, "zonelessEnabled", inject2(ZONELESS_ENABLED));
    __publicField(this, "tracing", inject2(TracingService, {
      optional: true
    }));
    ...
    __publicField(this, "angularZoneId", this.zoneIsDefined ? (_a6 = this.ngZone._inner) == null ? void 0 : _a6.get(angularZoneInstanceIdProperty) : null);
    __publicField(this, "scheduleInRootZone", !this.zonelessEnabled && this.zoneIsDefined && ((_b = inject2(SCHEDULE_IN_ROOT_ZONE, {
      optional: true
    })) != null ? _b : false));
  ...
  notify(source) {
    ...
    this.appRef.tracingSnapshot = (_b2 = (_a7 = this.tracing) == null ? void 0 : _a7.snapshot(this.appRef.tracingSnapshot)) != null ? _b2 : null;
  ...
  cleanup() {
    ...
    (_a7 = this.cancelScheduledCallback) == null ? void 0 : _a7.call(this);
...
__publicField(_ChangeDetectionSchedulerImpl, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var OutputEmitterRef = class {
  constructor() {
    ...
    __publicField(this, "destroyRef", inject2(DestroyRef));
  ...
  subscribe(callback) {
    ...
    ((_a7 = this.listeners) != null ? _a7 : this.listeners = []).push(callback);
    return {
      unsubscribe: () => {
        var _a8, _b2;
...
var BaseWritableResource = class {
  ...
  get snapshot() {
    var _a7;
    return (_a7 = this._snapshot) != null ? _a7 : this._snapshot = computed(() => {
...
var ResourceImpl = class extends BaseWritableResource {
  constructor(request, loaderFn, defaultValue, equal, debugName, injector, getInitialStream) {
    super(computed(() => {
      var _a7, _b2;
      const streamValue = (_b2 = (_a7 = this.state()).stream) == null ? void 0 : _b2.call(_a7);
      if (!streamValue) {
        return defaultValue;
      }
    ...
    this.state = linkedSignal(__spreadValues({
      ...
      computation: (extRequest, previous) => {
        if (!previous) {
          const initialStream = getInitialStream == null ? void 0 : getInitialStream(extRequest.request);
    ...
    this.error = computed(() => {
      var _a7, _b2;
      const stream = (_b2 = (_a7 = this.state()).stream) == null ? void 0 : _b2.call(_a7);
  ...
  abortInProgressLoad() {
    ...
    untracked2(() => {
      var _a8;
      return (_a8 = this.pendingController) == null ? void 0 : _a8.abort();
    });
    this.pendingController = void 0;
    (_a7 = this.resolvePendingTask) == null ? void 0 : _a7.call(this);
...
function createInputSignal(initialValue, options) {
  ...
  function inputValueFn() {
    ...
    if (node.value === REQUIRED_UNSET_VALUE) {
      let message = null;
      if (ngDevMode) {
        const name = (_a7 = options == null ? void 0 : options.debugName) != null ? _a7 : options == null ? void 0 : options.alias;
...
function compileNgModuleFactory(injector, options, moduleType) {
  ...
  const compilerProviders = compilerOptions.flatMap((option) => {
    var _a7;
    return (_a7 = option.providers) != null ? _a7 : [];
  });
...
var _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  constructor() {
    __publicField(this, "zone", inject2(NgZone));
    __publicField(this, "changeDetectionScheduler", inject2(ChangeDetectionScheduler));
    __publicField(this, "applicationRef", inject2(ApplicationRef));
    __publicField(this, "applicationErrorHandler", inject2(INTERNAL_APPLICATION_ERROR_HANDLER));
  ...
  ngOnDestroy() {
    var _a7;
    (_a7 = this._onMicrotaskEmptySubscription) == null ? void 0 : _a7.unsubscribe();
  }
};
...
__publicField(_NgZoneChangeDetectionScheduler, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function getNgZoneOptions(options) {
  ...
  return {
    ...
    shouldCoalesceEventChangeDetection: (_a7 = options == null ? void 0 : options.eventCoalescing) != null ? _a7 : false,
...
var _ZoneStablePendingTask = class _ZoneStablePendingTask {
  constructor() {
    ...
    __publicField(this, "initialized", false);
    __publicField(this, "zone", inject2(NgZone));
    __publicField(this, "pendingTasks", inject2(PendingTasksInternal));
  }
  initialize() {
    if (this.initialized) {
      return;
...
__publicField(_ZoneStablePendingTask, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  constructor() {
    ...
    __publicField(this, "options", inject2(IMAGE_CONFIG));
    __publicField(this, "lcpImageUrl");
  }
  start() {
    var _a7, _b2;
    if (typeof PerformanceObserver === "undefined" || ((_a7 = this.options) == null ? void 0 : _a7.disableImageSizeWarning) && ((_b2 = this.options) == null ? void 0 : _b2.disableImageLazyLoadWarning)) {
      return;
    }
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a8 = this.window) == null ? void 0 : _a8.addEventListener("load", waitToScan, {
            once: true
          });
        }
      };
  ...
  ngOnDestroy() {
    var _a7;
    (_a7 = this.observer) == null ? void 0 : _a7.disconnect();
  }
  initPerformanceObserver() {
    ...
    const observer = new PerformanceObserver((entryList) => {
      ...
      const imgSrc = (_b2 = (_a7 = lcpElement.element) == null ? void 0 : _a7.src) != null ? _b2 : "";
...
__publicField(_ImagePerformanceWarning, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
    ...
    return _callAndReportToErrorHandler(exceptionHandler, ngZone, () => {
      ...
      return initStatus.donePromise.then(() => {
        ...
        if (isApplicationBootstrapConfig(config2)) {
          ...
          moduleBootstrapImpl == null ? void 0 : moduleBootstrapImpl(config2.moduleRef, config2.allPlatformModules);
          return config2.moduleRef;
        }
...
var _PlatformRef = class _PlatformRef {
  ...
  bootstrapModuleFactory(moduleFactory, options) {
    var _a7;
    const allAppProviders = [provideZonelessChangeDetectionInternal(), ...(_a7 = options == null ? void 0 : options.applicationProviders) != null ? _a7 : [], errorHandlerEnvironmentInitializer, ...ngDevMode ? [validAppIdInitializer] : []];
...
__publicField(_PlatformRef, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _PlatformRef,
...
function createPlatformFactory(parentPlatformFactory, name, providers = []) {
  ...
  return (extraProviders = []) => {
    ...
    if (!platform) {
      ...
      platform = (_a7 = parentPlatformFactory == null ? void 0 : parentPlatformFactory(platformProviders)) != null ? _a7 : createPlatform(createPlatformInjector(platformProviders, desc));
    }
...
function getPlatform() {
  ...
  return (_a7 = _platformInjector == null ? void 0 : _platformInjector.get(PlatformRef)) != null ? _a7 : null;
}
...
__publicField(_IterableDiffers, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_KeyValueDiffers, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_ApplicationModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
...
function internalCreateApplication(config2) {
  ...
  try {
    const platformInjector = (_a7 = platformRef == null ? void 0 : platformRef.injector) != null ? _a7 : createOrReusePlatformInjector(platformProviders);
...
//# sourceMappingURL=chunk-J5J5AFBH.js.map
