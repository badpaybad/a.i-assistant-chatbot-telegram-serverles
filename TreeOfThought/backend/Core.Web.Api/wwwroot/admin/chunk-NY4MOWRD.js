...
_UserListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], viewQuery: function UserListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275pipe(43, "transloco");
    \u0275\u0275listener("pageIndexChange", function UserListComponent_Template_tot_table_pageIndexChange_42_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageIndex = $event;
      return \u0275\u0275resetView(ctx.loadUsers());
    })("pageSizeChange", function UserListComponent_Template_tot_table_pageSizeChange_42_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return \u0275\u0275resetView(ctx.loadUsers());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserListComponent, { className: "UserListComponent", filePath: "projects/tot/business-oidc/src/lib/user-list/user-list.component.ts", lineNumber: 347 });
})();
...
_RoleListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleListComponent, selectors: [["app-role-list"]], viewQuery: function RoleListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "transloco");
    \u0275\u0275listener("pageIndexChange", function RoleListComponent_Template_tot_table_pageIndexChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageIndex = $event;
      return \u0275\u0275resetView(ctx.loadRoles());
    })("pageSizeChange", function RoleListComponent_Template_tot_table_pageSizeChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return \u0275\u0275resetView(ctx.loadRoles());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoleListComponent, { className: "RoleListComponent", filePath: "projects/tot/business-oidc/src/lib/role-list/role-list.component.ts", lineNumber: 179 });
})();
...
_AclListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AclListComponent, selectors: [["app-acl-list"]], decls: 35, vars: 39, consts: [[1, "page-header"], [1, "filter-card"], [1, "filter-box"], [1, "filter-item"], [1, "label"], ["nz-input", "", 2, "width", "150px", 3, "ngModelChange", "ngModel", "placeholder"], ["nzType", "primary", 3, "click"], ["nz-icon", "", "nzType", "search"], ["nzType", "default", 3, "click"], ["nz-icon", "", "nzType", "plus"], [3, "pageIndexChange", "pageSizeChange", "data", "columns", "loading", "title", "frontPagination", "pageIndex", "pageSize", "total", "scroll"], ["totCell", "subject"], ["totCell", "resource"], ["totCell", "mask"], ["totCell", "action"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle"], [4, "nzModalContent"], ["class", "subject-info", 4, "ngIf"], [1, "subject-info"], ["nz-icon", "", "nzType", "user"], ["nz-icon", "", "nzType", "team"], [1, "mask-display"], [1, "mask-value"], [1, "mask-details"], ["nzColor", "blue", 4, "ngIf"], ["nzColor", "green", 4, "ngIf"], ["nzColor", "red", 4, "ngIf"], ["nzColor", "orange", 4, "ngIf"], ["nzColor", "blue"], ["nzColor", "green"], ["nzColor", "red"], ["nzColor", "orange"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzDanger"], ["nz-form", "", "nzLayout", "vertical"], [3, "nzSpan"], ["name", "subjectType", 3, "ngModelChange", "ngModel"], ["nz-radio", "", "nzValue", "user"], ["nz-radio", "", "nzValue", "role"], [4, "ngIf"], [2, "display", "flex", "gap", "8px"], ["nz-input", "", "name", "resType", 2, "width", "120px", 3, "ngModelChange", "ngModel", "placeholder"], ["nz-input", "", "name", "resId", 2, "flex", "1", 3, "ngModelChange", "ngModel", "placeholder"], ["name", "perms", 3, "ngModelChange", "ngModel"], ["apiUrl", "/api/AuthManagement/users", "labelField", "username", "name", "userId", 3, "ngModelChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/roles", "name", "roleId", 3, "ngModelChange", "placeholder", "ngModel"]], template: function AclListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(27, "transloco");
    \u0275\u0275listener("pageIndexChange", function AclListComponent_Template_tot_table_pageIndexChange_26_listener($event) {
      ctx.pageIndex = $event;
      return ctx.filter.resourceType && ctx.filter.resourceId ? ctx.loadAcl() : null;
    })("pageSizeChange", function AclListComponent_Template_tot_table_pageSizeChange_26_listener($event) {
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return ctx.filter.resourceType && ctx.filter.resourceId ? ctx.loadAcl() : null;
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AclListComponent, { className: "AclListComponent", filePath: "projects/tot/business-oidc/src/lib/acl-list/acl-list.component.ts", lineNumber: 223 });
})();
...
_ClaimSyncComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClaimSyncComponent, selectors: [["app-claim-sync"]], decls: 41, vars: 44, consts: [[1, "page-header"], ["nzType", "primary", 3, "click"], ["nz-icon", "", "nzType", "plus"], [1, "search-card", 3, "nzTitle"], ["nz-row", "", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], ["nz-input", "", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], [2, "width", "100%", 3, "ngModelChange", "ngModel"], ["nz-col", "", 1, "search-actions", 3, "nzSpan"], ["nzType", "primary", 3, "click", 4, "nzSpaceItem"], [3, "click", 4, "nzSpaceItem"], [2, "margin-bottom", "16px", 3, "nzTitle"], [1, "sync-actions"], ["nzType", "primary", 3, "click", "loading"], ["nz-icon", "", "nzType", "sync"], [3, "pageIndexChange", "pageSizeChange", "data", "columns", "loading", "title", "frontPagination", "pageIndex", "pageSize", "total", "scroll"], ["totCell", "createdAt"], ["totCell", "action"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle"], [4, "nzModalContent"], [3, "click"], [2, "display", "flex", "gap", "4px", "flex-direction", "column"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzDanger", "disabled"], ["nz-form", "", "nzLayout", "vertical"], [3, "nzSpan"], ["nz-input", "", "name", "name", 3, "ngModelChange", "ngModel", "placeholder"], ["nz-input", "", "name", "description", 3, "ngModelChange", "ngModel", "placeholder"]], template: function ClaimSyncComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(35, "transloco");
    \u0275\u0275listener("pageIndexChange", function ClaimSyncComponent_Template_tot_table_pageIndexChange_34_listener($event) {
      ctx.pageIndex = $event;
      return ctx.loadClaims();
    })("pageSizeChange", function ClaimSyncComponent_Template_tot_table_pageSizeChange_34_listener($event) {
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return ctx.loadClaims();
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClaimSyncComponent, { className: "ClaimSyncComponent", filePath: "projects/tot/business-oidc/src/lib/claim-sync/claim-sync.component.ts", lineNumber: 134 });
})();
...
_NotifyComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotifyComponent, selectors: [["tot-notify"]], decls: 26, vars: 36, consts: [["suffixIconSearch", ""], [1, "page-header"], [1, "search-card", 3, "nzTitle"], ["nz-row", "", "nzAlign", "middle", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], ["nz-col", "", 1, "search-actions", 3, "nzSpan"], ["nzType", "primary", 3, "click", 4, "nzSpaceItem"], [3, "click", 4, "nzSpaceItem"], [3, "pageIndexChange", "pageSizeChange", "data", "columns", "loading", "title", "frontPagination", "pageIndex", "pageSize", "total", "scroll"], ["totCell", "avatar"], ["totCell", "user"], ["totCell", "action"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle", "nzOkText", "nzCancelText", "nzOkLoading"], [4, "nzModalContent"], ["nz-icon", "", "nzType", "search"], ["nzType", "primary", 3, "click"], [3, "click"], ["nzIcon", "user", 3, "nzSrc", "nzSize"], [1, "user-cell"], [1, "sub-text"], ["nzType", "primary", "nzSize", "small", 3, "click"], ["nz-icon", "", "nzType", "notification"], ["nz-form", "", "nzLayout", "vertical"], ["nzRequired", ""], [3, "nzErrorTip"], ["name", "fcmToken", 2, "width", "100%", 3, "ngModelChange", "ngModel", "nzPlaceHolder", "nzLoading"], [3, "nzValue", "nzLabel", 4, "ngFor", "ngForOf"], ["class", "no-devices-warning", 4, "ngIf"], ["nz-input", "", "name", "title", "required", "", 3, "ngModelChange", "ngModel", "placeholder"], ["nz-input", "", "name", "body", "required", "", 3, "ngModelChange", "ngModel", "nzAutosize", "placeholder"], [3, "nzValue", "nzLabel"], [1, "no-devices-warning"], ["nz-icon", "", "nzType", "warning", "nzTheme", "outline"]], template: function NotifyComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(18, "transloco");
    \u0275\u0275listener("pageIndexChange", function NotifyComponent_Template_tot_table_pageIndexChange_17_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageIndex = $event;
      return \u0275\u0275resetView(ctx.loadUsers());
    })("pageSizeChange", function NotifyComponent_Template_tot_table_pageSizeChange_17_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.pageSize = $event;
      ctx.pageIndex = 1;
      return \u0275\u0275resetView(ctx.loadUsers());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotifyComponent, { className: "NotifyComponent", filePath: "projects/tot/business-oidc/src/lib/notify/notify.component.ts", lineNumber: 200 });
})();
export {
  AclListComponent,
...
//# sourceMappingURL=chunk-NY4MOWRD.js.map
