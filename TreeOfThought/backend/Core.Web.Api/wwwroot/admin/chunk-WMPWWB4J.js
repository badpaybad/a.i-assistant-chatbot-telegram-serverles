...
var ClaimSyncComponent = class _ClaimSyncComponent {
    ...
    this.modal.confirm({
      ...
      nzOnOk: async () => {
        try {
          ...
          this.notification.error(this.translate.instant("Th\u1EA5t b\u1EA1i"), e.error?.message || this.translate.instant("X\xF3a quy\u1EC1n th\u1EA5t b\u1EA1i"));
        }
      }
    });
  }
  static \u0275fac = function ClaimSyncComponent_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-WMPWWB4J.js.map
