...
var FirebaseService = class _FirebaseService {
  ...
  db;
  messaging;
  firebaseUserSubject = new BehaviorSubject(null);
  ...
  async loginWithGoogle() {
    const { GoogleAuthProvider, signInWithPopup } = await import("./chunk-RI5TWFRF.js");
    const provider = new GoogleAuthProvider();
    const result = await signInWithPopup(this.auth, provider);
    return result.user;
  }
  async loginWithFacebook() {
    const { FacebookAuthProvider, signInWithPopup } = await import("./chunk-RI5TWFRF.js");
    const provider = new FacebookAuthProvider();
    const result = await signInWithPopup(this.auth, provider);
    return result.user;
  }
  async loginWithMicrosoft() {
    const { OAuthProvider, signInWithPopup } = await import("./chunk-RI5TWFRF.js");
  ...
  async getFCMToken() {
    if (!this.messaging)
      return null;
    try {
      const token = await getToken2(this.messaging, { vapidKey: environment.firebase.vapidKey });
      return token;
    } catch (error) {
  ...
  static \u0275fac = function FirebaseService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FirebaseService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FirebaseService, factory: _FirebaseService.\u0275fac, providedIn: "root" });
};
(() => {
...
//# sourceMappingURL=chunk-3NZ5Q47C.js.map
