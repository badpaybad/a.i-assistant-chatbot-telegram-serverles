...
var CqrsTestComponent = class _CqrsTestComponent {
  ...
  commandPayload = '{"message": "Hello from UI Test Command", "timestamp": "' + (/* @__PURE__ */ new Date()).toISOString() + '"}';
  eventData = '{"message": "Hello from UI Test Event", "timestamp": "' + (/* @__PURE__ */ new Date()).toISOString() + '"}';
  ...
  static \u0275fac = function CqrsTestComponent_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-VJJEH7JN.js.map
