...
} from "./chunk-KQHSXDSZ.js";
import {
  NzAvatarComponent,
  NzAvatarModule
} from "./chunk-GGZZY2RY.js";
import {
  NzDatePickerComponent,
  NzDatePickerModule,
  NzDividerComponent,
  NzDividerModule
} from "./chunk-SW36GVRM.js";
import {
  ActivatedRoute,
...
var _DashboardService = class _DashboardService {
  ...
  getMessages(queueName, pageIndex = 1, pageSize = 10) {
    return from(this.http.get(`/api/cqrs/dashboard/messages/${queueName}?pageIndex=${pageIndex}&pageSize=${pageSize}`));
  }
...
function MessageListComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, ctx_r2.getTime(data_r2), "yyyy-MM-dd HH:mm:ss"), " ");
  }
}
function MessageListComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MessageListComponent_ng_template_3_Template_div_click_0_listener() {
      const data_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleExpand(data_r5));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "slice");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(2, 2, data_r5.raw, 0, 100), "", data_r5.raw.length > 100 ? "..." : "", " ");
  }
}
function MessageListComponent_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("nzColor", ctx_r2.getStatus(data_r6) === "error" ? "error" : ctx_r2.getStatus(data_r6) === "processing" ? "processing" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, ctx_r2.getStatus(data_r6)), " ");
  }
}
function MessageListComponent_ng_template_5_tot_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MessageListComponent_ng_template_5_tot_button_1_Template_tot_button_click_0_listener() {
      ...
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.resend(data_r9));
    });
    \u0275\u0275element(1, "i", 16);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
...
function MessageListComponent_ng_template_5_tot_button_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MessageListComponent_ng_template_5_tot_button_2_Template_tot_button_click_0_listener() {
      ...
      const data_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.delete(data_r9));
    });
    \u0275\u0275element(1, "i", 18);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
...
function MessageListComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MessageListComponent_ng_template_5_Template_tot_button_click_3_listener() {
      ...
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleExpand(data_r9));
    });
    \u0275\u0275element(4, "i", 14);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "transloco");
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.queueName.endsWith(":dead"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.queueName.endsWith(":dead"));
    \u0275\u0275advance(2);
    \u0275\u0275property("nzType", data_r9.expand ? "up" : "down");
    \u0275\u0275advance();
...
function MessageListComponent_ng_template_6_div_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(data_r12.parsed._error);
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_nz_tag_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("nzColor", step_r13.status.toLowerCase() === "success" ? "success" : "error");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r13.status, " ");
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_div_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.shortenNamespace(step_r13.sourceComponent));
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.shortenNamespace(step_r13.handlerOrEventName));
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_div_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(step_r13.workerName);
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_div_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", step_r13.details);
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_div_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(step_r13.details);
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_nz_timeline_item_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", (step_r13.status == null ? null : step_r13.status.toLowerCase()) === "error" ? "red" : (step_r13.status == null ? null : step_r13.status.toLowerCase()) === "success" ? "green" : "blue");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 10, step_r13.timestamp || step_r13.time, "yyyy-MM-dd HH:mm:ss.SSS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("nzColor", step_r13.step === "send" ? "blue" : step_r13.step === "dequeue" ? "orange" : step_r13.step === "done" ? "green" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r13.step, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r13.status);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", step_r13.sourceComponent);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r13.handlerOrEventName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r13.workerName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r13.details && (step_r13.status == null ? null : step_r13.status.toLowerCase()) !== "error");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (step_r13.status == null ? null : step_r13.status.toLowerCase()) === "error");
  }
}
function MessageListComponent_ng_template_6_nz_timeline_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r12.history);
  }
}
...
function MessageListComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MessageListComponent_ng_template_6_Template_tot_button_click_8_listener() {
      ...
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.copyToClipboard(data_r12.raw));
    });
    \u0275\u0275element(9, "i", 26);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "transloco");
  ...
  if (rf & 2) {
    ...
    const loadingHistory_r14 = \u0275\u0275reference(23);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.formatJson(data_r12.parsed));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", data_r12.parsed._error);
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 14);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 14, "L\u1ECBch s\u1EED d\xF2ng th\u1EDDi gian s\u1EF1 ki\u1EC7n (Tracking)"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", data_r12.history && data_r12.history.length > 0)("ngIfElse", loadingHistory_r14);
  }
}
...
_MessageListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MessageListComponent, selectors: [["app-message-list"]], inputs: { inputQueueName: "inputQueueName" }, decls: 8, vars: 8, consts: [["expandTpl", ""], ["loadingHistory", ""], [1, "message-list-container"], [3, "pageIndexChange", "pageSizeChange", "expandChange", "data", "columns", "loading", "total", "pageIndex", "pageSize", "frontPagination", "expandTemplate"], ["totCell", "time"], ["totCell", "content"], ["totCell", "status"], ["totCell", "action"], [1, "msg-preview", 3, "click"], [3, "nzColor"], [2, "display", "flex", "gap", "8px"], ["nzType", "primary", "nzSize", "small", 3, "click", 4, "ngIf"], ["nzSize", "small", 3, "nzDanger", "click", 4, "ngIf"], ["nzSize", "small", 3, "click"], ["nz-icon", "", 3, "nzType"], ["nzType", "primary", "nzSize", "small", 3, "click"], ["nz-icon", "", "nzType", "rollback"], ["nzSize", "small", 3, "click", "nzDanger"], ["nz-icon", "", "nzType", "delete"], [1, "json-viewer-container", 2, "background", "#fff", "padding", "20px", "border-radius", "6px", "width", "100%", "border", "1px solid #f0f0f0"], ["nz-row", "", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], [2, "display", "flex", "justify-content", "space-between", "margin-bottom", "8px", "align-items", "center"], [2, "font-weight", "bold", "color", "#1890ff", "font-size", "14px"], ["nz-icon", "", "nzType", "code"], ["nzType", "default", "nzSize", "small", 3, "click"], ["nz-icon", "", "nzType", "copy"], [2, "margin", "0", "color", "#333", "background", "#fafafa", "border", "1px solid #d9d9d9", "padding", "12px", "border-radius", "4px", "font-size", "12px", "overflow", "auto", "max-height", "400px", "font-family", "monospace", "white-space", "pre-wrap", "word-break", "break-all"], ["style", "margin-top: 12px; padding: 12px; background: #fff1f0; border-left: 4px solid #ff4d4f; border-radius: 4px; border: 1px solid #ffa39e; border-left-width: 4px;", 4, "ngIf"], [2, "font-weight", "bold", "color", "#1890ff", "font-size", "14px", "margin-bottom", "16px"], ["nz-icon", "", "nzType", "history"], [1, "timeline-wrapper", 2, "max-height", "400px", "overflow-y", "auto", "padding-right", "8px"], [4, "ngIf", "ngIfElse"], [2, "margin-top", "12px", "padding", "12px", "background", "#fff1f0", "border-left", "4px solid #ff4d4f", "border-radius", "4px", "border", "1px solid #ffa39e", "border-left-width", "4px"], [2, "font-weight", "bold", "color", "#cf1322", "margin-bottom", "4px"], ["nz-icon", "", "nzType", "warning"], [2, "color", "#ff4d4f", "font-family", "monospace", "font-size", "11px"], [3, "nzColor", 4, "ngFor", "ngForOf"], [2, "display", "flex", "align-items", "center", "gap", "8px", "margin-bottom", "4px"], [2, "font-weight", "bold", "font-family", "monospace", "font-size", "11px", "color", "#888"], [3, "nzColor", 4, "ngIf"], [2, "background", "#fafafa", "padding", "8px", "border-radius", "4px", "border-left", "3px solid #d9d9d9", "margin-bottom", "8px", "font-size", "11px"], [4, "ngIf"], ["style", "margin-top: 4px; color: #555;", 4, "ngIf"], ["style", "margin-top: 4px; color: #cf1322; font-family: monospace; font-size: 11px; white-space: pre-wrap; word-break: break-all;", 4, "ngIf"], [2, "color", "#666"], [2, "color", "#c41d7f"], [2, "color", "#389e0d"], [2, "color", "#d46b08"], [2, "margin-top", "4px", "color", "#555"], ["nz-icon", "", "nzType", "info-circle", 2, "color", "#1890ff"], [2, "margin-top", "4px", "color", "#cf1322", "font-family", "monospace", "font-size", "11px", "white-space", "pre-wrap", "word-break", "break-all"], [2, "display", "flex", "flex-direction", "column", "align-items", "center", "justify-content", "center", "height", "150px", "color", "#999"], ["nz-icon", "", "nzType", "loading", 2, "font-size", "24px", "color", "#1890ff", "margin-bottom", "8px"], [2, "font-size", "12px"]], template: function MessageListComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const expandTpl_r15 = \u0275\u0275reference(7);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.messages)("columns", ctx.msgColumns)("loading", ctx.loading)("total", ctx.total)("pageIndex", ctx.pageIndex)("pageSize", ctx.pageSize)("frontPagination", false)("expandTemplate", expandTpl_r15);
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
(() => {
  ...
  <tot-table 
    ...
    (pageIndexChange)="pageIndex = $event; loadMessages()"
    (pageSizeChange)="pageSize = $event; pageIndex = 1; loadMessages()"
...
function DashboardComponent_div_87_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r5 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r5.activeCount);
  }
}
function DashboardComponent_div_87_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r6 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r6.sendSuccessCount);
  }
}
function DashboardComponent_div_87_ng_template_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r7.sendErrorCount);
  }
}
function DashboardComponent_div_87_ng_template_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r8.doneSuccessCount);
  }
}
function DashboardComponent_div_87_ng_template_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r9 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r9.doneErrorCount);
  }
}
...
function DashboardComponent_div_87_ng_template_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r11.workers);
  }
}
function DashboardComponent_div_87_ng_template_10_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("nz-tooltip", h_r12.handlerName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(h_r12.handlerName));
    \u0275\u0275advance();
    \u0275\u0275property("nz-tooltip", h_r12.messageName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(h_r12.messageName));
  }
}
function DashboardComponent_div_87_ng_template_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r13.handlers);
  }
}
function DashboardComponent_div_87_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_87_ng_template_11_Template_tot_button_click_1_listener() {
      ...
      return \u0275\u0275resetView(ctx_r3.viewDetails(data_r15));
    });
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_87_ng_template_11_Template_tot_button_click_4_listener() {
      const data_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.viewInProgress(data_r15));
    });
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "transloco");
    \u0275\u0275elementEnd()();
...
function DashboardComponent_div_87_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("pageIndexChange", function DashboardComponent_div_87_Template_tot_table_pageIndexChange_3_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onQueuePageChange($event));
    })("pageSizeChange", function DashboardComponent_div_87_Template_tot_table_pageSizeChange_3_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onQueuePageSizeChange($event));
    });
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(2, 10, "Danh s\xE1ch H\xE0ng \u0111\u1EE3i (Queue)"));
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r3.pagedQueues)("columns", ctx_r3.queueColumns)("loading", ctx_r3.loading)("total", ctx_r3.allQueues.length)("pageIndex", ctx_r3.queuePageIndex)("pageSize", ctx_r3.queuePageSize)("frontPagination", false)("showPagination", true)("scroll", \u0275\u0275pureFunction0(12, _c62));
  }
}
function DashboardComponent_div_88_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r17.activeCount);
  }
}
function DashboardComponent_div_88_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r18.sendSuccessCount);
  }
}
function DashboardComponent_div_88_ng_template_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r19.sendErrorCount);
  }
}
function DashboardComponent_div_88_ng_template_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r20.doneSuccessCount);
  }
}
function DashboardComponent_div_88_ng_template_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r21.doneErrorCount);
  }
}
...
function DashboardComponent_div_88_ng_template_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r23.workers);
  }
}
function DashboardComponent_div_88_ng_template_10_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("nz-tooltip", h_r24.handlerName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(h_r24.handlerName));
    \u0275\u0275advance();
    \u0275\u0275property("nz-tooltip", h_r24.messageName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(h_r24.messageName));
  }
}
function DashboardComponent_div_88_ng_template_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r25.handlers);
  }
}
function DashboardComponent_div_88_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_88_ng_template_11_Template_tot_button_click_1_listener() {
      const data_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.viewDetails(data_r27));
    });
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_88_ng_template_11_Template_tot_button_click_4_listener() {
      const data_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.viewInProgress(data_r27));
    });
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "transloco");
    \u0275\u0275elementEnd()();
...
function DashboardComponent_div_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 41);
    \u0275\u0275listener("pageIndexChange", function DashboardComponent_div_88_Template_tot_table_pageIndexChange_3_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onTopicPageChange($event));
    })("pageSizeChange", function DashboardComponent_div_88_Template_tot_table_pageSizeChange_3_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onTopicPageSizeChange($event));
    });
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(2, 10, "Danh s\xE1ch Ch\u1EE7 \u0111\u1EC1 (Topic)"));
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r3.pagedTopics)("columns", ctx_r3.topicColumns)("loading", ctx_r3.loading)("total", ctx_r3.allTopics.length)("pageIndex", ctx_r3.topicPageIndex)("pageSize", ctx_r3.topicPageSize)("frontPagination", false)("showPagination", true)("scroll", \u0275\u0275pureFunction0(12, _c62));
  }
}
...
function DashboardComponent_div_89_ng_template_31_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("title", data_r29.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(data_r29.id);
  }
}
function DashboardComponent_div_89_ng_template_32_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", (data_r30.status == null ? null : data_r30.status.toLowerCase()) === "success" ? "success" : (data_r30.status == null ? null : data_r30.status.toLowerCase()) === "error" ? "error" : "processing");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, (data_r30.status == null ? null : data_r30.status.toLowerCase()) === "success" ? "Th\xE0nh c\xF4ng" : (data_r30.status == null ? null : data_r30.status.toLowerCase()) === "error" ? "L\u1ED7i" : "\u0110ang ch\u1EA1y"), " ");
  }
}
function DashboardComponent_div_89_ng_template_33_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r31.step === "send" ? "blue" : data_r31.step === "dequeue" ? "orange" : data_r31.step === "done" ? "green" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", data_r31.step, " ");
  }
}
function DashboardComponent_div_89_ng_template_34_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r32.sourceComponent);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.shortenNamespace(data_r32.sourceComponent), " ");
  }
}
function DashboardComponent_div_89_ng_template_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r33.queueOrTopic);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(data_r33.queueOrTopic));
  }
}
function DashboardComponent_div_89_ng_template_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r34.handler);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r3.shortenNamespace(data_r34.handler), " ");
  }
}
function DashboardComponent_div_89_ng_template_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, data_r35.time, "yyyy-MM-dd HH:mm:ss"), " ");
  }
}
function DashboardComponent_div_89_ng_template_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_89_ng_template_38_Template_tot_button_click_1_listener() {
      const data_r37 = \u0275\u0275restoreView(_r36).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.retryTracking(data_r37));
    });
    \u0275\u0275element(3, "i", 87);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_89_ng_template_38_Template_tot_button_click_6_listener() {
      const data_r37 = \u0275\u0275restoreView(_r36).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.deleteTracking(data_r37));
    });
    \u0275\u0275element(8, "i", 89);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "transloco");
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_89_ng_template_38_Template_tot_button_click_11_listener() {
      const data_r37 = \u0275\u0275restoreView(_r36).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.toggleExpand(data_r37));
    });
    \u0275\u0275element(12, "i", 91);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "transloco");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("nzType", data_r37.expand ? "up" : "down");
    \u0275\u0275advance();
...
function DashboardComponent_div_89_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_div_89_Template_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.filters.trackingId, $event) || (ctx_r3.filters.trackingId = $event);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_div_89_Template_nz_select_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.filters.status, $event) || (ctx_r3.filters.status = $event);
      return \u0275\u0275resetView($event);
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_div_89_Template_nz_date_picker_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.filters.fromDate, $event) || (ctx_r3.filters.fromDate = $event);
      return \u0275\u0275resetView($event);
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_div_89_Template_nz_date_picker_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.filters.toDate, $event) || (ctx_r3.filters.toDate = $event);
      return \u0275\u0275resetView($event);
    });
    ...
    \u0275\u0275listener("pageIndexChange", function DashboardComponent_div_89_Template_tot_table_pageIndexChange_30_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      ctx_r3.pageIndex = $event;
      return \u0275\u0275resetView(ctx_r3.loadTracking());
    })("pageSizeChange", function DashboardComponent_div_89_Template_tot_table_pageSizeChange_30_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      ctx_r3.pageSize = $event;
      ctx_r3.pageIndex = 1;
      return \u0275\u0275resetView(ctx_r3.loadTracking());
    })("expandChange", function DashboardComponent_div_89_Template_tot_table_expandChange_30_listener($event) {
      \u0275\u0275restoreView(_r28);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onRowExpand($event));
    });
  ...
  if (rf & 2) {
    const prefixSearch_r38 = \u0275\u0275reference(10);
    const ctx_r3 = \u0275\u0275nextContext();
    const expandTpl_r39 = \u0275\u0275reference(93);
    \u0275\u0275advance();
    ...
    \u0275\u0275property("nzSpan", 5);
    \u0275\u0275advance();
    \u0275\u0275property("nzPrefix", prefixSearch_r38);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.filters.trackingId);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 31, "Tracking ID"));
    \u0275\u0275advance(4);
    \u0275\u0275property("nzSpan", 4);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.filters.status);
    ...
    \u0275\u0275property("nzSpan", 10);
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.filters.fromDate);
    \u0275\u0275property("nzPlaceHolder", \u0275\u0275pipeBind1(23, 41, "B\u1EAFt \u0111\u1EA7u"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.filters.toDate);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r3.recentTracking)("columns", ctx_r3.trackingColumns)("loading", ctx_r3.loading)("total", ctx_r3.totalTracking)("pageIndex", ctx_r3.pageIndex)("pageSize", ctx_r3.pageSize)("frontPagination", false)("expandTemplate", expandTpl_r39)("scroll", \u0275\u0275pureFunction0(47, _c62));
  }
}
function DashboardComponent_div_90_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r41.status === "Running" ? "success" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, data_r41.status === "Running" ? "\u0110ang ch\u1EA1y" : "\u0110\xE3 d\u1EEBng"), " ");
  }
}
function DashboardComponent_div_90_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_div_90_ng_template_5_Template_tot_button_click_0_listener() {
      const data_r43 = \u0275\u0275restoreView(_r42).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.toggleWorker(data_r43.id, data_r43.status));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzType", data_r43.status === "Running" ? "default" : "primary")("nzDanger", data_r43.status === "Running");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 3, data_r43.status === "Running" ? "D\u1EEBng" : "Kh\u1EDFi ch\u1EA1y"), " ");
  }
}
function DashboardComponent_div_90_ng_template_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r44.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", item_r44.count, " ", \u0275\u0275pipeBind1(5, 3, "l\u1ED7i"));
  }
}
...
function DashboardComponent_div_90_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("pageIndexChange", function DashboardComponent_div_90_Template_tot_table_pageIndexChange_3_listener($event) {
      \u0275\u0275restoreView(_r40);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onWorkerPageChange($event));
    })("pageSizeChange", function DashboardComponent_div_90_Template_tot_table_pageSizeChange_3_listener($event) {
      \u0275\u0275restoreView(_r40);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onWorkerPageSizeChange($event));
    });
  ...
  if (rf & 2) {
    const errorItem_r45 = \u0275\u0275reference(12);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(2, 16, "Gi\xE1m s\xE1t ti\u1EBFn tr\xECnh (Workers)"));
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r3.pagedWorkers)("columns", ctx_r3.workerColumns)("total", ctx_r3.workerList.length)("pageIndex", ctx_r3.workerPageIndex)("pageSize", ctx_r3.workerPageSize)("frontPagination", false)("showPagination", true)("scroll", \u0275\u0275pureFunction0(20, _c72));
    \u0275\u0275advance(3);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(7, 18, "Ph\xE2n t\xEDch l\u1ED7i"));
    \u0275\u0275advance(2);
    \u0275\u0275property("nzGutter", 16);
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 12);
    \u0275\u0275advance();
    \u0275\u0275property("nzDataSource", ctx_r3.errorStats)("nzRenderItem", errorItem_r45);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzSpan", 12);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.errorStats.length === 0);
  }
}
function DashboardComponent_div_91_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r47.type === "Command" ? "blue" : data_r47.type === "Topic" ? "purple" : "cyan");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, data_r47.type), " ");
  }
}
function DashboardComponent_div_91_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nz-tooltip", \u0275\u0275pipeBind2(1, 3, data_r48.lastActive, "yyyy-MM-dd HH:mm:ss.SSS"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 6, data_r48.lastActive, "yyyy-MM-dd HH:mm:ss"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" (", \u0275\u0275pipeBind2(6, 9, data_r48.lastActive, "HH:mm:ss"), ") ");
  }
}
function DashboardComponent_div_91_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("pageIndexChange", function DashboardComponent_div_91_Template_tot_table_pageIndexChange_3_listener($event) {
      \u0275\u0275restoreView(_r46);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onActivityPageChange($event));
    })("pageSizeChange", function DashboardComponent_div_91_Template_tot_table_pageSizeChange_3_listener($event) {
      \u0275\u0275restoreView(_r46);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onActivityPageSizeChange($event));
    });
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(2, 8, "Danh s\xE1ch th\u1EDDi gian ho\u1EA1t \u0111\u1ED9ng l\u1EA7n cu\u1ED1i"));
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r3.pagedActivities)("columns", ctx_r3.activityColumns)("total", ctx_r3.lastActivityList.length)("pageIndex", ctx_r3.activityPageIndex)("pageSize", ctx_r3.activityPageSize)("frontPagination", false)("showPagination", true);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_nz_tag_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r51 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("nzColor", step_r51.status.toLowerCase() === "success" ? "success" : step_r51.status.toLowerCase() === "error" ? "error" : "processing");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r51.status, " ");
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("nz-tooltip", step_r51.sourceComponent);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(step_r51.sourceComponent));
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r51.queueOrTopicName);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_11_span_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r51 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r51.destinationQueueName);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r51.subscriberName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.destinationQueueName);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r51 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(step_r51.workerName);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275property("nz-tooltip", step_r51.handlerOrEventName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r3.shortenNamespace(step_r51.handlerOrEventName));
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const step_r51 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", step_r51.details, " ");
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_div_15_Template_tot_button_click_6_listener() {
      ...
      const step_r51 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r3.copyToClipboard(step_r51.details));
    });
    \u0275\u0275element(7, "i", 112);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "transloco");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r51.details);
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_nz_timeline_item_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", (step_r51.status == null ? null : step_r51.status.toLowerCase()) === "error" ? "red" : (step_r51.status == null ? null : step_r51.status.toLowerCase()) === "success" ? "green" : "blue");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 12, step_r51.timestamp || step_r51.time, "yyyy-MM-dd HH:mm:ss.SSS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("nzColor", step_r51.step === "send" ? "blue" : step_r51.step === "dequeue" ? "orange" : step_r51.step === "done" ? "green" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r51.step, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.status);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", step_r51.sourceComponent);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.queueOrTopicName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.subscriberName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.workerName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.handlerOrEventName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r51.details && (step_r51.status == null ? null : step_r51.status.toLowerCase()) !== "error");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (step_r51.status == null ? null : step_r51.status.toLowerCase()) === "error");
  }
}
function DashboardComponent_ng_template_92_nz_timeline_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r50 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", data_r50.history);
  }
}
...
function DashboardComponent_ng_template_92_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_ng_template_92_Template_tot_button_click_8_listener() {
      const data_r50 = \u0275\u0275restoreView(_r49).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.copyToClipboard(data_r50.content));
    });
    \u0275\u0275element(9, "i", 112);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "transloco");
  ...
  if (rf & 2) {
    ...
    const loadingHistory_r53 = \u0275\u0275reference(22);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r3.formatJson(data_r50.content));
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 14);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 13, "L\u1ECBch s\u1EED d\xF2ng th\u1EDDi gian s\u1EF1 ki\u1EC7n"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", data_r50.history && data_r50.history.length > 0)("ngIfElse", loadingHistory_r53);
  }
}
var _DashboardComponent = class _DashboardComponent {
  ...
  onWorkerPageChange(index) {
    this.workerPageIndex = index;
  }
  onWorkerPageSizeChange(size) {
    this.workerPageSize = size;
    this.workerPageIndex = 1;
  }
  onActivityPageChange(index) {
    this.activityPageIndex = index;
  }
  onActivityPageSizeChange(size) {
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 94, vars: 121, consts: [["titleQueue", ""], ["titleTopic", ""], ["titleWorkers", ""], ["expandTpl", ""], ["prefixSearch", ""], ["errorItem", ""], ["loadingHistory", ""], [1, "dashboard-container"], [1, "site-page-header", 3, "nzTitle"], [2, "display", "flex", "align-items", "center", "gap", "16px"], [2, "display", "flex", "align-items", "center", "gap", "8px"], [2, "color", "#999"], [2, "width", "120px", 3, "ngModelChange", "ngModel"], [3, "nzLabel", "nzValue", 4, "ngFor", "ngForOf"], ["nzType", "primary", 3, "click", "loading"], ["nz-icon", "", "nzType", "reload"], ["nz-row", "", 1, "stats-row", 2, "margin-bottom", "24px", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], ["nzHoverable", "", 3, "nzTitle"], ["nz-row", "", 3, "nzGutter"], ["nz-col", "", 2, "margin-bottom", "8px", 3, "nzSpan"], [3, "nzValue", "nzTitle", "nzValueStyle"], [1, "tab-actions", 2, "margin-bottom", "16px", "display", "flex", "justify-content", "center"], ["nzButtonStyle", "solid", "nzSize", "large", 3, "ngModelChange", "ngModel"], ["nz-radio-button", "", "nzValue", "queues"], ["nz-icon", "", "nzType", "database"], ["nz-radio-button", "", "nzValue", "topics"], ["nz-icon", "", "nzType", "cluster"], ["nz-radio-button", "", "nzValue", "tracking"], ["nz-icon", "", "nzType", "history"], ["nz-radio-button", "", "nzValue", "workers"], ["nz-icon", "", "nzType", "api"], ["nz-radio-button", "", "nzValue", "activity"], ["nz-icon", "", "nzType", "clock-circle"], [3, "ngSwitch"], [4, "ngSwitchCase"], [3, "nzLabel", "nzValue"], [2, "font-weight", "bold", "color", "#1890ff"], [2, "font-weight", "bold", "color", "#722ed1"], [2, "font-weight", "bold", "color", "#13c2c2"], [3, "nzTitle"], [3, "pageIndexChange", "pageSizeChange", "data", "columns", "loading", "total", "pageIndex", "pageSize", "frontPagination", "showPagination", "scroll"], ["totCell", "activeCount"], ["totCell", "sendSuccessCount"], ["totCell", "sendErrorCount"], ["totCell", "doneSuccessCount"], ["totCell", "doneErrorCount"], ["totCell", "workers"], ["totCell", "handlers"], ["totCell", "action"], ["nzColor", "processing"], ["nzColor", "success"], ["nzColor", "error"], [1, "worker-tags"], ["nzColor", "processing", 4, "ngFor", "ngForOf"], [1, "handler-grid"], ["class", "handler-tag-item", 4, "ngFor", "ngForOf"], [1, "handler-tag-item"], [1, "h-name", 3, "nz-tooltip"], [1, "m-name", 3, "nz-tooltip"], [2, "display", "flex", "gap", "4px", "flex-direction", "column"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzGhost"], ["nzType", "default", "nzSize", "small", 3, "click"], [1, "filters-container", 2, "margin-bottom", "24px"], [3, "nzPrefix"], ["type", "text", "nz-input", "", 3, "ngModelChange", "ngModel", "placeholder"], ["nzAllowClear", "", 2, "width", "100%", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], ["nzValue", "success", 3, "nzLabel"], ["nzValue", "error", 3, "nzLabel"], ["nzValue", "processing", 3, "nzLabel"], [2, "display", "flex", "gap", "8px"], [2, "flex", "1", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], [3, "click", "nzBlock"], [3, "pageIndexChange", "pageSizeChange", "expandChange", "data", "columns", "loading", "total", "pageIndex", "pageSize", "frontPagination", "expandTemplate", "scroll"], ["totCell", "id"], ["totCell", "status"], ["totCell", "step"], ["totCell", "sourceComponent"], ["totCell", "queueOrTopic"], ["totCell", "handler"], ["totCell", "time"], ["nz-icon", "", "nzType", "search"], [1, "id-text", 3, "title"], [3, "nzColor"], [1, "namespace-text", 3, "nz-tooltip"], [1, "queue-name", 3, "nz-tooltip"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzTooltipTitle"], ["nz-icon", "", "nzType", "rollback"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzDanger", "nzTooltipTitle"], ["nz-icon", "", "nzType", "delete"], ["nzSize", "small", "nzType", "link", 3, "click"], ["nz-icon", "", 3, "nzType"], [3, "pageIndexChange", "pageSizeChange", "data", "columns", "total", "pageIndex", "pageSize", "frontPagination", "showPagination", "scroll"], [2, "margin-top", "24px", 3, "nzTitle"], ["nzBordered", "", 3, "nzDataSource", "nzRenderItem"], ["class", "empty-state", 4, "ngIf"], [3, "click", "nzType", "nzDanger"], [2, "color", "#ff4d4f", "font-weight", "bold"], ["nzColor", "red"], [1, "empty-state"], ["nz-icon", "", "nzType", "check-circle", 2, "font-size", "48px", "color", "#52c41a"], [2, "margin-top", "16px"], ["nzSize", "middle", 3, "pageIndexChange", "pageSizeChange", "data", "columns", "total", "pageIndex", "pageSize", "frontPagination", "showPagination"], ["totCell", "type"], ["totCell", "lastActive"], [3, "nz-tooltip"], [2, "color", "#999", "font-size", "12px", "margin-left", "8px"], [1, "json-viewer-container", 2, "width", "100%", "padding", "24px", "border-radius", "8px", "border", "1px solid #f0f0f0", "background", "#fff"], [1, "json-header", 2, "margin-bottom", "12px", "display", "flex", "justify-content", "space-between", "align-items", "center"], [2, "font-weight", "600", "font-size", "14px", "color", "#1890ff"], ["nz-icon", "", "nzType", "code"], ["nzSize", "small", "nzType", "default", 3, "click"], ["nz-icon", "", "nzType", "copy"], [1, "json-content", 2, "max-height", "480px", "border-radius", "6px", "box-shadow", "inset 0 2px 8px rgba(0,0,0,0.15)"], [2, "font-weight", "600", "font-size", "15px", "margin-bottom", "20px", "color", "#1890ff"], [1, "timeline-wrapper", 2, "max-height", "480px", "overflow-y", "auto", "padding-right", "8px"], [4, "ngIf", "ngIfElse"], [3, "nzColor", 4, "ngFor", "ngForOf"], [2, "display", "flex", "align-items", "center", "gap", "12px", "margin-bottom", "6px"], [2, "font-weight", "bold", "font-family", "monospace", "font-size", "12px", "color", "#888"], [3, "nzColor", 4, "ngIf"], [1, "timeline-body-content", 2, "background", "rgba(0,0,0,0.02)", "padding", "12px", "border-radius", "6px", "border-left", "3px solid #d9d9d9", "margin-bottom", "12px"], ["class", "context-row", "style", "margin-bottom: 4px; font-size: 12px;", 4, "ngIf"], ["class", "details-row", "style", "margin-top: 6px; font-size: 12px; color: #555;", 4, "ngIf"], ["class", "error-detail-banner", "style", "margin-top: 8px; padding: 12px; background: #fff1f0; border: 1px solid #ffa39e; border-radius: 4px; border-left: 4px solid #ff4d4f;", 4, "ngIf"], [1, "context-row", 2, "margin-bottom", "4px", "font-size", "12px"], [2, "color", "#666", "font-weight", "500"], [2, "color", "#c41d7f", 3, "nz-tooltip"], [2, "color", "#096dd9"], [2, "color", "#722ed1"], ["style", "color: #888; font-size: 11px; margin-left: 6px;", 4, "ngIf"], [2, "color", "#888", "font-size", "11px", "margin-left", "6px"], [2, "color", "#d46b08"], [2, "color", "#389e0d", 3, "nz-tooltip"], [1, "details-row", 2, "margin-top", "6px", "font-size", "12px", "color", "#555"], ["nz-icon", "", "nzType", "info-circle", 2, "color", "#1890ff", "margin-right", "4px"], [1, "error-detail-banner", 2, "margin-top", "8px", "padding", "12px", "background", "#fff1f0", "border", "1px solid #ffa39e", "border-radius", "4px", "border-left", "4px solid #ff4d4f"], [2, "display", "flex", "justify-content", "space-between", "align-items", "center", "margin-bottom", "6px"], [2, "font-weight", "600", "color", "#cf1322"], ["nz-icon", "", "nzType", "warning", "nzTheme", "fill"], ["nzSize", "small", "nzType", "default", 3, "click", "nzDanger"], [2, "margin", "0", "padding", "8px", "background", "#141414", "color", "#ffccc7", "font-size", "11px", "max-height", "200px", "overflow", "auto", "border-radius", "4px", "font-family", "'Consolas', monospace", "white-space", "pre-wrap", "word-break", "break-all"], [2, "display", "flex", "flex-direction", "column", "align-items", "center", "justify-content", "center", "height", "200px", "color", "#999"], ["nz-icon", "", "nzType", "loading", 2, "font-size", "32px", "color", "#1890ff", "margin-bottom", "12px"]], template: function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(87, DashboardComponent_div_87_Template, 12, 13, "div", 35)(88, DashboardComponent_div_88_Template, 12, 13, "div", 35)(89, DashboardComponent_div_89_Template, 39, 48, "div", 35)(90, DashboardComponent_div_90_Template, 15, 21, "div", 35)(91, DashboardComponent_div_91_Template, 6, 10, "div", 35);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(92, DashboardComponent_ng_template_92_Template, 23, 15, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const titleQueue_r54 = \u0275\u0275reference(19);
    const titleTopic_r55 = \u0275\u0275reference(36);
    const titleWorkers_r56 = \u0275\u0275reference(53);
    \u0275\u0275advance();
    ...
    \u0275\u0275property("nzSpan", 9);
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", titleQueue_r54);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzGutter", 16);
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 12);
    ...
    \u0275\u0275property("nzSpan", 9);
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", titleTopic_r55);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzGutter", 16);
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 12);
    ...
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance();
    \u0275\u0275property("nzTitle", titleWorkers_r56);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzGutter", 16);
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 12);
    ...
    <div *ngSwitchCase="'queues'">
      <nz-card [nzTitle]="'Danh s\xE1ch H\xE0ng \u0111\u1EE3i (Queue)' | transloco">
        <tot-table
          ...
          [showPagination]="true"
          [scroll]="{ x: '1300px' }"
          (pageIndexChange)="onQueuePageChange($event)"
    ...
    <div *ngSwitchCase="'topics'">
      <nz-card [nzTitle]="'Danh s\xE1ch Ch\u1EE7 \u0111\u1EC1 (Topic)' | transloco">
        <tot-table
          ...
          [showPagination]="true"
          [scroll]="{ x: '1300px' }"
          (pageIndexChange)="onTopicPageChange($event)"
          (pageSizeChange)="onTopicPageSizeChange($event)"
        >
          <ng-template totCell="activeCount" let-data>
            <nz-tag nzColor="processing">{{ data.activeCount }}</nz-tag>
          </ng-template>
    ...
    <div *ngSwitchCase="'tracking'">
      <nz-card [nzTitle]="'L\u1ECBch s\u1EED th\u1EF1c thi' | transloco">
        ...
        <tot-table 
          ...
          [expandTemplate]="expandTpl"
          [scroll]="{ x: '1300px' }"
          (pageIndexChange)="pageIndex = $event; loadTracking()"
          (pageSizeChange)="pageSize = $event; pageIndex = 1; loadTracking()"
          (expandChange)="onRowExpand($event)"
        >
    ...
    <div *ngSwitchCase="'workers'">
      <nz-card [nzTitle]="'Gi\xE1m s\xE1t ti\u1EBFn tr\xECnh (Workers)' | transloco">
        <tot-table
          ...
          [pageIndex]="workerPageIndex"
          [pageSize]="workerPageSize"
          [frontPagination]="false"
          [showPagination]="true"
          [scroll]="{ x: '1000px' }"
          (pageIndexChange)="onWorkerPageChange($event)"
          (pageSizeChange)="onWorkerPageSizeChange($event)"
        >
          <ng-template totCell="status" let-data>
    ...
    <div *ngSwitchCase="'activity'">
      <nz-card [nzTitle]="'Danh s\xE1ch th\u1EDDi gian ho\u1EA1t \u0111\u1ED9ng l\u1EA7n cu\u1ED1i' | transloco">
        <tot-table
          ...
          [total]="lastActivityList.length"
          [pageIndex]="activityPageIndex"
          [pageSize]="activityPageSize"
          [frontPagination]="false"
          [showPagination]="true"
          nzSize="middle"
          (pageIndexChange)="onActivityPageChange($event)"
...
//# sourceMappingURL=chunk-SD5HK5W2.js.map
