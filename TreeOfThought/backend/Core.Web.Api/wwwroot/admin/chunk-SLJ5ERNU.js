    ...
    <nz-card class="search-card" [nzTitle]="'T\xECm ki\u1EBFm' | transloco">
      <div nz-row [nzGutter]="[16, 16]">
        ...
        <div nz-col [nzSpan]="8" class="search-actions">
          <nz-space>
            <tot-button *nzSpaceItem nzType="primary" (click)="loadUsers()">{{ 'T\xECm ki\u1EBFm' | transloco }}</tot-button>
...
_RoleListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleListComponent, selectors: [["app-role-list"]], viewQuery: function RoleListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275template(13, RoleListComponent_tot_button_13_Template, 3, 3, "tot-button", 10)(14, RoleListComponent_tot_button_14_Template, 3, 3, "tot-button", 11);
    \u0275\u0275elementEnd()()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RoleListComponent, [{
    ...
    <nz-card class="search-card" [nzTitle]="'T\xECm ki\u1EBFm' | transloco">
      <div nz-row [nzGutter]="[16, 16]">
        <div nz-col [nzSpan]="8">
          <input nz-input [(ngModel)]="searchQuery.keyword" [placeholder]="'T\xEAn vai tr\xF2, m\xF4 t\u1EA3' | transloco" (keyup.enter)="loadRoles()" />
        </div>
        ...
        <div nz-col [nzSpan]="6" class="search-actions">
          <nz-space>
            <tot-button *nzSpaceItem nzType="primary" (click)="loadRoles()">{{ 'T\xECm ki\u1EBFm' | transloco }}</tot-button>
            <tot-button *nzSpaceItem (click)="resetSearch()">{{ '\u0110\u1EB7t l\u1EA1i' | transloco }}</tot-button>
          </nz-space>
        </div>
      </div>
...
_AclListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AclListComponent, selectors: [["app-acl-list"]], viewQuery: function AclListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "tot-button", 10);
    ...
    \u0275\u0275pipe(21, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "tot-button", 12);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClaimSyncComponent, [{
    ...
    <nz-card [nzTitle]="'T\xECm ki\u1EBFm' | transloco" class="search-card">
      <div nz-row [nzGutter]="[16, 16]">
        <div nz-col [nzSpan]="10">
          <input nz-input [(ngModel)]="searchQuery.keyword" [placeholder]="'T\xEAn quy\u1EC1n, m\xF4 t\u1EA3' | transloco" (keyup.enter)="loadClaims()" />
        </div>
        <div nz-col [nzSpan]="8">
          <nz-range-picker [(ngModel)]="searchQuery.dateRange" style="width: 100%"></nz-range-picker>
        </div>
        <div nz-col [nzSpan]="6" class="search-actions">
          <nz-space>
            <tot-button *nzSpaceItem  nzType="primary" (click)="loadClaims()">{{ 'T\xECm ki\u1EBFm' | transloco }}</tot-button>
            <tot-button *nzSpaceItem  (click)="resetSearch()">{{ '\u0110\u1EB7t l\u1EA1i' | transloco }}</tot-button>
          </nz-space>
        </div>
      </div>
...
var _AuthorizeInfoComponent = class _AuthorizeInfoComponent {
  ...
  ngAfterViewInit() {
    this.claimsColumns = [
      ...
      { title: "Gi\xE1 tr\u1ECB Claim", key: "value", template: this.valueTpl }
    ];
  }
  loadUserData() {
...
_AuthorizeInfoComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthorizeInfoComponent, selectors: [["app-authorize-info"]], viewQuery: function AuthorizeInfoComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c06, 7);
  }
  if (rf & 2) {
    let _t;
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.valueTpl = _t.first);
  }
}, decls: 44, vars: 44, consts: [["valueTpl", ""], [1, "authorize-info-container"], [1, "page-header"], [1, "subtitle"], [3, "nzTitle"], [1, "tab-content"], [1, "info-card", 3, "nzTitle"], ["nzBordered", "", 3, "nzColumn"], [3, "nzColor", 4, "ngFor", "ngForOf"], ["class", "empty-text", 4, "ngIf"], [1, "claims-list"], ["class", "info-card", 3, "nzTitle", 4, "ngIf"], ["nzColor", "volcano"], [3, "title", "data", "columns", "pageSize"], [3, "nzColor"], [1, "empty-text"], [1, "admin-notice"], ["nz-icon", "", "nzType", "safety-certificate", "nzTheme", "twotone", 3, "nzTwotoneColor"]], template: function AuthorizeInfoComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "tot-table", 13);
    \u0275\u0275pipe(41, "transloco");
    \u0275\u0275template(42, AuthorizeInfoComponent_ng_template_42_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;70efadc8f01df98a16b477d44f79bf19b355eff90c2a62fef78074449633cbfa;/work/a.i-assistant-chatbot-telegram-serverles/TreeOfThought/frontend/web/projects/tot/business-oidc/src/lib/authorize-info/authorize-info.component.ts */\n.authorize-info-container {\n  padding: 0;\n}\n.page-header {\n  margin-bottom: 24px;\n}\n.subtitle {\n  color: rgba(0, 0, 0, 0.45);\n  margin-top: -16px;\n}\n.tab-content {\n  padding: 16px 0;\n}\n.info-card {\n  margin-bottom: 24px;\n}\n.claims-list {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.empty-text {\n  color: rgba(0, 0, 0, 0.25);\n  font-style: italic;\n}\n.admin-notice {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  padding: 16px;\n}\n.admin-notice span {\n  font-size: 48px;\n  margin-bottom: 16px;\n}\ncode {\n  background: #f5f5f5;\n  padding: 2px 4px;\n  border-radius: 4px;\n  font-size: 12px;\n}\n/*# sourceMappingURL=authorize-info.component.css.map */\n"] }]
    ...
    type: ViewChild,
    args: ["valueTpl", { static: true }]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthorizeInfoComponent, { className: "AuthorizeInfoComponent", filePath: "projects/tot/business-oidc/src/lib/authorize-info/authorize-info.component.ts", lineNumber: 133 });
})();
export {
  AclListComponent,
...
//# sourceMappingURL=chunk-SLJ5ERNU.js.map
