...
function NhanDienKhuonMatComponent_div_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "img", 50);
    \u0275\u0275elementStart(2, "div", 51)(3, "span", 52);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(8, NhanDienKhuonMatComponent_div_38_nz_tag_8_Template, 2, 0, "nz-tag", 55)(9, NhanDienKhuonMatComponent_div_38_nz_tag_9_Template, 3, 1, "nz-tag", 56)(10, NhanDienKhuonMatComponent_div_38_nz_tag_10_Template, 2, 1, "nz-tag", 57)(11, NhanDienKhuonMatComponent_div_38_nz_tag_11_Template, 2, 0, "nz-tag", 58)(12, NhanDienKhuonMatComponent_div_38_nz_tag_12_Template, 2, 0, "nz-tag", 59);
    \u0275\u0275elementEnd();
...
function NhanDienKhuonMatComponent_div_46_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, NhanDienKhuonMatComponent_div_46_div_20_div_5_Template, 2, 0, "div", 89);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 90)(7, "span", 91);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
...
function NhanDienKhuonMatComponent_div_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 71)(1, "div", 72)(2, "div", 73)(3, "span");
    \u0275\u0275text(4, "Khung \u1EA3nh g\u1ED1c (V\u1EBD Bounding Box)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 74)(6, "span", 75);
    \u0275\u0275text(7, "\u0110\u01B0a v\xE0o phi\xEAn l\u01B0u tr\u1EEF:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "nz-switch", 76);
    ...
    \u0275\u0275element(10, "div", 78, 3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 79)(13, "div", 73)(14, "span");
    \u0275\u0275text(15, "Danh s\xE1ch khu\xF4n m\u1EB7t \u0111\xE3 c\u1EAFt (K\xEDch th\u01B0\u1EDBc chu\u1EA9n 150x150)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "nz-tag", 80);
    \u0275\u0275text(17, "MediaPipe Local AI");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, NhanDienKhuonMatComponent_div_46_div_18_Template, 3, 0, "div", 81);
    \u0275\u0275elementStart(19, "div", 82);
    \u0275\u0275template(20, NhanDienKhuonMatComponent_div_46_div_20_Template, 13, 8, "div", 83);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function NhanDienKhuonMatComponent_div_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 96)(1, "div", 97)(2, "div", 98)(3, "label", 99);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 101)(7, "button", 102);
    ...
    \u0275\u0275template(8, NhanDienKhuonMatComponent_div_47_i_8_Template, 1, 0, "i", 103);
    \u0275\u0275text(9, " L\u01B0u tr\u1EEF l\xEAn Server ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(10, NhanDienKhuonMatComponent_div_47_div_10_Template, 8, 1, "div", 104);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function NhanDienKhuonMatComponent_tr_71_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_tr_71_div_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r11);
      const data_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.inlineRenameSession(data_r12));
    });
    \u0275\u0275element(4, "i", 122);
    \u0275\u0275elementEnd()();
  }
...
function NhanDienKhuonMatComponent_tr_71_div_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 123)(1, "input", 124);
    \u0275\u0275twoWayListener("ngModelChange", function NhanDienKhuonMatComponent_tr_71_div_3_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      const data_r12 = \u0275\u0275nextContext().$implicit;
      \u0275\u0275twoWayBindingSet(data_r12.tempName, $event) || (data_r12.tempName = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "button", 125);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_tr_71_div_3_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r13);
      const data_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.saveInlineRename(data_r12));
    });
    \u0275\u0275element(3, "i", 126);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 127);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_tr_71_div_3_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r13);
      const data_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.cancelInlineRename(data_r12));
    });
    \u0275\u0275element(5, "i", 128);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const data_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", data_r12.tempName);
  }
}
function NhanDienKhuonMatComponent_tr_71_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275template(2, NhanDienKhuonMatComponent_tr_71_div_2_Template, 5, 1, "div", 111)(3, NhanDienKhuonMatComponent_tr_71_div_3_Template, 6, 1, "div", 112);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "td");
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "date");
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td")(10, "nz-tag", 113);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "td", 114)(13, "div", 115)(14, "button", 116);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_tr_71_Template_button_click_14_listener() {
      const data_r12 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openSessionDetails(data_r12));
    });
    \u0275\u0275element(15, "i", 117);
    \u0275\u0275text(16, " Xem Chi Ti\u1EBFt ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 118);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_tr_71_Template_button_click_17_listener($event) {
      const data_r12 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.deleteSession(data_r12, $event));
    });
    \u0275\u0275element(18, "i", 61);
    \u0275\u0275text(19, " X\xF3a ");
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !data_r12.isEditing);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", data_r12.isEditing);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 5, data_r12.createdAt, "dd/MM/yyyy HH:mm:ss"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(data_r12.createdBy);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", data_r12.imageCount, " \u1EA3nh g\u1ED1c");
  }
}
function NhanDienKhuonMatComponent_div_73_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 132);
    \u0275\u0275element(1, "nz-spin", 108);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "\u0110ang t\u1EA3i c\u1EA5u tr\xFAc t\u1EC7p t\u1EEB server...");
    \u0275\u0275elementEnd()();
  }
}
function NhanDienKhuonMatComponent_div_73_div_2_div_1_div_20_Template(rf, ctx) {
  if (rf & 1) {
...
function NhanDienKhuonMatComponent_div_73_div_2_div_1_div_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 150)(1, "div", 151);
    \u0275\u0275element(2, "img", 152);
    \u0275\u0275elementStart(3, "button", 153);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_div_73_div_2_div_1_div_22_Template_button_click_3_listener() {
      const face_r17 = \u0275\u0275restoreView(_r16).$implicit;
      const img_r15 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r3.deleteDetailCroppedFace(face_r17, img_r15));
    });
    \u0275\u0275element(4, "i", 154);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 155)(6, "span");
  ...
  if (rf & 2) {
    const face_r17 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275property("src", face_r17.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(face_r17.boundingBox);
  }
}
function NhanDienKhuonMatComponent_div_73_div_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 135)(1, "div", 136)(2, "div", 137)(3, "span", 138);
    \u0275\u0275element(4, "i", 20);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "nz-tag", 139);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "span", 140);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "button", 141);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_div_73_div_2_div_1_Template_button_click_11_listener() {
      const img_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r3.deleteDetailOriginalImage(img_r15));
    });
    \u0275\u0275element(12, "i", 61);
    \u0275\u0275text(13, " X\xF3a \u1EA3nh g\u1ED1c & crops ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 142)(15, "div", 143);
    \u0275\u0275element(16, "img", 144);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 145)(18, "h4");
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, NhanDienKhuonMatComponent_div_73_div_2_div_1_div_20_Template, 2, 0, "div", 146);
    \u0275\u0275elementStart(21, "div", 147);
    \u0275\u0275template(22, NhanDienKhuonMatComponent_div_73_div_2_div_1_div_22_Template, 10, 2, "div", 148);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", img_r15.fileName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("K\xEDch th\u01B0\u1EDBc: ", ctx_r3.formatBytes(img_r15.size));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(10, 7, img_r15.createdAt, "dd/MM/yyyy HH:mm:ss"));
    \u0275\u0275advance(7);
    \u0275\u0275property("src", img_r15.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Khu\xF4n m\u1EB7t \u0111\xE3 tr\xEDch xu\u1EA5t (", img_r15.croppedFaces.length, ")");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", img_r15.croppedFaces.length === 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", img_r15.croppedFaces);
  }
}
function NhanDienKhuonMatComponent_div_73_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 133);
    \u0275\u0275template(1, NhanDienKhuonMatComponent_div_73_div_2_div_1_Template, 23, 10, "div", 134);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function NhanDienKhuonMatComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 129);
    \u0275\u0275template(1, NhanDienKhuonMatComponent_div_73_div_1_Template, 4, 0, "div", 130)(2, NhanDienKhuonMatComponent_div_73_div_2_Template, 2, 1, "div", 131);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var _NhanDienKhuonMatComponent = class _NhanDienKhuonMatComponent {
  ...
  async saveFaceDetectionSession() {
    ...
    try {
      ...
      this.message.error(((_a = error.error) == null ? void 0 : _a.message) || "L\u1ED7i k\u1EBFt n\u1ED1i ho\u1EB7c x\u1EED l\xFD ph\xEDa m\xE1y ch\u1EE7.");
      this.savingSession = false;
    }
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      this.firestoreUnsubscribe = this.firebase.subscribeToRequestId(trackingId, (data) => {
        if (data.status === "Completed") {
          this.message.success(data.message || "T\u1EA3i l\xEAn th\xE0nh c\xF4ng!");
          this.completeSessionSave();
          resolve();
        } else if (data.status === "Error") {
          this.message.error(data.message || "X\u1EED l\xFD l\u01B0u tr\u1EEF th\u1EA5t b\u1EA1i.");
          this.savingSession = false;
  ...
  async loadSessionsHistory() {
    try {
      ...
      const history = await this.api.getSessions();
...
_NhanDienKhuonMatComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NhanDienKhuonMatComponent, selectors: [["tot-nhan-dien-khuon-mat"]], viewQuery: function NhanDienKhuonMatComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 13)(13, "div", 14)(14, "div", 15)(15, "span", 16);
    \u0275\u0275element(16, "i", 17);
    ...
    \u0275\u0275template(37, NhanDienKhuonMatComponent_div_37_Template, 4, 0, "div", 30)(38, NhanDienKhuonMatComponent_div_38_Template, 15, 11, "div", 31);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 32)(40, "div", 15)(41, "span", 16);
    \u0275\u0275element(42, "i", 33);
    \u0275\u0275text(43, " K\u1EBFt Qu\u1EA3 Qu\xE9t & Tr\xEDch Xu\u1EA5t");
    \u0275\u0275elementEnd();
    \u0275\u0275template(44, NhanDienKhuonMatComponent_span_44_Template, 2, 1, "span", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275template(45, NhanDienKhuonMatComponent_div_45_Template, 4, 0, "div", 35)(46, NhanDienKhuonMatComponent_div_46_Template, 21, 3, "div", 36);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(47, NhanDienKhuonMatComponent_div_47_Template, 11, 6, "div", 37);
    \u0275\u0275elementStart(48, "div", 38)(49, "div", 15)(50, "span", 16);
    \u0275\u0275element(51, "i", 39);
    \u0275\u0275text(52, " L\u1ECBch S\u1EED C\xE1c Phi\xEAn Upload");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "button", 40);
    \u0275\u0275listener("click", function NhanDienKhuonMatComponent_Template_button_click_53_listener() {
      return ctx.loadSessionsHistory();
    });
    \u0275\u0275element(54, "i", 41);
    \u0275\u0275text(55, " L\xE0m m\u1EDBi l\u1ECBch s\u1EED ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "nz-table", 42, 2)(58, "thead")(59, "tr")(60, "th");
    \u0275\u0275text(61, "T\xEAn phi\xEAn upload");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "th");
    \u0275\u0275text(63, "Th\u1EDDi gian t\u1EA1o");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "th");
    \u0275\u0275text(65, "Ng\u01B0\u1EDDi t\u1EA1o");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "th");
    \u0275\u0275text(67, "S\u1ED1 l\u01B0\u1EE3ng \u1EA3nh g\u1ED1c");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "th", 43);
    \u0275\u0275text(69, "Thao t\xE1c");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(70, "tbody");
    \u0275\u0275template(71, NhanDienKhuonMatComponent_tr_71_Template, 20, 8, "tr", 44);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(72, "nz-modal", 45);
    \u0275\u0275twoWayListener("nzVisibleChange", function NhanDienKhuonMatComponent_Template_nz_modal_nzVisibleChange_72_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.showDetailsModal, $event) || (ctx.showDetailsModal = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("nzOnCancel", function NhanDienKhuonMatComponent_Template_nz_modal_nzOnCancel_72_listener() {
      return ctx.closeDetailsModal();
    });
    \u0275\u0275template(73, NhanDienKhuonMatComponent_div_73_Template, 3, 2, "div", 46);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const historyTable_r18 = \u0275\u0275reference(57);
    \u0275\u0275advance(37);
    ...
    \u0275\u0275property("ngIf", ctx.queue.length > 0);
    \u0275\u0275advance(6);
    \u0275\u0275property("nzLoading", ctx.loadingSessions);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzData", ctx.sessionsList)("nzLoading", ctx.loadingSessions);
    \u0275\u0275advance(15);
    \u0275\u0275property("ngForOf", historyTable_r18.data);
    \u0275\u0275advance();
...
(() => {
  ...
  <div class="workspace-card history-panel">
    <div class="card-header">
      <span class="card-title"><i nz-icon nzType="history"></i> L\u1ECBch S\u1EED C\xE1c Phi\xEAn Upload</span>
    ...
    <nz-table #historyTable [nzData]="sessionsList" [nzLoading]="loadingSessions" nzSize="middle" class="glass-table">
      <thead>
        <tr>
          <th>T\xEAn phi\xEAn upload</th>
          <th>Th\u1EDDi gian t\u1EA1o</th>
          <th>Ng\u01B0\u1EDDi t\u1EA1o</th>
          <th>S\u1ED1 l\u01B0\u1EE3ng \u1EA3nh g\u1ED1c</th>
          <th nzWidth="250px" nzAlign="right">Thao t\xE1c</th>
        </tr>
      </thead>
      <tbody>
        <tr *ngFor="let data of historyTable.data">
          ...
          <td nzAlign="right">
            <div class="action-buttons-group">
              <button nz-button nzType="primary" nzSize="small" (click)="openSessionDetails(data)" class="glow-btn">
                <i nz-icon nzType="eye"></i> Xem Chi Ti\u1EBFt
              </button>
              <button nz-button nzType="default" nzDanger nzSize="small" (click)="deleteSession(data, $event)" class="danger-btn">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NhanDienKhuonMatComponent, { className: "NhanDienKhuonMatComponent", filePath: "projects/tot/nhan-dien-khuon-mat/src/lib/nhan-dien-khuon-mat.component.ts", lineNumber: 56 });
})();
...
//# sourceMappingURL=chunk-R4CDG7QQ.js.map
