...
// projects/tot/core/src/lib/tokens/firebase-config.token.ts
var FIREBASE_CONFIG = new InjectionToken("FIREBASE_CONFIG");
...
function __PRIVATE_isServerTimestamp(e) {
  var _a2, _b;
  const t = (_b = (((_a2 = e == null ? void 0 : e.mapValue) == null ? void 0 : _a2.fields) || {})[tt]) == null ? void 0 : _b.stringValue;
  return t === et;
}
  ...
  switch (n) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(e2, t2) {
        var _a2, _b, _c, _d;
        const n2 = e2.fields || {}, r2 = t2.fields || {}, i = (_a2 = n2[ut]) == null ? void 0 : _a2.arrayValue, s = (_b = r2[ut]) == null ? void 0 : _b.arrayValue, o = __PRIVATE_primitiveComparator(((_c = i == null ? void 0 : i.values) == null ? void 0 : _c.length) || 0, ((_d = s == null ? void 0 : s.values) == null ? void 0 : _d.length) || 0);
        if (0 !== o) return o;
...
function __PRIVATE_isVectorValue(e) {
  var _a2, _b;
  const t = (_b = (((_a2 = e == null ? void 0 : e.mapValue) == null ? void 0 : _a2.fields) || {})[st]) == null ? void 0 : _b.stringValue;
  return t === at;
}
...
function __PRIVATE_extractDocumentKeysFromArrayValue(e, t) {
  var _a2;
  return (((_a2 = t.arrayValue) == null ? void 0 : _a2.values) || []).map(((e2) => DocumentKey.fromName(e2.referenceValue)));
}
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          Vt == null ? void 0 : Vt.o((function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            ...
            o && (s.bloomFilter = {
              applied: 0 === i3,
              hashCount: (_a2 = o == null ? void 0 : o.hashCount) != null ? _a2 : 0,
              ...
              mightContain: (e3) => {
                var _a3;
                return (_a3 = r3 == null ? void 0 : r3.mightContain(e3)) != null ? _a3 : false;
              }
            });
            return s;
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  kt(e, t) {
    ...
    const n = e.fields || {};
    this.Ft(t, 53);
    const r = ut, i = ((_b = (_a2 = n[r].arrayValue) == null ? void 0 : _a2.values) == null ? void 0 : _b.length) || 0;
...
var LocalDocumentsView = class {
  ...
  computeViews(e, t, n, r) {
    ...
    return t.forEach(((e2, t2) => {
      ...
      var _a2;
      return o.set(e3, new OverlayedDocument(t2, (_a2 = s.get(e3)) != null ? _a2 : null));
    })), o)));
  }
  ...
  T_(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
      ...
      if (!l) {
        ...
        const i2 = n2, s2 = (i2 == null ? void 0 : i2.error) || ((_a2 = i2[0]) == null ? void 0 : _a2.error);
        if (s2) {
  ...
  r.Tu.isEmpty() || (r.Tu.forEach(((e2, _) => {
    o.push(r.pu(_, t, n).then(((e3) => {
      ...
      if ((e3 || n) && r.isPrimaryClient) {
        const t2 = e3 ? !e3.fromCache : (_a2 = n == null ? void 0 : n.targetChanges.get(_.targetId)) == null ? void 0 : _a2.current;
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  async terminate() {
    var _a2, _b;
    (_a2 = this.gcScheduler) == null ? void 0 : _a2.stop(), (_b = this.indexBackfillerScheduler) == null ? void 0 : _b.stop(), this.sharedClientState.shutdown(), await this.persistence.shutdown();
  }
};
...
var OnlineComponentProvider = class {
  ...
  async terminate() {
    ...
    })(this.remoteStore), (_a2 = this.datastore) == null ? void 0 : _a2.terminate(), (_b = this.eventManager) == null ? void 0 : _b.terminate();
  }
};
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    } else this.host = e.host, this.ssl = (_a2 = e.ssl) != null ? _a2 : nn;
...
function connectFirestoreEmulator(e, t, n, r = {}) {
  ...
  if (!deepEqual(a, o) && (e._setSettings(a), r.mockUserToken)) {
    ...
    if ("string" == typeof r.mockUserToken) t2 = r.mockUserToken, n2 = User.MOCK_USER;
      ...
      t2 = createMockUserToken(r.mockUserToken, (_a2 = e._app) == null ? void 0 : _a2.options.projectId);
...
function __PRIVATE_configureFirestore(e) {
  var _a2, _b, _c, _d;
  const t = e._freezeSettings(), n = __PRIVATE_makeDatabaseInfo(e._databaseId, ((_a2 = e._app) == null ? void 0 : _a2.options.appId) || "", e._persistenceKey, (_b = e._app) == null ? void 0 : _b.options.apiKey, t);
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(e) {
    var _a2, _b, _c;
    const t = (_c = (_b = (_a2 = e.fields) == null ? void 0 : _a2[ut].arrayValue) == null ? void 0 : _b.values) == null ? void 0 : _c.map(((e2) => __PRIVATE_normalizeNumber(e2.doubleValue)));
...
var DocumentSnapshot$1 = class {
  ...
  _fieldsProto() {
    var _a2, _b;
    return (_b = (_a2 = this._document) == null ? void 0 : _a2.data.clone().value.mapValue.fields) != null ? _b : void 0;
  }
  /**
...
function onSnapshot(t, ...e) {
  ...
  if (__PRIVATE_isPartialObserver(e[r])) {
    const t2 = e[r];
    e[r] = (_a2 = t2.next) == null ? void 0 : _a2.bind(t2), e[r + 1] = (_b = t2.error) == null ? void 0 : _b.bind(t2), e[r + 2] = (_c = t2.complete) == null ? void 0 : _c.bind(t2);
  }
  let o, i, c;
...
!(function __PRIVATE_registerFirestore(h, d = true) {
  __PRIVATE_setSDKVersion(SDK_VERSION), _registerComponent(new Component2("firestore", ((t, { instanceIdentifier: e, options: n }) => {
...
var _FirebaseService = class _FirebaseService {
  ...
  async loginWithFacebook() {
    const { FacebookAuthProvider, signInWithPopup } = await import("./chunk-QX4VAYBX.js");
  ...
  async loginWithMicrosoft() {
    const { OAuthProvider, signInWithPopup } = await import("./chunk-QX4VAYBX.js");
    ...
    const unsubscribe = onSnapshot(docRef, async (snapshot) => {
      if (snapshot.exists()) {
        try {
          ...
          console.error("X\u1EED l\xFD l\u1ED7i n\u1EBFu c\xF3:", error);
        } finally {
          try {
  ...
  async getFCMToken() {
    ...
    try {
      if ("serviceWorker" in navigator) {
        const baseHref = ((_a2 = document.querySelector("base")) == null ? void 0 : _a2.getAttribute("href")) || "/";
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FirebaseService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
__publicField(_NzFormControlComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  ...
  contentQueries: function NzFormControlComponent_ContentQueries(rf, ctx, dirIndex) {
    ...
    if (rf & 2) {
      let _t2;
      \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.defaultValidateControl = _t2.first);
    }
  },
...
//# sourceMappingURL=chunk-F22CD6US.js.map
