import {
  ...
  NzPageHeaderModule
} from "./chunk-6MKW3LKJ.js";
import {
  NzDescriptionsModule
} from "./chunk-D5642PCG.js";
import {
  NzAvatarComponent,
  NzAvatarModule
} from "./chunk-UMFSMH6H.js";
import {
...
function DashboardComponent_div_63_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_div_63_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_div_63_ng_template_8_nz_tag_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-tag", 51);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DashboardComponent_div_63_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, DashboardComponent_div_63_ng_template_8_nz_tag_1_Template, 2, 1, "nz-tag", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const data_r8 = ctx.$implicit;
...
function DashboardComponent_div_63_ng_template_9_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_div_63_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275template(1, DashboardComponent_div_63_ng_template_9_div_1_Template, 5, 2, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DashboardComponent_div_63_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 61)(1, "tot-button", 62);
    \u0275\u0275listener("click", function DashboardComponent_div_63_ng_template_10_Template_tot_button_click_1_listener() {
    ...
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "tot-button", 63);
    \u0275\u0275listener("click", function DashboardComponent_div_63_ng_template_10_Template_tot_button_click_4_listener() {
      const data_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
...
function DashboardComponent_div_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 41);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 42);
    \u0275\u0275template(4, DashboardComponent_div_63_ng_template_4_Template, 3, 4, "ng-template", 43)(5, DashboardComponent_div_63_ng_template_5_Template, 2, 1, "ng-template", 44)(6, DashboardComponent_div_63_ng_template_6_Template, 2, 1, "ng-template", 45)(7, DashboardComponent_div_63_ng_template_7_Template, 2, 1, "ng-template", 46)(8, DashboardComponent_div_63_ng_template_8_Template, 2, 1, "ng-template", 47)(9, DashboardComponent_div_63_ng_template_9_Template, 2, 1, "ng-template", 48)(10, DashboardComponent_div_63_ng_template_10_Template, 7, 7, "ng-template", 49);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function DashboardComponent_div_64_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    const data_r16 = ctx.$implicit;
    \u0275\u0275textInterpolate1(" ", data_r16.worker || data_r16.workerId || "-", " ");
  }
}
function DashboardComponent_div_64_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 80)(1, "code");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "slice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "tot-button", 81);
    \u0275\u0275listener("click", function DashboardComponent_div_64_ng_template_33_Template_tot_button_click_4_listener() {
      const data_r18 = \u0275\u0275restoreView(_r17).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r12.copyToClipboard(data_r18.content));
    });
    \u0275\u0275element(5, "span", 82);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind3(3, 2, data_r18.content, 0, 50), "", (data_r18.content == null ? null : data_r18.content.length) > 50 ? "..." : "");
  }
}
function DashboardComponent_div_64_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 61)(1, "tot-button", 83);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275listener("click", function DashboardComponent_div_64_ng_template_34_Template_tot_button_click_1_listener() {
      const data_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r12.retryTracking(data_r20));
    });
    \u0275\u0275element(3, "i", 84);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "tot-button", 85);
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275listener("click", function DashboardComponent_div_64_ng_template_34_Template_tot_button_click_6_listener() {
      const data_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r12.deleteTracking(data_r20));
    });
    \u0275\u0275element(8, "i", 86);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "tot-button", 87);
    \u0275\u0275listener("click", function DashboardComponent_div_64_ng_template_34_Template_tot_button_click_11_listener() {
      const data_r20 = \u0275\u0275restoreView(_r19).$implicit;
      return \u0275\u0275resetView(data_r20.expand = !data_r20.expand);
    });
    \u0275\u0275element(12, "i", 88);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "transloco");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("nzType", data_r20.expand ? "up" : "down");
    \u0275\u0275advance();
...
function DashboardComponent_div_64_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 41);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "div", 64)(4, "div", 65)(5, "div", 18)(6, "nz-input-group", 66)(7, "input", 67);
    \u0275\u0275pipe(8, "transloco");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 18)(12, "nz-select", 68);
    \u0275\u0275pipe(13, "transloco");
    ...
    \u0275\u0275element(14, "nz-option", 69);
    \u0275\u0275pipe(15, "transloco");
    \u0275\u0275element(16, "nz-option", 70);
    \u0275\u0275pipe(17, "transloco");
    \u0275\u0275element(18, "nz-option", 71);
    \u0275\u0275pipe(19, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 18)(21, "div", 72)(22, "nz-date-picker", 73);
    \u0275\u0275pipe(23, "transloco");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "nz-date-picker", 73);
    \u0275\u0275pipe(25, "transloco");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 18)(27, "tot-button", 74);
    ...
    \u0275\u0275pipe(29, "transloco");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(30, "tot-table", 75);
    ...
    \u0275\u0275template(31, DashboardComponent_div_64_ng_template_31_Template, 3, 4, "ng-template", 76)(32, DashboardComponent_div_64_ng_template_32_Template, 1, 1, "ng-template", 77)(33, DashboardComponent_div_64_ng_template_33_Template, 6, 6, "ng-template", 78)(34, DashboardComponent_div_64_ng_template_34_Template, 15, 17, "ng-template", 49);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const prefixSearch_r21 = \u0275\u0275reference(10);
    const ctx_r12 = \u0275\u0275nextContext();
    const expandTpl_r22 = \u0275\u0275reference(69);
    \u0275\u0275advance();
    ...
    \u0275\u0275property("nzSpan", 5);
    \u0275\u0275advance();
    \u0275\u0275property("nzPrefix", prefixSearch_r21);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx_r12.recentTracking)("columns", ctx_r12.trackingColumns)("loading", ctx_r12.loading)("total", ctx_r12.totalTracking)("pageIndex", ctx_r12.pageIndex)("pageSize", ctx_r12.pageSize)("frontPagination", false)("expandTemplate", expandTpl_r22);
  }
}
function DashboardComponent_div_65_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r23.status === "Running" ? "success" : "default");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, data_r23.status === "Running" ? "\u0110ang ch\u1EA1y" : "\u0110\xE3 d\u1EEBng"), " ");
  }
}
function DashboardComponent_div_65_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tot-button", 94);
    \u0275\u0275listener("click", function DashboardComponent_div_65_ng_template_5_Template_tot_button_click_0_listener() {
      const data_r25 = \u0275\u0275restoreView(_r24).$implicit;
      const ctx_r12 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r12.toggleWorker(data_r25.id, data_r25.status));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzType", data_r25.status === "Running" ? "default" : "primary")("nzDanger", data_r25.status === "Running");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 3, data_r25.status === "Running" ? "D\u1EEBng" : "Kh\u1EDFi ch\u1EA1y"), " ");
  }
}
function DashboardComponent_div_65_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-list-item")(1, "span", 95);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "nz-tag", 96);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", item_r26.count, " ", \u0275\u0275pipeBind1(5, 3, "l\u1ED7i"));
  }
}
function DashboardComponent_div_65_div_14_Template(rf, ctx) {
  if (rf & 1) {
...
function DashboardComponent_div_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 41);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 89);
    \u0275\u0275template(4, DashboardComponent_div_65_ng_template_4_Template, 3, 4, "ng-template", 90)(5, DashboardComponent_div_65_ng_template_5_Template, 3, 5, "ng-template", 49);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "nz-card", 91);
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275elementStart(8, "div", 65)(9, "div", 18)(10, "nz-list", 92);
    \u0275\u0275template(11, DashboardComponent_div_65_ng_template_11_Template, 6, 5, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 18);
    \u0275\u0275template(14, DashboardComponent_div_65_div_14_Template, 5, 3, "div", 93);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const errorItem_r27 = \u0275\u0275reference(12);
    const ctx_r12 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275property("nzSpan", 12);
    \u0275\u0275advance();
    \u0275\u0275property("nzDataSource", ctx_r12.errorStats)("nzRenderItem", errorItem_r27);
    \u0275\u0275advance(3);
    \u0275\u0275property("nzSpan", 12);
    \u0275\u0275advance();
...
function DashboardComponent_div_66_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r28.type === "Command" ? "blue" : data_r28.type === "Topic" ? "purple" : "cyan");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, data_r28.type), " ");
  }
}
function DashboardComponent_div_66_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nz-tooltip", \u0275\u0275pipeBind2(1, 3, data_r29.lastActive, "yyyy-MM-dd HH:mm:ss.SSS"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 6, data_r29.lastActive, "yyyy-MM-dd HH:mm:ss"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" (", \u0275\u0275pipeBind2(6, 9, data_r29.lastActive, "HH:mm:ss"), ") ");
  }
}
function DashboardComponent_div_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "nz-card", 41);
    \u0275\u0275pipe(2, "transloco");
    \u0275\u0275elementStart(3, "tot-table", 100);
    \u0275\u0275template(4, DashboardComponent_div_66_ng_template_4_Template, 3, 4, "ng-template", 43)(5, DashboardComponent_div_66_ng_template_5_Template, 7, 12, "ng-template", 101);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r12 = \u0275\u0275nextContext();
...
function DashboardComponent_ng_template_68_ng_template_16_nz_tag_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-tag", 50);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const step_r32 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("nzColor", step_r32.status === "success" ? "success" : "processing");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(step_r32.status);
  }
}
function DashboardComponent_ng_template_68_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, DashboardComponent_ng_template_68_ng_template_16_nz_tag_9_Template, 2, 2, "nz-tag", 113);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const step_r32 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(4, 4, step_r32.time, "HH:mm:ss.SSS"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r32.step);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(step_r32.details);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r32.status);
  }
}
function DashboardComponent_ng_template_68_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_ng_template_68_Template_tot_button_click_5_listener() {
      const data_r31 = \u0275\u0275restoreView(_r30).$implicit;
      const ctx_r12 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r12.copyToClipboard(data_r31.content));
    });
    \u0275\u0275element(6, "i", 82);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "transloco");
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 99)(12, "h4");
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "nz-list", 108);
    \u0275\u0275template(16, DashboardComponent_ng_template_68_ng_template_16_Template, 10, 7, "ng-template", null, 7, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const data_r31 = ctx.$implicit;
    const historyItem_r33 = \u0275\u0275reference(17);
    const ctx_r12 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r12.formatJson(data_r31.content));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 10, "L\u1ECBch s\u1EED x\u1EED l\xFD"));
    \u0275\u0275advance(2);
    \u0275\u0275property("nzDataSource", data_r31.history)("nzRenderItem", historyItem_r33);
  }
}
var _DashboardComponent = class _DashboardComponent {
  ...
  initColumns() {
    this.trackingColumns = [
      ...
      { title: "H\xE0nh \u0111\u1ED9ng", width: "100px", right: true }
    ];
    this.queueColumns = [
      { title: "Lo\u1EA1i", key: "type", width: "80px", left: true },
      { title: "T\xEAn topic/ queue", key: "name", width: "200px", left: "80px" },
      { title: "\u0110ang x\u1EED l\xFD", key: "processing", width: "100px", align: "center" },
      { title: "Th\xE0nh c\xF4ng", width: "120px", align: "center" },
...
_DashboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 70, vars: 63, consts: [["prefixEnqueued", ""], ["prefixProcessed", ""], ["prefixError", ""], ["prefixWorkers", ""], ["expandTpl", ""], ["prefixSearch", ""], ["errorItem", ""], ["historyItem", ""], [1, "dashboard-container"], [1, "site-page-header", 3, "nzTitle"], [2, "display", "flex", "align-items", "center", "gap", "16px"], [2, "display", "flex", "align-items", "center", "gap", "8px"], [2, "color", "#999"], [2, "width", "120px", 3, "ngModelChange", "ngModel"], [3, "nzLabel", "nzValue", 4, "ngFor", "ngForOf"], ["nzType", "primary", 3, "click", "loading"], ["nz-icon", "", "nzType", "reload"], ["nz-row", "", 1, "stats-row", 2, "margin-bottom", "24px", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], ["nzHoverable", ""], [3, "nzValue", "nzTitle", "nzPrefix"], [3, "nzValue", "nzTitle", "nzPrefix", "nzValueStyle"], [1, "tab-actions", 2, "margin-bottom", "16px", "display", "flex", "justify-content", "center"], ["nzButtonStyle", "solid", "nzSize", "large", 3, "ngModelChange", "ngModel"], ["nz-radio-button", "", "nzValue", "queues"], ["nz-icon", "", "nzType", "database"], ["nz-radio-button", "", "nzValue", "tracking"], ["nz-icon", "", "nzType", "history"], ["nz-radio-button", "", "nzValue", "workers"], ["nz-icon", "", "nzType", "api"], ["nz-radio-button", "", "nzValue", "activity"], ["nz-icon", "", "nzType", "clock-circle"], ["nz-radio-button", "", "nzValue", "test"], ["nz-icon", "", "nzType", "experiment"], [3, "ngSwitch"], [4, "ngSwitchCase"], [3, "nzLabel", "nzValue"], ["nz-icon", "", "nzType", "cloud-upload", 2, "color", "#1890ff"], ["nz-icon", "", "nzType", "check-circle", 2, "color", "#52c41a"], ["nz-icon", "", "nzType", "close-circle", 2, "color", "#ff4d4f"], ["nz-icon", "", "nzType", "cluster", 2, "color", "#722ed1"], [3, "nzTitle"], [3, "data", "columns", "loading", "pageSize", "frontPagination", "showPagination", "scroll"], ["totCell", "Lo\u1EA1i"], ["totCell", "processing"], ["totCell", "Th\xE0nh c\xF4ng"], ["totCell", "L\u1ED7i"], ["totCell", "Workers"], ["totCell", "Handlers"], ["totCell", "H\xE0nh \u0111\u1ED9ng"], [3, "nzColor"], ["nzColor", "processing"], ["nzColor", "success"], ["nzColor", "error"], [1, "worker-tags"], ["nzColor", "processing", 4, "ngFor", "ngForOf"], [1, "handler-grid"], ["class", "handler-tag-item", 4, "ngFor", "ngForOf"], [1, "handler-tag-item"], [1, "h-name"], [1, "m-name"], [2, "display", "flex", "gap", "4px", "flex-direction", "column"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzGhost"], ["nzType", "default", "nzSize", "small", 3, "click"], [1, "filters-container", 2, "margin-bottom", "24px"], ["nz-row", "", 3, "nzGutter"], [3, "nzPrefix"], ["type", "text", "nz-input", "", 3, "ngModelChange", "ngModel", "placeholder"], ["nzAllowClear", "", 2, "width", "100%", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], ["nzValue", "success", 3, "nzLabel"], ["nzValue", "error", 3, "nzLabel"], ["nzValue", "processing", 3, "nzLabel"], [2, "display", "flex", "gap", "8px"], [2, "flex", "1", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], [3, "click", "nzBlock"], [3, "queryParamsChange", "data", "columns", "loading", "total", "pageIndex", "pageSize", "frontPagination", "expandTemplate"], ["totCell", "Status"], ["totCell", "Worker"], ["totCell", "Content"], ["nz-icon", "", "nzType", "search"], [1, "content-preview"], ["nzType", "text", "nzSize", "small", 3, "click"], ["nz-icon", "", "nzType", "copy"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzTooltipTitle"], ["nz-icon", "", "nzType", "rollback"], ["nzSize", "small", "nzType", "link", "nz-tooltip", "", 3, "click", "nzDanger", "nzTooltipTitle"], ["nz-icon", "", "nzType", "delete"], ["nzSize", "small", "nzType", "link", 3, "click"], ["nz-icon", "", 3, "nzType"], [3, "data", "columns", "pageSize", "frontPagination", "showPagination", "scroll"], ["totCell", "Tr\u1EA1ng th\xE1i"], [2, "margin-top", "24px", 3, "nzTitle"], ["nzBordered", "", 3, "nzDataSource", "nzRenderItem"], ["class", "empty-state", 4, "ngIf"], [3, "click", "nzType", "nzDanger"], [2, "color", "#ff4d4f", "font-weight", "bold"], ["nzColor", "red"], [1, "empty-state"], ["nz-icon", "", "nzType", "check-circle", 2, "font-size", "48px", "color", "#52c41a"], [2, "margin-top", "16px"], ["nzSize", "middle", 3, "data", "columns", "pageSize", "frontPagination", "showPagination"], ["totCell", "Ho\u1EA1t \u0111\u1ED9ng cu\u1ED1i"], [3, "nz-tooltip"], [2, "color", "#999", "font-size", "12px", "margin-left", "8px"], [1, "json-viewer-container", 2, "width", "100%"], [1, "json-header"], ["nzSize", "small", 3, "click"], [1, "json-content"], [3, "nzDataSource", "nzRenderItem"], [2, "display", "flex", "width", "100%", "gap", "16px"], [2, "width", "150px", "color", "#999"], [2, "width", "100px", "font-weight", "bold"], [2, "flex", "1"], [3, "nzColor", 4, "ngIf"]], template: function DashboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(61, "transloco");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementContainerStart(62, 34);
    \u0275\u0275template(63, DashboardComponent_div_63_Template, 11, 11, "div", 35)(64, DashboardComponent_div_64_Template, 35, 46, "div", 35)(65, DashboardComponent_div_65_Template, 15, 19, "div", 35)(66, DashboardComponent_div_66_Template, 6, 8, "div", 35)(67, DashboardComponent_div_67_Template, 2, 0, "div", 35);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(68, DashboardComponent_ng_template_68_Template, 18, 12, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzValue", ctx.stats.stats["total:processed"] || 0)("nzTitle", \u0275\u0275pipeBind1(25, 45, "\u0110\xE3 x\u1EED l\xFD th\xE0nh c\xF4ng"))("nzPrefix", prefixProcessed_r35)("nzValueStyle", \u0275\u0275pureFunction0(61, _c06));
    \u0275\u0275advance(4);
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    \u0275\u0275property("nzValue", ctx.stats.stats["total:error"] || 0)("nzTitle", \u0275\u0275pipeBind1(31, 47, "L\u1ED7i h\u1EC7 th\u1ED1ng"))("nzPrefix", prefixError_r36)("nzValueStyle", \u0275\u0275pureFunction0(62, _c13));
    \u0275\u0275advance(4);
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(2);
    ...
    <div *ngSwitchCase="'queues'">
      <nz-card [nzTitle]="'Danh s\xE1ch th\u1EF1c th\u1EC3 CQRS' | transloco">
        <tot-table
          ...
          [scroll]="{ x: '1200px' }"
        >
          <ng-template totCell="Lo\u1EA1i" let-data>
          ...
          <ng-template totCell="Th\xE0nh c\xF4ng" let-data>
            <nz-tag nzColor="success">{{ data.processedCount }}</nz-tag>
          </ng-template>

          <ng-template totCell="L\u1ED7i" let-data>
          ...
          <ng-template totCell="H\xE0nh \u0111\u1ED9ng" let-data>
    ...
    <div *ngSwitchCase="'workers'">
      <nz-card [nzTitle]="'Gi\xE1m s\xE1t ti\u1EBFn tr\xECnh (Workers)' | transloco">
        <tot-table
          ...
          [scroll]="{ x: '800px' }"
        >
          <ng-template totCell="Tr\u1EA1ng th\xE1i" let-data>
    ...
    <div *ngSwitchCase="'activity'">
      <nz-card [nzTitle]="'Danh s\xE1ch th\u1EDDi gian ho\u1EA1t \u0111\u1ED9ng l\u1EA7n cu\u1ED1i' | transloco">
        ...
        >
          ...
          <ng-template totCell="Ho\u1EA1t \u0111\u1ED9ng cu\u1ED1i" let-data>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "projects/tot/business-dashboard/src/lib/dashboard/dashboard.component.ts", lineNumber: 65 });
})();
...
//# sourceMappingURL=chunk-MXC6E2UK.js.map
