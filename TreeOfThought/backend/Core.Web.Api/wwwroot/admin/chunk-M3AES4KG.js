...
__publicField(_NzAggregatePipe, "\u0275fac", function NzAggregatePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzAggregatePipe)();
});
__publicField(_NzAggregatePipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzAggregate",
...
__publicField(_NzBytesPipe, "formats", {
  B: {
    max: 1024
  },
  kB: {
...
__publicField(_NzBytesPipe, "\u0275fac", function NzBytesPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzBytesPipe)();
});
__publicField(_NzBytesPipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzBytes",
  type: _NzBytesPipe,
  pure: true
}));
...
__publicField(_NzToCssUnitPipe, "\u0275fac", function NzToCssUnitPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzToCssUnitPipe)();
});
__publicField(_NzToCssUnitPipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzToCssUnit",
...
__publicField(_NzEllipsisPipe, "\u0275fac", function NzEllipsisPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzEllipsisPipe)();
});
__publicField(_NzEllipsisPipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzEllipsis",
...
__publicField(_NzSanitizerPipe, "\u0275fac", function NzSanitizerPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzSanitizerPipe)();
});
__publicField(_NzSanitizerPipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzSanitizer",
...
__publicField(_NzTrimPipe, "\u0275fac", function NzTrimPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzTrimPipe)();
});
__publicField(_NzTrimPipe, "\u0275pipe", /* @__PURE__ */ \u0275\u0275definePipe({
  name: "nzTrim",
  type: _NzTrimPipe,
  pure: true
}));
...
__publicField(__ResetsLoader, "\u0275fac", function _ResetsLoader_Factory(__ngFactoryType__) {
...
var _DragDropRegistry = class _DragDropRegistry {
  constructor() {
    ...
    __publicField(this, "_styleLoader", inject(_CdkPrivateStyleLoader));
    __publicField(this, "_renderer", inject(RendererFactory2).createRenderer(null, null));
    __publicField(this, "_cleanupDocumentTouchmove");
    __publicField(this, "_scroll", new Subject());
    __publicField(this, "_dropInstances", /* @__PURE__ */ new Set());
    __publicField(this, "_dragInstances", /* @__PURE__ */ new Set());
    __publicField(this, "_activeDragInstances", signal([], ...ngDevMode ? [{
      debugName: "_activeDragInstances"
    }] : []));
    __publicField(this, "_globalListeners");
    __publicField(this, "_draggingPredicate", (item) => item.isDragging());
    __publicField(this, "_domNodesToDirectives", null);
    __publicField(this, "pointerMove", new Subject());
    __publicField(this, "pointerUp", new Subject());
    __publicField(this, "_preventDefaultWhileDragging", (event) => {
      if (this._activeDragInstances().length > 0) {
        event.preventDefault();
      }
    });
    __publicField(this, "_persistentTouchmoveListener", (event) => {
      if (this._activeDragInstances().length > 0) {
  ...
  registerDragItem(drag) {
    ...
    if (this._dragInstances.size === 1) {
      this._ngZone.runOutsideAngular(() => {
        var _a;
        (_a = this._cleanupDocumentTouchmove) == null ? void 0 : _a.call(this);
  ...
  registerDirectiveNode(node, dragRef) {
    var _a;
    (_a = this._domNodesToDirectives) != null ? _a : this._domNodesToDirectives = /* @__PURE__ */ new WeakMap();
    this._domNodesToDirectives.set(node, dragRef);
  }
  removeDirectiveNode(node) {
    var _a;
    (_a = this._domNodesToDirectives) == null ? void 0 : _a.delete(node);
  }
  getDragDirectiveForNode(node) {
    var _a;
    return ((_a = this._domNodesToDirectives) == null ? void 0 : _a.get(node)) || null;
  }
  ngOnDestroy() {
  ...
  _clearGlobalListeners() {
    var _a;
    (_a = this._globalListeners) == null ? void 0 : _a.forEach((cleanup) => cleanup());
    this._globalListeners = void 0;
  }
};
__publicField(_DragDropRegistry, "\u0275fac", function DragDropRegistry_Factory(__ngFactoryType__) {
...
var PreviewRef = class {
  constructor(_document, _rootElement, _direction, _initialDomRect, _previewTemplate, _previewClass, _pickupPositionOnPage, _initialTransform, _zIndex, _renderer) {
    ...
    __publicField(this, "_initialDomRect");
    __publicField(this, "_previewTemplate");
    __publicField(this, "_previewClass");
    __publicField(this, "_pickupPositionOnPage");
    __publicField(this, "_initialTransform");
    __publicField(this, "_zIndex");
    __publicField(this, "_renderer");
    __publicField(this, "_previewEmbeddedView", null);
...
var DragRef = class {
  constructor(element, _config, _document, _ngZone, _viewportRuler, _dragDropRegistry, _renderer) {
    ...
    __publicField(this, "_viewportRuler");
    __publicField(this, "_dragDropRegistry");
    __publicField(this, "_renderer");
    __publicField(this, "_rootElementCleanups");
    __publicField(this, "_cleanupShadowRootSelectStart");
    __publicField(this, "_preview", null);
    __publicField(this, "_previewContainer");
    __publicField(this, "_placeholderRef", null);
    __publicField(this, "_placeholder");
    __publicField(this, "_pickupPositionInElement");
    __publicField(this, "_pickupPositionOnPage");
    __publicField(this, "_marker");
    __publicField(this, "_anchor", null);
    __publicField(this, "_passiveTransform", {
      x: 0,
      y: 0
    });
    __publicField(this, "_activeTransform", {
      x: 0,
      y: 0
    });
    __publicField(this, "_initialTransform");
    __publicField(this, "_hasStartedDragging", signal(false, ...ngDevMode ? [{
      debugName: "_hasStartedDragging"
    }] : []));
    __publicField(this, "_hasMoved", false);
    __publicField(this, "_initialContainer");
    __publicField(this, "_initialIndex");
    __publicField(this, "_parentPositions");
    __publicField(this, "_moveEvents", new Subject());
    __publicField(this, "_pointerDirectionDelta");
    __publicField(this, "_pointerPositionAtLastDirectionChange");
    __publicField(this, "_lastKnownPointerPosition");
    __publicField(this, "_rootElement");
    __publicField(this, "_ownerSVGElement", null);
    __publicField(this, "_rootElementTapHighlight");
    __publicField(this, "_pointerMoveSubscription", Subscription.EMPTY);
    __publicField(this, "_pointerUpSubscription", Subscription.EMPTY);
    __publicField(this, "_scrollSubscription", Subscription.EMPTY);
    __publicField(this, "_resizeSubscription", Subscription.EMPTY);
    __publicField(this, "_lastTouchEventTime");
    __publicField(this, "_dragStartTime");
    __publicField(this, "_boundaryElement", null);
    __publicField(this, "_nativeInteractionsEnabled", true);
    __publicField(this, "_initialDomRect");
    __publicField(this, "_previewRect");
    __publicField(this, "_boundaryRect");
    __publicField(this, "_previewTemplate");
    __publicField(this, "_placeholderTemplate");
    __publicField(this, "_handles", []);
    __publicField(this, "_disabledHandles", /* @__PURE__ */ new Set());
    __publicField(this, "_dropContainer");
    __publicField(this, "_direction", "ltr");
    __publicField(this, "_parentDragRef", null);
    __publicField(this, "_cachedShadowRoot");
    __publicField(this, "lockAxis", null);
    __publicField(this, "dragStartDelay", 0);
    __publicField(this, "previewClass");
    __publicField(this, "scale", 1);
    __publicField(this, "_disabled", false);
    __publicField(this, "beforeStarted", new Subject());
    __publicField(this, "started", new Subject());
    __publicField(this, "released", new Subject());
    __publicField(this, "ended", new Subject());
    __publicField(this, "entered", new Subject());
    __publicField(this, "exited", new Subject());
    __publicField(this, "dropped", new Subject());
    __publicField(this, "moved", this._moveEvents);
    __publicField(this, "data");
    __publicField(this, "constrainPosition");
    __publicField(this, "_pointerDown", (event) => {
    ...
    __publicField(this, "_pointerMove", (event) => {
    ...
    __publicField(this, "_pointerUp", (event) => {
      this._endDragSequence(event);
    });
    __publicField(this, "_nativeDragStart", (event) => {
      if (this._handles.length) {
        const targetHandle = this._getTargetHandle(event);
        if (targetHandle && !this._disabledHandles.has(targetHandle) && !this.disabled) {
          event.preventDefault();
  ...
  dispose() {
    ...
    (_b = this._marker) == null ? void 0 : _b.remove();
  ...
  _removeListeners() {
    ...
    (_a = this._cleanupShadowRootSelectStart) == null ? void 0 : _a.call(this);
  ...
  _destroyPlaceholder() {
    var _a, _b, _c;
    (_a = this._anchor) == null ? void 0 : _a.remove();
    (_b = this._placeholder) == null ? void 0 : _b.remove();
    (_c = this._placeholderRef) == null ? void 0 : _c.destroy();
  ...
  _updateActiveDropContainer({
    ...
    if (newContainer && newContainer !== this._dropContainer) {
      this._ngZone.run(() => {
        ...
        const nextItemElement = ((_a = this._dropContainer.getItemAtIndex(exitIndex + 1)) == null ? void 0 : _a.getVisibleElement()) || null;
        this.exited.next({
          item: this,
  ...
  _removeRootElementListeners() {
    var _a;
    (_a = this._rootElementCleanups) == null ? void 0 : _a.forEach((cleanup) => cleanup());
  ...
  _conditionallyInsertAnchor(newContainer, exitContainer, nextItemElement) {
    ...
    if (newContainer === this._initialContainer) {
      ...
      const anchor = (_b = this._anchor) != null ? _b : this._anchor = deepCloneNode(this._placeholder);
...
var SingleAxisSortStrategy = class {
  constructor(_dragDropRegistry) {
    ...
    __publicField(this, "_sortPredicate");
    __publicField(this, "_itemPositions", []);
    __publicField(this, "_activeDraggables");
    __publicField(this, "orientation", "vertical");
    __publicField(this, "direction", "ltr");
    __publicField(this, "_previousSwap", {
      drag: null,
      delta: 0,
      overlaps: false
    });
  ...
  reset() {
    var _a;
    (_a = this._activeDraggables) == null ? void 0 : _a.forEach((item) => {
      var _a2;
      const rootElement = item.getRootElement();
      if (rootElement) {
        const initialTransform = (_a2 = this._itemPositions.find((p) => p.drag === item)) == null ? void 0 : _a2.initialTransform;
  ...
  getItemAtIndex(index) {
    var _a;
    return ((_a = this._getVisualItemPositions()[index]) == null ? void 0 : _a.drag) || null;
  }
...
var MixedSortStrategy = class {
  constructor(_document, _dragDropRegistry) {
    ...
    __publicField(this, "_activeItems");
    __publicField(this, "_previousSwap", {
      drag: null,
      deltaX: 0,
      deltaY: 0,
    ...
    __publicField(this, "_relatedNodes", []);
    this._document = _document;
    this._dragDropRegistry = _dragDropRegistry;
  }
  start(items) {
...
var DropListRef = class {
  constructor(element, _dragDropRegistry, _document, _ngZone, _viewportRuler) {
    ...
    __publicField(this, "sortingDisabled", false);
    __publicField(this, "lockAxis", null);
    __publicField(this, "autoScrollDisabled", false);
    __publicField(this, "autoScrollStep", 2);
    __publicField(this, "hasAnchor", false);
    __publicField(this, "enterPredicate", () => true);
    __publicField(this, "sortPredicate", () => true);
    __publicField(this, "beforeStarted", new Subject());
    __publicField(this, "entered", new Subject());
    __publicField(this, "exited", new Subject());
    __publicField(this, "dropped", new Subject());
    __publicField(this, "sorted", new Subject());
    __publicField(this, "receivingStarted", new Subject());
    __publicField(this, "receivingStopped", new Subject());
    __publicField(this, "data");
    __publicField(this, "_container");
    __publicField(this, "_isDragging", false);
    __publicField(this, "_parentPositions");
    __publicField(this, "_sortStrategy");
    __publicField(this, "_domRect");
    __publicField(this, "_draggables", []);
    __publicField(this, "_siblings", []);
    __publicField(this, "_activeSiblings", /* @__PURE__ */ new Set());
    __publicField(this, "_viewportScrollSubscription", Subscription.EMPTY);
    __publicField(this, "_verticalScrollDirection", AutoScrollVerticalDirection.NONE);
    __publicField(this, "_horizontalScrollDirection", AutoScrollHorizontalDirection.NONE);
    __publicField(this, "_scrollNode");
    __publicField(this, "_stopScrollTimers", new Subject());
    __publicField(this, "_cachedShadowRoot", null);
    __publicField(this, "_document");
    __publicField(this, "_scrollableElements", []);
    __publicField(this, "_initialScrollSnap");
    __publicField(this, "_direction", "ltr");
    __publicField(this, "_startScrollInterval", () => {
      this._stopScrolling();
...
__publicField(_DragDrop, "\u0275fac", function DragDrop_Factory(__ngFactoryType__) {
...
var _CdkDragHandle = class _CdkDragHandle {
  constructor() {
    ...
    __publicField(this, "_parentDrag", inject(CDK_DRAG_PARENT, {
      optional: true,
      skipSelf: true
    }));
    __publicField(this, "_dragDropRegistry", inject(DragDropRegistry));
    __publicField(this, "_stateChanges", new Subject());
    __publicField(this, "_disabled", false);
    var _a;
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      assertElementNode(this.element.nativeElement, "cdkDragHandle");
    }
    (_a = this._parentDrag) == null ? void 0 : _a._addHandle(this);
  }
  get disabled() {
...
__publicField(_CdkDragHandle, "\u0275fac", function CdkDragHandle_Factory(__ngFactoryType__) {
...
var _CdkDrag = class _CdkDrag {
  constructor() {
    __publicField(this, "element", inject(ElementRef));
    __publicField(this, "dropContainer", inject(CDK_DROP_LIST, {
      optional: true,
      skipSelf: true
    }));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_viewContainerRef", inject(ViewContainerRef));
    __publicField(this, "_dir", inject(Directionality, {
      optional: true
    }));
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_selfHandle", inject(CDK_DRAG_HANDLE, {
      optional: true,
      self: true
    }));
    __publicField(this, "_parentDrag", inject(CDK_DRAG_PARENT, {
    ...
    __publicField(this, "_dragDropRegistry", inject(DragDropRegistry));
    __publicField(this, "_destroyed", new Subject());
    __publicField(this, "_handles", new BehaviorSubject([]));
    __publicField(this, "_previewTemplate", null);
    __publicField(this, "_placeholderTemplate", null);
    __publicField(this, "_dragRef");
    __publicField(this, "data");
    __publicField(this, "lockAxis", null);
    __publicField(this, "rootElementSelector");
    __publicField(this, "boundaryElement");
    __publicField(this, "dragStartDelay");
    __publicField(this, "freeDragPosition");
    __publicField(this, "_disabled", false);
    __publicField(this, "constrainPosition");
    __publicField(this, "previewClass");
    __publicField(this, "previewContainer");
    __publicField(this, "scale", 1);
    __publicField(this, "started", new EventEmitter());
    __publicField(this, "released", new EventEmitter());
    __publicField(this, "ended", new EventEmitter());
    __publicField(this, "entered", new EventEmitter());
    __publicField(this, "exited", new EventEmitter());
    __publicField(this, "dropped", new EventEmitter());
    __publicField(this, "moved", new Observable((observer) => {
...
__publicField(_CdkDrag, "\u0275fac", function CdkDrag_Factory(__ngFactoryType__) {
...
__publicField(_CdkDropListGroup, "\u0275fac", function CdkDropListGroup_Factory(__ngFactoryType__) {
...
var _CdkDropList = class _CdkDropList {
  constructor() {
    __publicField(this, "element", inject(ElementRef));
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_scrollDispatcher", inject(ScrollDispatcher));
    __publicField(this, "_dir", inject(Directionality, {
      optional: true
    }));
    __publicField(this, "_group", inject(CDK_DROP_LIST_GROUP, {
      optional: true,
      skipSelf: true
    }));
    __publicField(this, "_latestSortedRefs");
    __publicField(this, "_destroyed", new Subject());
    __publicField(this, "_scrollableParentsResolved", false);
    __publicField(this, "_dropListRef");
    __publicField(this, "connectedTo", []);
    __publicField(this, "data");
    __publicField(this, "orientation", "vertical");
    __publicField(this, "id", inject(_IdGenerator).getId("cdk-drop-list-"));
    __publicField(this, "lockAxis", null);
    __publicField(this, "_disabled", false);
    __publicField(this, "sortingDisabled", false);
    __publicField(this, "enterPredicate", () => true);
    __publicField(this, "sortPredicate", () => true);
    __publicField(this, "autoScrollDisabled", false);
    __publicField(this, "autoScrollStep");
    __publicField(this, "elementContainerSelector", null);
    __publicField(this, "hasAnchor", false);
    __publicField(this, "dropped", new EventEmitter());
    __publicField(this, "entered", new EventEmitter());
    __publicField(this, "exited", new EventEmitter());
    __publicField(this, "sorted", new EventEmitter());
    __publicField(this, "_unsortedItems", /* @__PURE__ */ new Set());
    const config = inject(CDK_DRAG_CONFIG, {
      optional: true
    });
...
__publicField(_CdkDropList, "\u0275fac", function CdkDropList_Factory(__ngFactoryType__) {
...
var _CdkDragPreview = class _CdkDragPreview {
  constructor() {
    ...
    __publicField(this, "_drag", inject(CDK_DRAG_PARENT, {
      optional: true
    }));
    __publicField(this, "data");
    __publicField(this, "matchSize", false);
    var _a;
...
__publicField(_CdkDragPreview, "\u0275fac", function CdkDragPreview_Factory(__ngFactoryType__) {
...
__publicField(_CdkDragPlaceholder, "\u0275fac", function CdkDragPlaceholder_Factory(__ngFactoryType__) {
...
var ModalOptions = class {
  constructor() {
    ...
    __publicField(this, "nzClosable", true);
    __publicField(this, "nzOkLoading", false);
    __publicField(this, "nzOkDisabled", false);
    __publicField(this, "nzCancelDisabled", false);
    __publicField(this, "nzCancelLoading", false);
    __publicField(this, "nzDraggable", false);
    __publicField(this, "nzNoAnimation", false);
    __publicField(this, "nzAutofocus", "auto");
    __publicField(this, "nzMask");
    __publicField(this, "nzMaskClosable");
    __publicField(this, "nzKeyboard", true);
    __publicField(this, "nzZIndex", 1e3);
    __publicField(this, "nzWidth", 520);
    __publicField(this, "nzCloseIcon", "close");
    __publicField(this, "nzOkType", "primary");
    __publicField(this, "nzOkDanger", false);
    __publicField(this, "nzModalType", "default");
    __publicField(this, "nzOnCancel", noopFun);
    __publicField(this, "nzOnOk", noopFun);
    __publicField(this, "nzData");
    __publicField(this, "nzMaskStyle");
    __publicField(this, "nzBodyStyle");
    __publicField(this, "nzWrapClassName");
    __publicField(this, "nzClassName");
    __publicField(this, "nzStyle");
    __publicField(this, "nzTitle");
    __publicField(this, "nzFooter");
    // Default Modal ONLY
    __publicField(this, "nzCancelText");
    __publicField(this, "nzOkText");
    __publicField(this, "nzContent");
    __publicField(this, "nzCloseOnNavigation");
    __publicField(this, "nzViewContainerRef");
    // Template use only
    __publicField(this, "nzAfterOpen");
    __publicField(this, "nzAfterClose");
    // Confirm
    __publicField(this, "nzIconType", "question-circle");
    __publicField(this, "nzDirection");
  }
};
...
var _NzModalCloseComponent = class _NzModalCloseComponent {
  constructor() {
    __publicField(this, "config", inject(ModalOptions));
  }
};
__publicField(_NzModalCloseComponent, "\u0275fac", function NzModalCloseComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalCloseComponent)();
});
__publicField(_NzModalCloseComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _BaseModalContainerComponent = class _BaseModalContainerComponent extends BasePortalOutlet {
  constructor() {
    ...
    __publicField(this, "focusTrapFactory", inject(FocusTrapFactory));
    __publicField(this, "render", inject(Renderer2));
    __publicField(this, "overlayRef", inject(OverlayRef));
    ...
    __publicField(this, "portalOutlet");
    __publicField(this, "modalElementRef");
    __publicField(this, "animationStateChanged", new EventEmitter());
    __publicField(this, "containerClick", new EventEmitter());
    __publicField(this, "cancelTriggered", new EventEmitter());
    __publicField(this, "okTriggered", new EventEmitter());
    __publicField(this, "modalRef");
    __publicField(this, "isStringContent", false);
    __publicField(this, "dir", "ltr");
    __publicField(this, "elementFocusedBeforeModalWasOpened", null);
    __publicField(this, "focusTrap");
    __publicField(this, "mouseDown", false);
    __publicField(this, "oldMaskStyle", null);
  ...
  restoreFocus() {
    var _a, _b;
    (_a = this.elementFocusedBeforeModalWasOpened) == null ? void 0 : _a.focus();
    (_b = this.focusTrap) == null ? void 0 : _b.destroy();
  }
...
__publicField(_BaseModalContainerComponent, "\u0275fac", function BaseModalContainerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BaseModalContainerComponent)();
});
__publicField(_BaseModalContainerComponent, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_NzModalConfirmContainerComponent, "\u0275fac", function NzModalConfirmContainerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalConfirmContainerComponent)();
});
__publicField(_NzModalConfirmContainerComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _NzModalFooterComponent = class _NzModalFooterComponent {
  constructor() {
    __publicField(this, "i18n", inject(NzI18nService));
    __publicField(this, "config", inject(ModalOptions));
    __publicField(this, "buttonsFooter", false);
...
__publicField(_NzModalFooterComponent, "\u0275fac", function NzModalFooterComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalFooterComponent)();
});
__publicField(_NzModalFooterComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
__publicField(_NzModalTitleComponent, "\u0275fac", function NzModalTitleComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalTitleComponent)();
});
__publicField(_NzModalTitleComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
__publicField(_NzModalContainerComponent, "\u0275fac", /* @__PURE__ */ (() => {
...
__publicField(_NzModalContainerComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var NzModalRef = class {
  constructor(overlayRef, config, containerInstance) {
    ...
    __publicField(this, "componentInstance", null);
    __publicField(this, "componentRef", null);
    __publicField(this, "result");
    __publicField(this, "state", NzModalState.OPEN);
    __publicField(this, "afterClose", new Subject());
    __publicField(this, "afterOpen", new Subject());
...
var _NzModalService = class _NzModalService {
  constructor() {
    ...
    __publicField(this, "parentModal", inject(_NzModalService, {
      skipSelf: true,
      optional: true
    }));
    __publicField(this, "openModalsAtThisLevel", []);
    __publicField(this, "afterAllClosedAtThisLevel", new Subject());
    __publicField(this, "afterAllClose", defer(() => this.openModals.length ? this._afterAllClosed : this._afterAllClosed.pipe(startWith(void 0))));
  }
  get openModals() {
  ...
  open(componentOrTemplateRef, config) {
    ...
    overlayZIndexSetter(overlayRef, config == null ? void 0 : config.nzZIndex);
...
__publicField(_NzModalService, "\u0275fac", function NzModalService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalService)();
});
__publicField(_NzModalService, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_NzModalContentDirective, "\u0275fac", function NzModalContentDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalContentDirective)();
});
__publicField(_NzModalContentDirective, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
var _NzModalFooterDirective = class _NzModalFooterDirective {
  constructor() {
    __publicField(this, "templateRef", inject(TemplateRef));
    __publicField(this, "nzModalRef", inject(NzModalRef, {
      optional: true
    }));
    var _a;
    (_a = this.nzModalRef) == null ? void 0 : _a.updateConfig({
      nzFooter: this.templateRef
    });
  }
};
__publicField(_NzModalFooterDirective, "\u0275fac", function NzModalFooterDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalFooterDirective)();
});
__publicField(_NzModalFooterDirective, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_NzModalTitleDirective, "\u0275fac", function NzModalTitleDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalTitleDirective)();
});
__publicField(_NzModalTitleDirective, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
var _NzModalComponent = class _NzModalComponent {
  constructor() {
    __publicField(this, "cdr", inject(ChangeDetectorRef));
    __publicField(this, "modal", inject(NzModalService));
     ...
     * @note The input usage will be removed in v22.
     */
    __publicField(this, "nzOnCancel", new EventEmitter());
    __publicField(this, "nzAfterOpen", new EventEmitter());
    __publicField(this, "nzAfterClose", new EventEmitter());
    __publicField(this, "nzVisibleChange", new EventEmitter());
    __publicField(this, "contentFromContentChild");
    __publicField(this, "modalRef", null);
    this.destroyRef.onDestroy(() => {
      var _a;
      (_a = this.modalRef) == null ? void 0 : _a._finishDialogClose();
    });
  }
  ...
  triggerOk() {
    var _a;
    (_a = this.modalRef) == null ? void 0 : _a.triggerOk();
  }
  triggerCancel() {
    var _a;
    (_a = this.modalRef) == null ? void 0 : _a.triggerCancel();
  }
  getContentComponent() {
    var _a;
    return (_a = this.modalRef) == null ? void 0 : _a.getContentComponent();
  }
  getElement() {
    var _a;
    return (_a = this.modalRef) == null ? void 0 : _a.getElement();
  }
  getModalRef() {
...
__publicField(_NzModalComponent, "\u0275fac", function NzModalComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalComponent)();
});
__publicField(_NzModalComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
__publicField(_NzModalModule, "\u0275fac", function NzModalModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzModalModule)();
});
__publicField(_NzModalModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _NzModalModule,
...
__publicField(_NzModalModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
//# sourceMappingURL=chunk-M3AES4KG.js.map
