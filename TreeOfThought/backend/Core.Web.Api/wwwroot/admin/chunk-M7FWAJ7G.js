...
// projects/tot/shared/src/lib/components/tot-select/tot-select.component.ts
function TotSelectComponent_ng_container_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "label", 5);
    \u0275\u0275listener("click", function TotSelectComponent_ng_container_2_ng_container_2_Template_label_click_1_listener($event) {
...
function TotSelectComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "nz-option", 3);
    \u0275\u0275template(2, TotSelectComponent_ng_container_2_ng_container_2_Template, 4, 2, "ng-container", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function TotSelectComponent_nz_option_3_Template(rf, ctx) {
  if (rf & 1) {
...
var _TotSelectComponent = class _TotSelectComponent {
  constructor() {
...
_TotSelectComponent.\u0275fac = function TotSelectComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TotSelectComponent)();
};
_TotSelectComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TotSelectComponent, selectors: [["tot-select"]], inputs: { apiUrl: "apiUrl", params: "params", mode: "mode", placeholder: "placeholder", labelField: "labelField", valueField: "valueField", pageSize: "pageSize" }, outputs: { valueChange: "valueChange" }, features: [\u0275\u0275ProvidersFeature([
  {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => _TotSelectComponent),
    multi: true
  }
])], decls: 4, vars: 11, consts: [[2, "width", "100%", 3, "ngModelChange", "nzOnSearch", "nzScrollToBottom", "nzMode", "nzPlaceHolder", "nzLoading", "nzShowSearch", "nzServerSearch", "ngModel", "nzAllowClear"], [4, "ngFor", "ngForOf"], ["nzDisabled", "", "nzCustomContent", "", 4, "ngIf"], [3, "nzLabel", "nzValue", "nzCustomContent"], [4, "ngIf"], ["nz-checkbox", "", 3, "click", "nzChecked"], [2, "margin-left", "8px"], ["nzDisabled", "", "nzCustomContent", ""], ["nzSimple", ""]], template: function TotSelectComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-select", 0);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function TotSelectComponent_Template_nz_select_ngModelChange_0_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.selectedValue, $event) || (ctx.selectedValue = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function TotSelectComponent_Template_nz_select_ngModelChange_0_listener($event) {
      return ctx.onValueChange($event);
    })("nzOnSearch", function TotSelectComponent_Template_nz_select_nzOnSearch_0_listener($event) {
      return ctx.onSearch($event);
    })("nzScrollToBottom", function TotSelectComponent_Template_nz_select_nzScrollToBottom_0_listener() {
      return ctx.onScrollToBottom();
    });
    \u0275\u0275template(2, TotSelectComponent_ng_container_2_Template, 3, 4, "ng-container", 1)(3, TotSelectComponent_nz_option_3_Template, 2, 0, "nz-option", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TotSelectComponent, { className: "TotSelectComponent", filePath: "projects/tot/shared/src/lib/components/tot-select/tot-select.component.ts", lineNumber: 25 });
})();
...
function UserListComponent_tot_button_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tot-button", 30);
...
function UserListComponent_tr_77_tot_button_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tot-button", 52);
    \u0275\u0275listener("click", function UserListComponent_tr_77_tot_button_34_Template_tot_button_click_0_listener() {
      \u0275\u0275restoreView(_r15);
      const data_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
...
function UserListComponent_tr_77_tot_button_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tot-button", 53);
    \u0275\u0275listener("click", function UserListComponent_tr_77_tot_button_35_Template_tot_button_click_0_listener() {
      \u0275\u0275restoreView(_r16);
      const data_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
...
function UserListComponent_tr_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(20, "tot-button", 46);
    \u0275\u0275listener("click", function UserListComponent_tr_77_Template_tot_button_click_20_listener() {
      const data_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementStart(24, "tot-button", 46);
    \u0275\u0275listener("click", function UserListComponent_tr_77_Template_tot_button_click_24_listener() {
      const data_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(34, UserListComponent_tr_77_tot_button_34_Template, 3, 3, "tot-button", 48)(35, UserListComponent_tr_77_tot_button_35_Template, 3, 5, "tot-button", 49);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function UserListComponent_ng_container_82_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(29, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "nz-form-control")(31, "tot-select", 61);
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_ng_container_82_Template_tot_select_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "nz-form-control")(38, "tot-select", 62);
    \u0275\u0275pipe(39, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_ng_container_82_Template_tot_select_ngModelChange_38_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
...
function UserListComponent_ng_container_85_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "tot-select", 64);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_ng_container_85_Template_tot_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r2 = \u0275\u0275nextContext();
...
function UserListComponent_ng_container_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "tot-select", 65);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_ng_container_88_Template_tot_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r20);
      const ctx_r2 = \u0275\u0275nextContext();
...
_UserListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], decls: 89, vars: 92, consts: [["suffixIconSearch", ""], ["basicTable", ""], ["avatarInput", ""], [1, "page-header"], ["nzType", "primary", 3, "click", 4, "nzSpaceItem"], [3, "loading", "click", 4, "nzSpaceItem"], ["nzType", "default", 3, "loading", "click", 4, "nzSpaceItem"], [1, "search-card", 3, "nzTitle"], ["nz-row", "", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], ["nzAllowClear", "", 2, "width", "100%", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], [3, "nzValue", "nzLabel"], ["apiUrl", "/api/AuthManagement/roles", "mode", "multiple", 3, "ngModelChange", "valueChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", 3, "ngModelChange", "valueChange", "placeholder", "ngModel"], [2, "width", "100%", 3, "ngModelChange", "ngModel"], ["nzValue", "google", "nzLabel", "Google"], ["nzValue", "ms", "nzLabel", "Microsoft"], ["nzValue", "facebook", "nzLabel", "Facebook"], ["nz-input", "", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], ["nz-col", "", 1, "search-actions", 3, "nzSpan"], [3, "click", 4, "nzSpaceItem"], [3, "nzData", "nzLoading"], ["nzWidth", "80px"], ["nzWidth", "150px"], [4, "ngFor", "ngForOf"], ["type", "file", "accept", "image/*", 2, "display", "none", 3, "change"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle"], [4, "nzModalContent"], ["nzType", "primary", 3, "click"], ["nz-icon", "", "nzType", "plus"], [3, "click", "loading"], ["nz-icon", "", "nzType", "reload"], ["nzType", "default", 3, "click", "loading"], ["nz-icon", "", "nzType", "sync"], ["nz-icon", "", "nzType", "search"], [3, "click"], [1, "avatar-wrapper", 3, "click"], ["nzIcon", "user", 1, "user-avatar", 3, "nzSrc", "nzSize"], [1, "avatar-mask"], ["nz-icon", "", "nzType", "camera"], [1, "user-cell"], [1, "sub-text"], [3, "nzColor"], ["nzColor", "blue", 3, "nzMode", "nzOnClose", 4, "ngFor", "ngForOf"], ["nzType", "dashed", "nzSize", "small", 3, "click"], ["nzColor", "purple", 3, "nzMode", "nzOnClose", 4, "ngFor", "ngForOf"], ["nzType", "primary", "nzSize", "small", 3, "click", 4, "nzSpaceItem"], ["nzType", "primary", "nzSize", "small", 3, "nzDanger", "disabled", "click", 4, "nzSpaceItem"], ["nzColor", "blue", 3, "nzOnClose", "nzMode"], ["nzColor", "purple", 3, "nzOnClose", "nzMode"], ["nzType", "primary", "nzSize", "small", 3, "click"], ["nzType", "primary", "nzSize", "small", 3, "click", "nzDanger", "disabled"], ["nz-form", "", "nzLayout", "vertical"], ["nzRequired", ""], ["nz-input", "", "name", "username", 3, "ngModelChange", "ngModel", "disabled"], [4, "ngIf"], ["nz-input", "", "name", "displayName", 3, "ngModelChange", "ngModel"], ["nz-input", "", "name", "email", 3, "ngModelChange", "ngModel"], ["nz-checkbox", "", "name", "isEmailVerified", 3, "ngModelChange", "ngModel"], ["apiUrl", "/api/AuthManagement/roles", "mode", "multiple", "name", "roleIds", 3, "ngModelChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", "name", "claimIds", 3, "ngModelChange", "placeholder", "ngModel"], ["nz-input", "", "type", "password", "name", "password", 3, "ngModelChange", "ngModel"], ["apiUrl", "/api/AuthManagement/roles", "mode", "multiple", 3, "ngModelChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", 3, "ngModelChange", "placeholder", "ngModel"]], template: function UserListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, UserListComponent_tot_button_5_Template, 4, 3, "tot-button", 4)(6, UserListComponent_tot_button_6_Template, 4, 4, "tot-button", 5)(7, UserListComponent_tot_button_7_Template, 4, 4, "tot-button", 6);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 9)(25, "tot-select", 14);
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_Template_tot_select_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.searchQuery.roleIds, $event) || (ctx.searchQuery.roleIds = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("valueChange", function UserListComponent_Template_tot_select_valueChange_25_listener() {
      return ctx.loadUsers();
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 9)(28, "tot-select", 15);
    \u0275\u0275pipe(29, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function UserListComponent_Template_tot_select_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.searchQuery.claimIds, $event) || (ctx.searchQuery.claimIds = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("valueChange", function UserListComponent_Template_tot_select_valueChange_28_listener() {
      return ctx.loadUsers();
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(43, UserListComponent_tot_button_43_Template, 3, 3, "tot-button", 4)(44, UserListComponent_tot_button_44_Template, 3, 3, "tot-button", 22);
    \u0275\u0275elementEnd()()()();
...
function RoleListComponent_ng_container_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(19, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "nz-form-control")(21, "tot-select", 31);
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function RoleListComponent_ng_container_41_Template_tot_select_ngModelChange_21_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
...
function RoleListComponent_ng_container_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "tot-select", 32);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function RoleListComponent_ng_container_44_Template_tot_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.selectedClaimIds, $event) || (ctx_r2.selectedClaimIds = $event);
      return \u0275\u0275resetView($event);
...
_RoleListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleListComponent, selectors: [["app-role-list"]], decls: 45, vars: 45, consts: [["basicTable", ""], [1, "page-header"], ["nz-button", "", "nzType", "primary", 3, "click"], ["nz-icon", "", "nzType", "plus"], [1, "search-card", 3, "nzTitle"], ["nz-row", "", 3, "nzGutter"], ["nz-col", "", 3, "nzSpan"], ["nz-input", "", 3, "ngModelChange", "keyup.enter", "ngModel", "placeholder"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", 3, "ngModelChange", "valueChange", "placeholder", "ngModel"], ["nz-col", "", 1, "search-actions", 3, "nzSpan"], ["nz-button", "", "nzType", "primary", 3, "click", 4, "nzSpaceItem"], ["nz-button", "", 3, "click", 4, "nzSpaceItem"], [3, "nzData", "nzLoading"], ["nzWidth", "200px"], ["nzWidth", "150px"], [4, "ngFor", "ngForOf"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle"], [4, "nzModalContent"], ["nz-button", "", 3, "click"], [1, "claim-tags"], ["nzColor", "blue", 3, "nzMode", "nzOnClose", 4, "ngFor", "ngForOf"], ["nz-button", "", "nzType", "dashed", "nzSize", "small", 3, "click"], ["nz-button", "", "nzType", "primary", "nzSize", "small", 3, "click", 4, "nzSpaceItem"], ["nz-button", "", "nzType", "primary", "nzDanger", "", "nzSize", "small", 3, "disabled", "click", 4, "nzSpaceItem"], ["nzColor", "blue", 3, "nzOnClose", "nzMode"], ["nz-button", "", "nzType", "primary", "nzSize", "small", 3, "click"], ["nz-button", "", "nzType", "primary", "nzDanger", "", "nzSize", "small", 3, "click", "disabled"], ["nz-form", "", "nzLayout", "vertical"], ["nzRequired", ""], ["nz-input", "", "name", "name", 3, "ngModelChange", "ngModel", "placeholder", "disabled"], ["nz-input", "", "name", "description", 3, "ngModelChange", "ngModel", "placeholder"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", "name", "claimIds", 3, "ngModelChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/claims", "mode", "multiple", 3, "ngModelChange", "placeholder", "ngModel"]], template: function RoleListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 6)(15, "tot-select", 8);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function RoleListComponent_Template_tot_select_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.searchQuery.claimIds, $event) || (ctx.searchQuery.claimIds = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("valueChange", function RoleListComponent_Template_tot_select_valueChange_15_listener() {
      return ctx.loadRoles();
    });
    \u0275\u0275elementEnd()();
...
function AclListComponent_tr_43_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(data_r3.userId);
  }
}
function AclListComponent_tr_43_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275element(1, "span", 27);
    \u0275\u0275elementStart(2, "span");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(data_r3.roleId);
  }
}
function AclListComponent_tr_43_nz_tag_14_Template(rf, ctx) {
  if (rf & 1) {
...
function AclListComponent_tr_43_nz_tag_15_Template(rf, ctx) {
  if (rf & 1) {
...
function AclListComponent_tr_43_nz_tag_16_Template(rf, ctx) {
  if (rf & 1) {
...
function AclListComponent_tr_43_nz_tag_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AclListComponent_tr_43_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275template(2, AclListComponent_tr_43_div_2_Template, 7, 4, "div", 16)(3, AclListComponent_tr_43_div_3_Template, 7, 4, "div", 16);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td")(10, "div", 17)(11, "span", 18);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 19);
    \u0275\u0275template(14, AclListComponent_tr_43_nz_tag_14_Template, 3, 3, "nz-tag", 20)(15, AclListComponent_tr_43_nz_tag_15_Template, 3, 3, "nz-tag", 21)(16, AclListComponent_tr_43_nz_tag_16_Template, 3, 3, "nz-tag", 22)(17, AclListComponent_tr_43_nz_tag_17_Template, 3, 3, "nz-tag", 23);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "td")(19, "button", 24);
    \u0275\u0275listener("click", function AclListComponent_tr_43_Template_button_click_19_listener() {
      const data_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.deleteAcl(data_r3.id));
    });
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", data_r3.userId);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", data_r3.roleId);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 10, "X\xF3a"));
  }
}
function AclListComponent_ng_container_46_nz_form_item_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "nz-form-item")(1, "nz-form-label", 33);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "nz-form-control")(5, "tot-select", 42);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_nz_form_item_14_Template_tot_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r6);
...
function AclListComponent_ng_container_46_nz_form_item_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "nz-form-item")(1, "nz-form-label", 33);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "nz-form-control")(5, "tot-select", 43);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_nz_form_item_15_Template_tot_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function AclListComponent_ng_container_46_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "form", 32)(2, "nz-form-item")(3, "nz-form-label", 33);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "nz-form-control")(7, "nz-radio-group", 34);
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_Template_nz_radio_group_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.newEntry.subjectType, $event) || (ctx_r3.newEntry.subjectType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(8, "label", 35);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(14, AclListComponent_ng_container_46_nz_form_item_14_Template, 7, 8, "nz-form-item", 37)(15, AclListComponent_ng_container_46_nz_form_item_15_Template, 7, 8, "nz-form-item", 37);
    \u0275\u0275element(16, "nz-divider");
    \u0275\u0275elementStart(17, "nz-form-item")(18, "nz-form-label", 33);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "nz-form-control")(22, "div", 38)(23, "input", 39);
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_Template_input_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_Template_input_ngModelChange_25_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(27, "nz-form-item")(28, "nz-form-label", 33);
    \u0275\u0275text(29);
    \u0275\u0275pipe(30, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "nz-form-control")(32, "nz-checkbox-group", 41);
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_Template_nz_checkbox_group_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
...
_AclListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AclListComponent, selectors: [["app-acl-list"]], decls: 47, vars: 42, consts: [["basicTable", ""], [1, "page-header"], [1, "filter-card"], [1, "filter-box"], [1, "filter-item"], [1, "label"], ["nz-input", "", 2, "width", "150px", 3, "ngModelChange", "ngModel", "placeholder"], ["nz-button", "", "nzType", "primary", 3, "click"], ["nz-icon", "", "nzType", "search"], ["nz-button", "", "nzType", "default", 3, "click"], ["nz-icon", "", "nzType", "plus"], [3, "nzData", "nzLoading"], ["nzWidth", "100px"], [4, "ngFor", "ngForOf"], [3, "nzVisibleChange", "nzOnCancel", "nzOnOk", "nzVisible", "nzTitle"], [4, "nzModalContent"], ["class", "subject-info", 4, "ngIf"], [1, "mask-display"], [1, "mask-value"], [1, "mask-details"], ["nzColor", "blue", 4, "ngIf"], ["nzColor", "green", 4, "ngIf"], ["nzColor", "red", 4, "ngIf"], ["nzColor", "orange", 4, "ngIf"], ["nz-button", "", "nzType", "primary", "nzDanger", "", "nzSize", "small", 3, "click"], [1, "subject-info"], ["nz-icon", "", "nzType", "user"], ["nz-icon", "", "nzType", "team"], ["nzColor", "blue"], ["nzColor", "green"], ["nzColor", "red"], ["nzColor", "orange"], ["nz-form", "", "nzLayout", "vertical"], [3, "nzSpan"], ["name", "subjectType", 3, "ngModelChange", "ngModel"], ["nz-radio", "", "nzValue", "user"], ["nz-radio", "", "nzValue", "role"], [4, "ngIf"], [2, "display", "flex", "gap", "8px"], ["nz-input", "", "name", "resType", 2, "width", "120px", 3, "ngModelChange", "ngModel", "placeholder"], ["nz-input", "", "name", "resId", 2, "flex", "1", 3, "ngModelChange", "ngModel", "placeholder"], ["name", "perms", 3, "ngModelChange", "ngModel"], ["apiUrl", "/api/AuthManagement/users", "labelField", "username", "name", "userId", 3, "ngModelChange", "placeholder", "ngModel"], ["apiUrl", "/api/AuthManagement/roles", "name", "roleId", 3, "ngModelChange", "placeholder", "ngModel"]], template: function AclListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 1)(1, "h2");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "nz-card", 2)(5, "div", 3)(6, "div", 4)(7, "span", 5);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(26, "nz-table", 11, 0)(28, "thead")(29, "tr")(30, "th");
    \u0275\u0275text(31);
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(43, AclListComponent_tr_43_Template, 22, 12, "tr", 13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "nz-modal", 14);
    \u0275\u0275pipe(45, "translate");
    \u0275\u0275twoWayListener("nzVisibleChange", function AclListComponent_Template_nz_modal_nzVisibleChange_44_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.isCreateModalVisible, $event) || (ctx.isCreateModalVisible = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("nzOnCancel", function AclListComponent_Template_nz_modal_nzOnCancel_44_listener() {
      return ctx.isCreateModalVisible = false;
    })("nzOnOk", function AclListComponent_Template_nz_modal_nzOnOk_44_listener() {
      return ctx.createAcl();
    });
    \u0275\u0275template(46, AclListComponent_ng_container_46_Template, 33, 30, "ng-container", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const basicTable_r8 = \u0275\u0275reference(27);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 18, "Qu\u1EA3n l\xFD ACL"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(9, 20, "Lo\u1EA1i t\xE0i nguy\xEAn"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx.filter.resourceType);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 22, "V\xED d\u1EE5: order"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(15, 24, "ID t\xE0i nguy\xEAn"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx.filter.resourceId);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(17, 26, "V\xED d\u1EE5: 123 ho\u1EB7c *"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(21, 28, "T\xECm ki\u1EBFm..."), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 30, "Th\xEAm m\u1EDBi"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("nzData", ctx.aclEntries)("nzLoading", ctx.loading);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 32, "\u0110\u1ED1i t\u01B0\u1EE3ng"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 34, "T\xE0i nguy\xEAn"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 36, "M\u1EB7t n\u1EA1 quy\u1EC1n"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 38, "H\xE0nh \u0111\u1ED9ng"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", basicTable_r8.data);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("nzVisible", ctx.isCreateModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(45, 40, "Th\xEAm m\u1EDBi"));
  }
}, dependencies: [
  CommonModule,
  NgForOf,
    ...
    <nz-table #basicTable [nzData]="aclEntries" [nzLoading]="loading">
      <thead>
        <tr>
          ...
          <th>{{ 'T\xE0i nguy\xEAn' | translate }}</th>
          <th>{{ 'M\u1EB7t n\u1EA1 quy\u1EC1n' | translate }}</th>
          <th nzWidth="100px">{{ 'H\xE0nh \u0111\u1ED9ng' | translate }}</th>
        </tr>
      </thead>
      <tbody>
        <tr *ngFor="let data of basicTable.data">
...
//# sourceMappingURL=chunk-M7FWAJ7G.js.map
