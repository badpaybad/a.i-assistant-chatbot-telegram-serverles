...
var FcmTestComponent = class _FcmTestComponent {
  constructor() {
  ...
  ngOnInit() {
    this.firebase.onMessageReceived((payload) => {
      this.notification.success(payload.notification?.title || "FCM Notification", payload.notification?.body || "New message received", { nzDuration: 0 });
    });
  }
  ...
  static {
    this.\u0275fac = function FcmTestComponent_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-SARV5SMV.js.map
