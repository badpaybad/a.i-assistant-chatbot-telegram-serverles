  ...
  async submitForm() {
    if (this.validateForm.valid) {
      ...
      try {
        ...
        console.error(e);
        this.notification.error(this.translate.instant("Th\u1EA5t b\u1EA1i"), e.error?.message || this.translate.instant("\u0110\u1ED5i m\u1EADt kh\u1EA9u th\u1EA5t b\u1EA1i"));
      } finally {
        this.loading = false;
      }
    } else {
...
//# sourceMappingURL=chunk-2BAAYDW2.js.map
