...
function UserListComponent_ng_template_47_nz_tag_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("nzOnClose", function UserListComponent_ng_template_47_nz_tag_0_Template_nz_tag_nzOnClose_0_listener() {
...
function UserListComponent_ng_template_48_nz_tag_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("nzOnClose", function UserListComponent_ng_template_48_nz_tag_0_Template_nz_tag_nzOnClose_0_listener() {
...
_UserListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], viewQuery: function UserListComponent_Query(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("nzGutter", \u0275\u0275pureFunction0(66, _c1));
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance();
    ...
    \u0275\u0275property("nzSpan", 8);
    \u0275\u0275advance(4);
    \u0275\u0275property("data", ctx.users)("columns", ctx.userColumns)("loading", ctx.loading)("title", \u0275\u0275pipeBind1(43, 58, "Danh s\xE1ch ng\u01B0\u1EDDi d\xF9ng"))("extra", userExtraTpl_r29)("frontPagination", true);
    \u0275\u0275advance(12);
    \u0275\u0275twoWayProperty("nzVisible", ctx.isUserModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(55, 60, ctx.editingUser ? "S\u1EEDa ng\u01B0\u1EDDi d\xF9ng" : "Th\xEAm ng\u01B0\u1EDDi d\xF9ng"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("nzVisible", ctx.isRoleModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(58, 62, "Vai tr\xF2"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("nzVisible", ctx.isClaimModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(61, 64, "Quy\u1EC1n"));
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UserListComponent, [{
    ...
    >
      ...
      <ng-template totCell="Ng\u01B0\u1EDDi d\xF9ng" let-data>
        <div class="user-cell">
      ...
      <ng-template totCell="Vai tr\xF2" let-data>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserListComponent, { className: "UserListComponent", filePath: "projects/tot/business-oidc/src/lib/user-list/user-list.component.ts", lineNumber: 340 });
})();
...
_RoleListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleListComponent, selectors: [["app-role-list"]], viewQuery: function RoleListComponent_Query(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("nzGutter", \u0275\u0275pureFunction0(31, _c12));
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 8);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx.searchQuery.keyword);
    ...
    \u0275\u0275property("nzSpan", 6);
    \u0275\u0275advance(4);
    \u0275\u0275property("data", ctx.roles)("columns", ctx.roleColumns)("loading", ctx.loading)("title", \u0275\u0275pipeBind1(16, 25, "Vai tr\xF2"))("extra", roleExtraTpl_r15)("frontPagination", true);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("nzVisible", ctx.isRoleModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(21, 27, ctx.editingRole ? "S\u1EEDa vai tr\xF2" : "Th\xEAm m\u1EDBi"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("nzVisible", ctx.isClaimModalVisible);
    \u0275\u0275property("nzTitle", \u0275\u0275pipeBind1(24, 29, "Quy\u1EC1n"));
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoleListComponent, { className: "RoleListComponent", filePath: "projects/tot/business-oidc/src/lib/role-list/role-list.component.ts", lineNumber: 173 });
})();
...
var _AclListComponent = class _AclListComponent {
  ...
  ngOnInit() {
    this.aclColumns = [
      { title: "\u0110\u1ED1i t\u01B0\u1EE3ng" },
      { title: "T\xE0i nguy\xEAn" },
      { title: "M\u1EB7t n\u1EA1 quy\u1EC1n" },
      { title: "H\xE0nh \u0111\u1ED9ng", width: "120px", right: true }
    ];
    this.loadMetadata();
  }
  async loadMetadata() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AclListComponent, [{
    ...
    <tot-table [data]="aclEntries" [columns]="aclColumns" [loading]="loading" [title]="'Danh s\xE1ch ACL' | transloco" [frontPagination]="true">
      ...
      <ng-template totCell="T\xE0i nguy\xEAn" let-data>
...
_ClaimSyncComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClaimSyncComponent, selectors: [["app-claim-sync"]], viewQuery: function ClaimSyncComponent_Query(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("nzGutter", \u0275\u0275pureFunction0(36, _c2));
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 10);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx.searchQuery.keyword);
...
//# sourceMappingURL=chunk-75EIAVNK.js.map
