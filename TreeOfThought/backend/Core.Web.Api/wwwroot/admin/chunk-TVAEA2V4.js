...
} from "./chunk-LR2WY4IR.js";
import {
  NzAvatarComponent,
  NzAvatarModule
} from "./chunk-OCU54EZG.js";
import {
  NzColDirective,
...
function DashboardComponent_div_72_ng_template_32_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", (data_r16.status == null ? null : data_r16.status.toLowerCase()) === "success" ? "success" : (data_r16.status == null ? null : data_r16.status.toLowerCase()) === "error" ? "error" : "processing");
    \u0275\u0275advance();
...
function DashboardComponent_div_72_ng_template_33_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", data_r17.step === "Enqueue" ? "blue" : data_r17.step === "Publish" ? "cyan" : data_r17.step === "Subscribe" ? "purple" : data_r17.step === "Dequeue" ? "orange" : "green");
    \u0275\u0275advance();
...
function DashboardComponent_div_72_ng_template_34_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r12 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r18.sourceComponent);
    \u0275\u0275advance();
...
function DashboardComponent_div_72_ng_template_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r12 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r19.queueOrTopic);
    \u0275\u0275advance();
...
function DashboardComponent_div_72_ng_template_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r12 = \u0275\u0275nextContext(2);
    \u0275\u0275property("nz-tooltip", data_r20.handler);
    \u0275\u0275advance();
...
function DashboardComponent_div_72_ng_template_38_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("nzType", data_r23.expand ? "up" : "down");
    \u0275\u0275advance();
...
function DashboardComponent_div_73_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const errorItem_r30 = \u0275\u0275reference(12);
    const ctx_r12 = \u0275\u0275nextContext();
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_nz_timeline_item_1_nz_tag_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", step_r35.status.toLowerCase() === "success" ? "success" : step_r35.status.toLowerCase() === "error" ? "error" : "processing");
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_nz_timeline_item_1_div_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("nz-tooltip", step_r35.sourceComponent);
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_nz_timeline_item_1_div_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(step_r35.subscriberName);
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_nz_timeline_item_1_div_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r12 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275property("nz-tooltip", step_r35.handlerOrEventName);
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_nz_timeline_item_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzColor", (step_r35.status == null ? null : step_r35.status.toLowerCase()) === "error" ? "red" : (step_r35.status == null ? null : step_r35.status.toLowerCase()) === "success" ? "green" : "blue");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 12, step_r35.timestamp || step_r35.time, "yyyy-MM-dd HH:mm:ss.SSS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("nzColor", step_r35.step === "Enqueue" ? "blue" : step_r35.step === "Publish" ? "cyan" : step_r35.step === "Subscribe" ? "purple" : step_r35.step === "Dequeue" ? "orange" : "green");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r35.step, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.status);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", step_r35.sourceComponent);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.queueOrTopicName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.subscriberName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.workerName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.handlerOrEventName);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", step_r35.details && (step_r35.status == null ? null : step_r35.status.toLowerCase()) !== "error");
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_nz_timeline_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const data_r34 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
...
function DashboardComponent_ng_template_75_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const loadingHistory_r37 = \u0275\u0275reference(22);
    const ctx_r12 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r12.formatJson(data_r34.content));
    \u0275\u0275advance();
    \u0275\u0275property("nzSpan", 14);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 13, "L\u1ECBch s\u1EED d\xF2ng th\u1EDDi gian s\u1EF1 ki\u1EC7n"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", data_r34.history && data_r34.history.length > 0)("ngIfElse", loadingHistory_r37);
  }
}
      ...
      <nz-card [nzTitle]="'L\u1ECBch s\u1EED th\u1EF1c thi' | transloco">
        ...
        >
          ...
          <ng-template totCell="step" let-data>
            <nz-tag [nzColor]="data.step === 'Enqueue' ? 'blue' : data.step === 'Publish' ? 'cyan' : data.step === 'Subscribe' ? 'purple' : data.step === 'Dequeue' ? 'orange' : 'green'">
              {{ data.step }}
            </nz-tag>
          </ng-template>
            ...
            <nz-timeline *ngIf="data.history && data.history.length > 0; else loadingHistory">
              ...
              >
                ...
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
                  ...
                  <nz-tag [nzColor]="step.step === 'Enqueue' ? 'blue' : step.step === 'Publish' ? 'cyan' : step.step === 'Subscribe' ? 'purple' : step.step === 'Dequeue' ? 'orange' : 'green'">
                    {{ step.step }}
                  </nz-tag>
...
//# sourceMappingURL=chunk-TVAEA2V4.js.map
