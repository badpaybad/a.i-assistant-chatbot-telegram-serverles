...
// projects/tot/shared/src/lib/components/app-select/app-select.component.ts
function AppSelectComponent_ng_container_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "label", 5);
    \u0275\u0275listener("click", function AppSelectComponent_ng_container_2_ng_container_2_Template_label_click_1_listener($event) {
...
function AppSelectComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "nz-option", 3);
    \u0275\u0275template(2, AppSelectComponent_ng_container_2_ng_container_2_Template, 4, 2, "ng-container", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AppSelectComponent_nz_option_3_Template(rf, ctx) {
  if (rf & 1) {
...
var _AppSelectComponent = class _AppSelectComponent {
  constructor() {
...
_AppSelectComponent.\u0275fac = function AppSelectComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AppSelectComponent)();
};
_AppSelectComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppSelectComponent, selectors: [["app-select"]], inputs: { apiUrl: "apiUrl", params: "params", mode: "mode", placeholder: "placeholder", labelField: "labelField", valueField: "valueField", pageSize: "pageSize" }, outputs: { valueChange: "valueChange" }, features: [\u0275\u0275ProvidersFeature([
  {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => _AppSelectComponent),
    multi: true
  }
])], decls: 4, vars: 11, consts: [[2, "width", "100%", 3, "ngModelChange", "nzOnSearch", "nzScrollToBottom", "nzMode", "nzPlaceHolder", "nzLoading", "nzShowSearch", "nzServerSearch", "ngModel", "nzAllowClear"], [4, "ngFor", "ngForOf"], ["nzDisabled", "", "nzCustomContent", "", 4, "ngIf"], [3, "nzLabel", "nzValue", "nzCustomContent"], [4, "ngIf"], ["nz-checkbox", "", 3, "click", "nzChecked"], [2, "margin-left", "8px"], ["nzDisabled", "", "nzCustomContent", ""], ["nzSimple", ""]], template: function AppSelectComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nz-select", 0);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AppSelectComponent_Template_nz_select_ngModelChange_0_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.selectedValue, $event) || (ctx.selectedValue = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function AppSelectComponent_Template_nz_select_ngModelChange_0_listener($event) {
      return ctx.onValueChange($event);
    })("nzOnSearch", function AppSelectComponent_Template_nz_select_nzOnSearch_0_listener($event) {
      return ctx.onSearch($event);
    })("nzScrollToBottom", function AppSelectComponent_Template_nz_select_nzScrollToBottom_0_listener() {
      return ctx.onScrollToBottom();
    });
    \u0275\u0275template(2, AppSelectComponent_ng_container_2_Template, 3, 4, "ng-container", 1)(3, AppSelectComponent_nz_option_3_Template, 2, 0, "nz-option", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var AppSelectComponent = _AppSelectComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppSelectComponent, [{
    type: Component,
    args: [{ selector: "app-select", standalone: true, imports: [CommonModule, FormsModule, NzSelectModule, NzCheckboxModule, NzSpinModule, TranslateModule], providers: [
      {
        provide: NG_VALUE_ACCESSOR,
...
function AclListComponent_ng_container_46_nz_form_item_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "nz-form-control")(5, "app-select", 42);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_nz_form_item_14_Template_app_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r6);
...
function AclListComponent_ng_container_46_nz_form_item_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "nz-form-control")(5, "app-select", 43);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AclListComponent_ng_container_46_nz_form_item_15_Template_app_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext(2);
...
//# sourceMappingURL=chunk-QK4CE2DR.js.map
