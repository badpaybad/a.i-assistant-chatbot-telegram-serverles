...
_NhanDienKhuonMatComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NhanDienKhuonMatComponent, selectors: [["tot-nhan-dien-khuon-mat"]], viewQuery: function NhanDienKhuonMatComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("queryParamsChange", function NhanDienKhuonMatComponent_Template_tot_table_queryParamsChange_43_listener($event) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzXs", 24)("nzMd", 12)("nzLg", 8);
    \u0275\u0275advance(11);
    \u0275\u0275property("data", ctx.queue)("columns", ctx.activeColumns)("loading", ctx.loadingDetector)("nzSize", "middle")("frontPagination", false)("showPagination", ctx.queue.length > 0)("pageSize", ctx.activePageSize)("title", activeTableTitleTpl_r25)("extra", activeTableExtraTpl_r26);
    \u0275\u0275advance(9);
...
//# sourceMappingURL=chunk-SPMWGLSU.js.map
