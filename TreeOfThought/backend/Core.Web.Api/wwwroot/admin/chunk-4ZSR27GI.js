import {
  ...
  NzPageHeaderModule
} from "./chunk-2QJRDCYV.js";
import {
  NzDescriptionsModule
} from "./chunk-5HPD4ML7.js";
import {
  NzAvatarComponent,
  NzAvatarModule
    ...
    <div class="topic-detail-container">
      ...
      <ng-template #noSubs>
        <div style="text-align: center; padding: 24px; color: #999;">
          {{ 'Kh\xF4ng c\xF3 subscriber n\xE0o' | transloco }}
        </div>
      </ng-template>
    </div>
...
var _CqrsTestComponent = class _CqrsTestComponent {
  ...
  sendTestCommand() {
    ...
    this.dashboardService.sendTestCommand(this.commandPayload).subscribe({
      next: (res) => {
        ...
        this.notification.success(this.translate.translate("Th\xE0nh c\xF4ng"), this.translate.translate("NOTIFICATIONS.SAMPLE_COMMAND_SENT", { id: res.trackingId }));
        this.loadingCommand = false;
      },
      error: () => {
  ...
  sendTestEvent() {
    ...
    this.dashboardService.sendTestEvent(this.eventData).subscribe({
      next: (res) => {
        this.lastTrackingId = res.trackingId;
        this.notification.success(this.translate.translate("Th\xE0nh c\xF4ng"), this.translate.translate("NOTIFICATIONS.SAMPLE_EVENT_PUBLISHED", { id: res.trackingId }));
        this.loadingEvent = false;
      },
      error: () => {
    ...
    <div style="padding: 24px;">
      ...
      <div nz-row [nzGutter]="24">
        <div nz-col [nzSpan]="12">
          <nz-card [nzTitle]="'G\u1EEDi SampleCommand' | transloco">
            <p>{{ 'Command n\xE0y s\u1EBD \u0111\u01B0\u1EE3c Enqueue v\xE0o queue sample.command' | transloco }}</p>
        ...
        <div nz-col [nzSpan]="12">
          <nz-card [nzTitle]="'G\u1EEDi SampleEvent' | transloco">
            <p>{{ 'S\u1EF1 ki\u1EC7n n\xE0y s\u1EBD \u0111\u01B0\u1EE3c Publish v\xE0o topic sample.event' | transloco }}</p>
            <div style="margin-bottom: 16px;">
      ...
      <div *ngIf="lastTrackingId" style="margin-top: 24px;">
        <nz-card [nzTitle]="'K\u1EBFt qu\u1EA3 g\u1EA7n nh\u1EA5t' | transloco">
          ...
          <p>{{ 'B\u1EA1n c\xF3 th\u1EC3 quay l\u1EA1i Dashboard v\xE0 t\xECm ki\u1EBFm theo ID n\xE0y \u0111\u1EC3 theo d\xF5i lu\u1ED3ng x\u1EED l\xFD.' | transloco }}</p>
        </nz-card>
      </div>
    </div>
...
function DashboardComponent_ng_template_86_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "slice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "tot-button", 96);
    \u0275\u0275listener("click", function DashboardComponent_ng_template_86_Template_tot_button_click_4_listener() {
...
function DashboardComponent_ng_template_90_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "tot-button", 106);
    \u0275\u0275listener("click", function DashboardComponent_ng_template_90_Template_tot_button_click_5_listener() {
...
(() => {
  ...
  <div class="tab-actions" style="margin-bottom: 16px; display: flex; justify-content: center;">
    <nz-radio-group [(ngModel)]="activeTab" nzButtonStyle="solid" nzSize="large">
      <label nz-radio-button nzValue="queues"><i nz-icon nzType="database"></i> {{ 'H\xE0ng \u0111\u1EE3i & Ch\u1EE7 \u0111\u1EC1' | transloco }}</label>
  ...
  <ng-container [ngSwitch]="activeTab">
    <div *ngSwitchCase="'queues'">
      <nz-card [nzTitle]="'Danh s\xE1ch th\u1EF1c th\u1EC3 CQRS' | transloco">
        <tot-table
          [data]="queues"
  ...
  <ng-template #statusTpl let-data>
    <nz-tag [nzColor]="data.status === 'success' ? 'success' : data.status === 'error' ? 'error' : 'processing'">
      {{ (data.status === 'success' ? 'Th\xE0nh c\xF4ng' : data.status === 'error' ? 'L\u1ED7i' : '\u0110ang ch\u1EA1y') | transloco }}
    </nz-tag>
  </ng-template>
  ...
  <ng-template #expandTpl let-data>
    <div class="json-viewer-container" style="width: 100%;">
      ...
      <div style="margin-top: 16px;">
        <h4>{{ 'L\u1ECBch s\u1EED x\u1EED l\xFD' | transloco }}</h4>
        ...
        <div class="flow-node" [class]="getStepStatus(log.step)">
          ...
          <div class="node-badge">
            <nz-tag [nzColor]="getStepStatus(log.step) === 'error' ? 'red' : 'blue'" nzMode="checkable">
              {{ (getStepStatus(log.step) === 'error' ? 'L\u1ED7i' : 'Th\xE0nh c\xF4ng') | transloco | uppercase }}
            </nz-tag>
          </div>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TracingComponent, { className: "TracingComponent", filePath: "projects/tot/business-dashboard/src/lib/tracing/tracing.component.ts", lineNumber: 39 });
})();
export {
  CqrsTestComponent,
  DashboardComponent,
...
//# sourceMappingURL=chunk-4ZSR27GI.js.map
