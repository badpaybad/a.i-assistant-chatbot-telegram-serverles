        ...
        children: [
          {
            ...
            loadComponent: () => import("./chunk-FNQ4P4ER.js").then((m) => m.NhanDienKhuonMatComponent)
          },
          {
            path: "training",
            data: { breadcrumb: "\u0110\xE0o t\u1EA1o nh\u1EADn d\u1EA1ng" },
            loadComponent: () => import("./chunk-FNQ4P4ER.js").then((m) => m.TrainingComponent)
          },
          {
            path: "camera",
            data: { breadcrumb: "Camera nh\u1EADn d\u1EA1ng" },
            loadComponent: () => import("./chunk-FNQ4P4ER.js").then((m) => m.CameraComponent)
          },
          {
            path: "",
            redirectTo: "sessions",
