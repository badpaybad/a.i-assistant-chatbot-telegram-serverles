import {
  AppSelectComponent
} from "./chunk-ZQEXHZGB.js";
import {
  AuthManagementService
} from "./chunk-HCWZGQUL.js";
import {
  NzAvatarComponent,
  NzAvatarModule
} from "./chunk-UKXS5GKX.js";
import {
  NzCardComponent,
  NzCardModule
...
var UserListComponent = class _UserListComponent {
  ...
  showEditModal(user) {
    ...
    this.userForm = {
      ...
      claimIds: user.directClaims?.map((c) => c.id) || []
    };
    this.isUserModalVisible = true;
  }
  async saveUser() {
  ...
  showClaimModal(user) {
    this.selectedUser = user;
    this.selectedClaimIds = user.directClaims?.map((c) => c.id) || [];
    ...
    this.modal.confirm({
      ...
      nzOnOk: async () => {
        try {
          ...
          this.message.error(e.error?.message || this.translate.instant("X\xF3a ng\u01B0\u1EDDi d\xF9ng th\u1EA5t b\u1EA1i"));
        }
      }
    });
  }
...
//# sourceMappingURL=chunk-PTH5KOTS.js.map
