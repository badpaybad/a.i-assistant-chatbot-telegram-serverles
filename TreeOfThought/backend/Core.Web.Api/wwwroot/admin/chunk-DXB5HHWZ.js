...
function RoleListComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoleListComponent_ng_template_26_Template_tot_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function RoleListComponent_ng_template_26_Template_tot_button_click_4_listener() {
      const data_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 4, "S\u1EEDa"));
    \u0275\u0275advance(2);
    \u0275\u0275property("nzDanger", true)("disabled", (data_r11.name == null ? null : data_r11.name.toLowerCase()) === ctx_r2.ADMIN_ROLE.toLowerCase());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 6, "X\xF3a"));
  }
}
...
_RoleListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleListComponent, selectors: [["app-role-list"]], viewQuery: function RoleListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275template(22, RoleListComponent_ng_template_22_Template, 2, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(24, RoleListComponent_ng_template_24_Template, 4, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(26, RoleListComponent_ng_template_26_Template, 7, 8, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    ...
    <ng-template #actionsTpl let-data>
      <div style="display: flex; gap: 4px; flex-direction: column;">
        ...
        <tot-button nzType="primary" [nzDanger]="true" nzSize="small" 
                ...
                (click)="deleteRole(data)">{{ 'X\xF3a' | translate }}</tot-button>
      </div>
    </ng-template>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoleListComponent, { className: "RoleListComponent", filePath: "projects/tot/business-oidc/src/lib/role-list/role-list.component.ts", lineNumber: 166 });
})();
...
function AclListComponent_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AclListComponent_ng_template_33_Template_tot_button_click_0_listener() {
...
_AclListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AclListComponent, selectors: [["app-acl-list"]], viewQuery: function AclListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275template(27, AclListComponent_ng_template_27_Template, 2, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(29, AclListComponent_ng_template_29_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(31, AclListComponent_ng_template_31_Template, 8, 5, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(33, AclListComponent_ng_template_33_Template, 3, 4, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AclListComponent, [{
    ...
    <ng-template #actionsTpl let-data>
      <tot-button nzType="primary" [nzDanger]="true" nzSize="small" (click)="deleteAcl(data.id)">{{ 'X\xF3a' | translate }}</tot-button>
    </ng-template>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AclListComponent, { className: "AclListComponent", filePath: "projects/tot/business-oidc/src/lib/acl-list/acl-list.component.ts", lineNumber: 210 });
})();
...
//# sourceMappingURL=chunk-DXB5HHWZ.js.map
