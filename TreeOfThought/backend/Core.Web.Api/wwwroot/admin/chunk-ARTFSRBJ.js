...
function FileExplorerComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, FileExplorerComponent_div_6_ng_template_2_Template, 2, 1, "ng-template", 21)(3, FileExplorerComponent_div_6_ng_template_3_Template, 2, 1, "ng-template", 32)(4, FileExplorerComponent_div_6_ng_template_4_Template, 5, 4, "ng-template", 33);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
var _FileExplorerComponent = class _FileExplorerComponent {
  ...
  initColumns() {
    this.searchColumns = [
      { title: "T\xEAn file" },
      { title: "\u0110\u01B0\u1EDDng d\u1EABn" },
      { title: "Thao t\xE1c", width: "100px", right: true }
    ];
    this.folderColumns = [
      { title: "T\xEAn th\u01B0 m\u1EE5c" },
      { title: "H\xE0nh \u0111\u1ED9ng", width: "150px", right: true }
    ];
    this.fileColumns = [
      { title: "T\xEAn file" },
      { title: "Tr\u1EA1ng th\xE1i", width: "120px" },
      { title: "K\xEDch th\u01B0\u1EDBc", width: "120px" },
      { title: "Lo\u1EA1i", width: "120px" },
      { title: "Ng\xE0y t\u1EA1o", width: "150px" },
      { title: "H\xE0nh \u0111\u1ED9ng", width: "150px", right: true }
    ];
  }
  ngOnDestroy() {
  ...
  <div class="search-section">
    ...
    <div *ngIf="searchResults.length > 0 || searching" class="mt-3">
      ...
      >
        ...
        <ng-template totCell="\u0110\u01B0\u1EDDng d\u1EABn" let-data>
          <nz-tag>{{ data.folderPath }}</nz-tag>
        </ng-template>

        <ng-template totCell="Thao t\xE1c" let-data>
  ...
  <div class="explorer-content">
    ...
    <div class="mt-3">
        ...
        >
          ...
          <ng-template totCell="K\xEDch th\u01B0\u1EDBc" let-data>
          ...
          <ng-template totCell="Ng\xE0y t\u1EA1o" let-data>
...
//# sourceMappingURL=chunk-ARTFSRBJ.js.map
