...
if len(sys.argv) > 1 and sys.argv[1] == 'config_ngoc':
    ...
    from config_ngoc import TELEGRAM_BOT_GROUP_CHATID,TELEGRAM_OWNER_USERNAME,TELEGRAM_BOT_TOKEN, TELEGRAM_API_URL, PORT, TELEGRAM_BOT_CHATID, TELEGRAM_BOT_USERNAME, GEMINI_APIKEY, GEMINI_MODEL, DISCORD_PUBKEY, DISCORD_APPID, DISCORD_TOKEN,  TELEGRAM_API_ID, TELEGRAM_API_HASH, REPLY_ON_TAG_BOT_USERNAME,JIRA_PERSONAL_ACCESS_TOKEN,JIRA_SERVER_ISSUE_API,JIRA_PROJECT_KEY,JIRA_SERVER_WEBHOOK_API,SWAKSRC
elif len(sys.argv) < 2 or sys.argv[1] != "config_dunp":
    from config_dunp import TELEGRAM_BOT_GROUP_CHATID,TELEGRAM_OWNER_USERNAME,TELEGRAM_BOT_TOKEN, TELEGRAM_API_URL, PORT, TELEGRAM_BOT_CHATID, TELEGRAM_BOT_USERNAME, GEMINI_APIKEY, GEMINI_MODEL, DISCORD_PUBKEY, DISCORD_APPID, DISCORD_TOKEN,  TELEGRAM_API_ID, TELEGRAM_API_HASH, REPLY_ON_TAG_BOT_USERNAME,JIRA_PERSONAL_ACCESS_TOKEN,JIRA_SERVER_ISSUE_API,JIRA_PROJECT_KEY,JIRA_SERVER_WEBHOOK_API,SWAKSRC
elif len(sys.argv) > 1 and sys.argv[1] == 'config_dunp':
    from config_dunp import TELEGRAM_BOT_GROUP_CHATID,TELEGRAM_OWNER_USERNAME,TELEGRAM_BOT_TOKEN, TELEGRAM_API_URL, PORT, TELEGRAM_BOT_CHATID, TELEGRAM_BOT_USERNAME, GEMINI_APIKEY, GEMINI_MODEL, DISCORD_PUBKEY, DISCORD_APPID, DISCORD_TOKEN,  TELEGRAM_API_ID, TELEGRAM_API_HASH, REPLY_ON_TAG_BOT_USERNAME,JIRA_PERSONAL_ACCESS_TOKEN,JIRA_SERVER_ISSUE_API,JIRA_PROJECT_KEY,JIRA_SERVER_WEBHOOK_API,SWAKSRC
else:
    from config_dev import TELEGRAM_BOT_GROUP_CHATID,TELEGRAM_OWNER_USERNAME,TELEGRAM_BOT_TOKEN, TELEGRAM_API_URL, PORT, TELEGRAM_BOT_CHATID, TELEGRAM_BOT_USERNAME, GEMINI_APIKEY, GEMINI_MODEL, DISCORD_PUBKEY, DISCORD_APPID, DISCORD_TOKEN,  TELEGRAM_API_ID, TELEGRAM_API_HASH, REPLY_ON_TAG_BOT_USERNAME,JIRA_PERSONAL_ACCESS_TOKEN,JIRA_SERVER_ISSUE_API,JIRA_PROJECT_KEY,JIRA_SERVER_WEBHOOK_API,SWAKSRC
